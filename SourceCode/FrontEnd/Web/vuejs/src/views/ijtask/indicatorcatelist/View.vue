                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span><i class="icon-eye icon mr-2"></i> Loại chỉ tiêu: {{model.CateName}}</span>
                        </div>
                    </b-col>
                    ...
                    <b-card>
                        <div class="form-body">
                            ...
                            <table class="table b-table table-sm table-bordered">
                                <thead>
                                <tr>
                                    <th scope="col" style="width: 30%; border-bottom: none;">Tên</th>
                                    <th scope="col" style="width: 10%; border-bottom: none;">kiểu dữ liệu</th>
                                    <th scope="col" style="width: 10%; border-bottom: none;">Giá trị</th>
                                    <th scope="col" style="width: 10%; border-bottom: none;">Giá trị qui đổi</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr v-for="(field, key) in model.IndicatorCateValue">
                                    ...
                                    <td v-if="field.DataType == 1 || field.DataType == 2 || field.DataType == 3 || field.DataType == 4" class="text-right">{{field.CateValue}}</td>
                                    <td v-if="field.DataType == 1 || field.DataType == 2 || field.DataType == 3 || field.DataType == 4" class="text-right">{{field.ConvertedValue}}</td>
...
<script>
    ...
    const DeleteApi = 'task/api/indicator-cate-list/delete';
