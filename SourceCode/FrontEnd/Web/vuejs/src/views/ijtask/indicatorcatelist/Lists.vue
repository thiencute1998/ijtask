                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Loại chỉ tiêu</span>
                            </div>
                        </b-col>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                    ...
                    {key: 'CateName', label: 'Tên loại chỉ tiêu', field: 'CateName',searchOnTopRow: {type: 'text'}, thStyle: 'min-width: 300px'},
        ...
        created() {
          ...
          this.settings.Table = 'task_indicator_code_list';
          this.settings.FieldInactive = 'Inactive';

          this.settings.ListApi = 'task/api/indicator-cate-list';
          this.settings.DeleteApi = 'task/api/indicator-cate-list/delete';
          this.settings.CreateRouter = 'task-indicator-cate-list-create';
          this.settings.EditRouter = 'task-indicator-cate-list-edit';
          this.settings.ViewRouter = 'task-indicator-cate-list-view';
        ...
        methods: {
          ...
          handleDebugger(data){
              console.log(data);indicator-cate-list
          },
