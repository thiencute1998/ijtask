                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span><i class="icon-eye icon mr-2"></i> Đánh giá 1 công việc: {{model.indicatorName}}</span>
                        </div>
                    </b-col>
                ...
                <div class="container-fluid">
                    <b-card>
                        <div class="form-group row">
                          ...
                          <label class="col-md-4 m-0">Chức vụ</label>
                          <div class="col-lg-8 col-md-6 col-sm-8 col-24 d-flex app-object-code">
                            {{model.EmployeeTitle}}
                          </div>
                        </div>
                        <div class="form-group row">
                          <label class="col-md-4 m-0">Điểm</label>
                          <label class="col-md-20 m-0">{{model.LevelInt}}</label>
                        </div>
                        <div class="form-group row">
                          <label class="col-md-4 m-0">Xếp loại</label>
                          <label class="col-md-20 m-0">{{model.LevelResult}}</label>
                        </div>
                    </b-card>
                </div>
...
<script>
    ...
    const DeleteApi = 'task/api/evaluation-1job/delete';
