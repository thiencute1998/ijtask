                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Đánh giá 1 công việc</span>
                            </div>
                        </b-col>
                          ...
                          <div class="kanban-item col-lg-6 col-md-8 col-sm-12 col-24" v-for="(item, key) in itemsArray">
                            <div class="kanban-item-inner" @click="$_lists_onFieldClicked(item)">
                              <div class="kanban-record d-flex justify-content-between">
                                <span class="kanban-title">{{item.EmployeeID}}</span>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                    ...
                    {key: 'EmployeeID', label: 'Mã người đánh giá', field: 'EmployeeID', thStyle: 'width: 12%; min-width: 100px', searchOnTopRow: {type: 'text'}},
                    {key: 'EmployeeName', label: 'Tên người đánh giá', thStyle: 'min-width: 300px', field: 'EmployeeName',searchOnTopRow: {type: 'text'}},
                    {key: 'EmployeeTitle', label: 'Chức vụ', thStyle: 'min-width: 300px', field: 'EmployeeTitle',searchOnTopRow: {type: 'text'}},
                ];
        ...
        created() {
          ...
          this.settings.FieldID = 'LineID';
          this.settings.Table = 'task_evaluation_1job_trans';
          this.settings.FieldInactive = 'Inactive';
          this.settings.ListApi = 'task/api/evaluation-1job';
          this.settings.DeleteApi = 'task/api/evaluation-1job/delete';
          this.settings.CreateRouter = 'task-evaluation-1job-create';
          this.settings.EditRouter = 'task-evaluation-1job-edit';
          this.settings.ViewRouter = 'task-evaluation-1job-view';
        ...
        methods: {
            ...
            fetchData(){
                ...
                if (this.modelSearch.EmployeeID.trim() !== '') {
                    requestData.data.EmployeeID = this.modelSearch.EmployeeID;
                }
