                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Bảng điểm</span>
                            </div>
                        </b-col>
                          ...
                          <div class="kanban-item col-lg-6 col-md-8 col-sm-12 col-24" v-for="(item, key) in itemsArray">
                            <div class="kanban-item-inner" @click="$_lists_onFieldClicked(item)">
                              <div class="kanban-record d-flex justify-content-between">
                                <span class="kanban-title">{{item.ScaleRateName}}</span>
<!--                                <span class="kanban-title">{{item.MaxLevel}}</span>-->
                              </div>
                            </div>
                          </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                    ...
                    {key: 'ScaleRateName', label: 'Tên bảng điểm', field: 'ScaleRateName',searchOnTopRow: {type: 'text'}, thStyle: 'min-width: 300px'},
                    //{key: 'MaxLevel', label: 'Mức tối đa', field: 'MaxLevel',searchOnTopRow: {type: 'text'}, thStyle: 'max-width: 50px; text-align: center;'},
        ...
        created() {
          this.settings.FieldID = 'ScaleRateID';
          this.settings.Table = 'task_scale_rate';
          this.settings.FieldInactive = 'Inactive';

          this.settings.ListApi = 'task/api/scalerate';
          this.settings.DeleteApi = 'task/api/scalerate/delete';
          this.settings.CreateRouter = 'task-scalerate-create';
          this.settings.EditRouter = 'task-scalerate-edit';
          this.settings.ViewRouter = 'task-scalerate-view';
        ...
        mounted() {
          // this.$nextTick(() => {
          //   if ($('.b-table-sticky-header').length) {
          //     const ps = new PerfectScrollbar('.b-table-sticky-header', {
          //       wheelSpeed: 2,
        ...
        methods: {
          ...
          fetchData(){
              ...
              if (this.modelSearch.ScaleRateName !== '') {
                  requestData.data.ScaleRateName = this.modelSearch.ScaleRateName;
              }
