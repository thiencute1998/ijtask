    ...
    <div class="table-responsive">
        <table v-if="isForm" class="table b-table table-sm table-bordered table-editable">
            ...
            <tr v-for="(item, key) in this.value">
                <td class="NameObject"><IjcoreUploadFile v-model="value[key]"></IjcoreUploadFile></td>
                ...
                <td><input v-model="value[key].FileType" class="form-control"/></td>
                <td><input v-model="value[key].FileSize" class="form-control"/></td>
