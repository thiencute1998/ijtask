<template>
  <a @click="onToggleModal()" class="ij-a-icon" title="Thêm đánh giá">
    <i class="fa fa-external-link ij-icon" aria-hidden="true"></i>
    <b-modal ref="modal" id="modal-form-input-task-evaluation" scrollable size="xl">
      ...
      onUpdate() {
        ...
        ApiService.customRequest(requestData).then((responses) => {
          ...
          if (responsesData.status === 1) {
            ...
            self.$_storeTaskNotice(self.Task.TaskID, 'evaluation');
          } else {
...
<style>
  ...
  #modal-form-input-task-evaluation .modal-lg .modal-content {
    width: 1024px;
    margin: auto;
  }

  @media (max-width: 1024px) {
    #modal-form-input-task-evaluation .modal-lg {
      max-width: 100%;
    }
  ...
  @media (min-width: 992px) {
    ...
    #modal-form-input-task-evaluation .modal-lg, #modal-form-input-task-evaluation .modal-xl{
