                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Phiếu ĐGCV</span>
                            </div>
                        </b-col>
...
<!--                          </b-button>-->
                          <ijtask-button-dropdown-menu
                            ...
                            dropdown-header-text="Chu kỳ"
                            @on:click-button="handleAddNewItem"
                            :split="true"
                            :right="true"
                            text="Thêm">
                          </ijtask-button-dropdown-menu>
                          ...
                          <div class="kanban-item col-lg-6 col-md-8 col-sm-12 col-24" v-for="(item, key) in itemsArray">
                            <div class="kanban-item-inner" @click="$_lists_onFieldClicked(item)">
                              <div class="kanban-record d-flex justify-content-between">
                                <span class="kanban-title">{{item.TransName}}</span>
                              </div>
                            </div>
                          </div>
                        </div>
...
<script>
    ...
    import IjtaskButtonDropdownMenu from "@/components/IjtaskButtonDropdownMenu";
    ...
    export default {
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                    ...
                    {key: 'TransNo', label: 'Mã số', field: 'TransNo', thStyle: 'width: 12%; min-width: 100px', searchOnTopRow: {type: 'text'}},
                    {key: 'TransName', label: 'Tên', field: 'TransName',searchOnTopRow: {type: 'text'}, thStyle: 'min-width: 300px'},
        ...
        created() {
          ...
          this.settings.Table = 'task_evaluation_trans';
          this.settings.FieldInactive = 'Inactive';

          this.settings.ListApi = 'task/api/evaluation-trans';
          this.settings.DeleteApi = 'task/api/evaluation-trans/delete';
          this.settings.CreateRouter = 'task-evaluation-trans-create';
          this.settings.EditRouter = 'task-evaluation-trans-edit';
          this.settings.ViewRouter = 'task-evaluation-trans-view';
        ...
        methods: {
          ...
          fetchData(){
              ...
              if (this.modelSearch.bkbqldatp !== '') {
                requestData.data.TransNo = this.modelSearch.TransNo;
              }
              if (this.modelSearch.bkbqldatp !== '') {
                  requestData.data.TransName = this.modelSearch.TransName;
              }
