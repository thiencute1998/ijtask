                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Bảng chỉ tiêu ĐGCV</span>
                            </div>
                        </b-col>
                          ...
                          <div class="kanban-item col-lg-6 col-md-8 col-sm-12 col-24" v-for="(item, key) in itemsArray">
                            <div class="kanban-item-inner" @click="$_lists_onFieldClicked(item)">
                              <div class="kanban-record d-flex justify-content-between">
                                <span class="kanban-title">{{item.TableName}}</span>
                              </div>
                            </div>
                          </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                  ...
                  {key: 'TableNo', label: 'Mã số', field: 'TableNo', thStyle: 'width: 12%; min-width: 100px', searchOnTopRow: {type: 'text'}},
                  {key: 'TableName', label: 'Tên', field: 'TableName',searchOnTopRow: {type: 'text'}, thStyle: 'min-width: 300px'},
        ...
        created() {
          this.settings.FieldID = 'TableID';
          this.settings.Table = 'task_indicator_table';
          this.settings.FieldInactive = 'Inactive';

          this.settings.ListApi = 'task/api/indicator-table';
          this.settings.DeleteApi = 'task/api/indicator-table/delete';
          this.settings.CreateRouter = 'task-indicator-table-create';
          this.settings.EditRouter = 'task-indicator-table-edit';
          this.settings.ViewRouter = 'task-indicator-table-view';
        ...
        methods: {
          ...
          fetchData(){
              ...
              if (this.modelSearch.bkbqldatp !== '') {
                requestData.data.TableNo = this.modelSearch.TableNo;
              }
              if (this.modelSearch.bkbqldatp !== '') {
                  requestData.data.TableName = this.modelSearch.TableName;
              }
