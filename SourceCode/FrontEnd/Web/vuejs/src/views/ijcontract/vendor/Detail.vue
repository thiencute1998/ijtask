                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span><i class="icon-eye icon mr-2"></i> Nhà cung cấp: {{model.vendorName}}</span>
                        </div>
                    </b-col>
            ...
            <vue-perfect-scrollbar class="scroll-area" :settings="$store.state.psSettings">
                <div class="container-fluid">
                    <b-card>
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 m-0">Địa chỉ</label>
                            <label class="col-md-22 m-0">
                                {{model.address}}
                            </label>
                        </div>

                        <div class="form-group row">
                            <label class="col-md-2 m-0">ĐTĐV</label>
                            <label class="col-md-6 m-0">
                                {{model.officePhone}}
                            </label>
                            ...
                            <label class="col-md-8 m-0">
                                {{model.email}}
                            </label>
                        </div>

                        <div class="form-group row">
                            <label class="col-md-2 m-0">Website</label>
                            <label class="col-md-10 m-0">
                                {{model.website}}
                            </label>
                        </div>

                        <div class="form-group row">
                            <label class="col-md-2 m-0">Ghi chú</label>
                            <div class="col-md-22 m-0" id="view-Note">
                                {{model.note}}
                            </div>
                        </div>
                    </b-card>
