      ...
      <b-col class="col-md-12">
        ...
        <b-card no-body :no-block="true">
          ...
          <b-card-body>
            ...
            <b-row class="form-group">
              <b-col sm="7">
                <b-form-input type="text" placeholder=".col-sm-14"></b-form-input>
              </b-col>
            </b-row>
            <b-row class="form-group">
              <b-col sm="8">
                <b-form-input type="text" placeholder=".col-sm-16"></b-form-input>
              </b-col>
            </b-row>
            <b-row class="form-group">
              <b-col sm="9">
                <b-form-input type="text" placeholder=".col-sm-18"></b-form-input>
              </b-col>
            </b-row>
            <b-row class="form-group">
              <b-col sm="10">
                <b-form-input type="text" placeholder=".col-sm-20"></b-form-input>
              </b-col>
            </b-row>
            <b-row class="form-group">
              <b-col sm="11">
                <b-form-input type="text" placeholder=".col-sm-22"></b-form-input>
              </b-col>
            </b-row>
            <b-row class="form-group">
              <b-col sm="12">
                <b-form-input type="text" placeholder=".col-sm-24"></b-form-input>
              </b-col>
            </b-row>
          </b-card-body>
          <div slot="footer">
    ...
    <b-row>
      <b-col class="col-md-12">
        <b-card>
          ...
          <b-row class="form-group">
            <b-col md="8">
              <b-form-input type="text" placeholder=".col-md-16"></b-form-input>
            </b-col>
            <b-col md="4">
          ...
          <b-row class="form-group">
            <b-col md="7">
              <b-form-input type="text" placeholder=".col-md-14"></b-form-input>
            </b-col>
            <b-col md="5">
              <b-form-input type="text" placeholder=".col-md-10"></b-form-input>
            </b-col>
          </b-row>
          <b-row class="form-group">
            <b-col class="col-md-12">
              <b-form-input type="text" placeholder=".col-md-12"></b-form-input>
            </b-col>
            <b-col class="col-md-12">
              <b-form-input type="text" placeholder=".col-md-12"></b-form-input>
            </b-col>
      ...
      <b-col class="col-md-12">
        <b-card>
          ...
          <b-row class="form-group">
            ...
            <b-col cols="8">
              <b-form-input type="text" placeholder=".col-16"></b-form-input>
            </b-col>
          </b-row>
          <b-row class="form-group">
            <b-col cols="5">
              <b-form-input type="text" placeholder=".col-10"></b-form-input>
            </b-col>
            <b-col cols="7">
              <b-form-input type="text" placeholder=".col-14"></b-form-input>
            </b-col>
          </b-row>
          <b-row class="form-group">
            <b-col cols="6">
              <b-form-input type="text" placeholder=".col-12"></b-form-input>
            </b-col>
            <b-col cols="6">
              <b-form-input type="text" placeholder=".col-12"></b-form-input>
            </b-col>
