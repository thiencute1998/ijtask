  ...
  <div class="animated fadeIn">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="bd-example">
          <dl class="row">
            <dt class="col-sm-6">Description lists</dt>
            <dd class="col-sm-18">A description list is perfect for defining terms.</dd>

            <dt class="col-sm-6">Euismod</dt>
            <dd class="col-sm-18">
              <p>Vestibulum id ligula porta felis euismod semper eget lacinia odio sem nec elit.</p>
              <p>Donec id elit non mi porta gravida at eget metus.</p>
            </dd>

            <dt class="col-sm-6">Malesuada porta</dt>
            <dd class="col-sm-18">Etiam porta sem malesuada magna mollis euismod.</dd>

            <dt class="col-sm-6 text-truncate">Truncated term is truncated</dt>
            <dd class="col-sm-18">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus.</dd>

            <dt class="col-sm-6">Nesting</dt>
            <dd class="col-sm-18">
              <dl class="row">
                <dt class="col-sm-8">Nested definition list</dt>
                <dd class="col-sm-16">Aenean posuere, tortor sed cursus feugiat, nunc augue blandit nunc.</dd>
              </dl>
            </dd>
          </dl>
        </div>
