  ...
  <div class="animated fadeIn">
    <div class="email-app">
      <nav>
        ...
        <ul class="nav">
          <li class="nav-item">
            <router-link class="nav-link" to="./inbox"><i class="fa fa-inbox"></i> Inbox <b-badge variant="danger">4</b-badge></router-link>
          </li>
          <li class="nav-item">
      ...
      <main>
        ...
        <form>
          <div class="form-row mb-3">
            <label for="to" class="col-4 col-sm-2 col-form-label">To:</label>
            <b-col cols="12" sm="11">
