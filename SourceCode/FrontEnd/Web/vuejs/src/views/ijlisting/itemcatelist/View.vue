        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại vật tư - hàng hóa - dịch vụ: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại vật tư - hàng hóa - dịch vụ: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.itemCateValue">
...
const CreateRouter = 'listing-itemcatelist-create';
const ViewApi = 'listing/api/item-cate-list/view';
const ListApi = 'listing/api/item-cate-list';
const DeleteApi = 'listing/api/item-cate-list/delete';
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.itemCateList = responsesData.data.itemCateList;
          self.model.itemCateValue = responsesData.data.itemCateValue;

          let parentObj = _.find(self.model.itemCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
