                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Tiền tệ</span>
                            </div>
                        </b-col>
                    ...
                    <div class="content-body">
                      <div class="content-table content-body-list" v-if="stage.viewType === 'list'">
                        <b-table ref="selectableTable"
                          ...
                          <template v-slot:cell(ExpenseName)="data">
                          ...
                          <div class="kanban-item col-lg-6 col-md-8 col-sm-12 col-24" v-for="(item, key) in itemsArray">
                            <div class="kanban-item-inner" @click="$_lists_onFieldClicked(item)">
                              <div class="kanban-record d-flex justify-content-between">
                                <span class="kanban-title">{{item.CcyName}}</span>
                                <span class="kanban-no">{{item.CcyNo}}</span>
                              </div>
                            </div>
                          </div>
                        </div>
...
<script>
    ...
    const DeleteApi = 'listing/api/ccy/delete';
    ...
    export default {
      ...
      mixins: [mixinLists],
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                    ...
                    {key: 'CcyNo', label: 'Mã tiền tệ', thStyle: 'width: 12%; min-width: 100px', field: 'CcyNo',searchOnTopRow: {type: 'text'}},
                    {key: 'CcyName', label: 'Tên tiền tệ', field: 'CcyName',thStyle: 'min-width: 300px', searchOnTopRow: {type: 'text'}, tdClass: 'pr-3'},
                ];
        ...
        created() {
          this.settings.FieldID = 'CcyID';
          this.settings.Table = 'ccy';
          this.settings.FieldInactive = 'Inactive';

          this.settings.ListApi = 'listing/api/ccy';
          this.settings.DeleteApi = 'listing/api/ccy/delete';
          this.settings.CreateRouter = 'listing-ccy-create';
          this.settings.EditRouter = 'listing-ccy-edit';
          this.settings.ViewRouter = 'listing-ccy-view';
        ...
        methods: {
            ...
            fetchData(){
                ...
                if (this.modelSearch.CcyNo !== '') {
                    requestData.data.CcyNo = this.modelSearch.CcyNo;
                }
                if (this.modelSearch.CcyName !== '') {
                    requestData.data.CcyName = this.modelSearch.CcyName;
                }
            ...
            let request = {};
            if (this.modelSearch.CcyNo !== '') {
              request.CcyNo = this.modelSearch.CcyNo;
            }
            if (this.modelSearch.CcyName !== '') {
              request.CcyName = this.modelSearch.CcyName;
            }
