    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <coa-sna-per-field-view class="app-disable" :CoaSna="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'coa_sna'" v-model="field.AccessField"></coa-sna-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <coa-sna-per-field-view class="app-disable" :CoaSna="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'coa_sna'" v-model="field.EditField"></coa-sna-per-field-view>
          </td>
          <td class="pr-3 text-center">
...
export default {
  ...
  filters: {},
  props: ['title', 'value', 'name', 'api', 'table', 'Task', 'isDetail', 'per', 'EmployeeOption', 'CoaSnaOption'],
}
</script>
<style>
.mr-bottom-3 {
