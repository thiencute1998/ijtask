                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i>Hệ thống tài khoản Quốc Gia</span>
                            </div>
                        </b-col>
                    ...
                    <div class="main-header-filter pt-2">
                      <div class="row mb-2">
                        <div class="col-6 mb-2">
                          <coa-sna-modal-search-link
                            v-model="filter.CoaSnaLink"
...
<script>
    ...
    import CoaSnaModalSearchLink from "./partials/CoaSnaModalSearchLink";
    import CoaSnaModalSearchEmployee from "./partials/CoaSnaModalSearchEmployee";
    ...
    export default {
        ...
        data() {
            return {
              filter: {
                ...
                CoaSnaLink: (this.$route.query && this.$route.query.CoaSnaLink) ? this.$route.query.CoaSnaLink : [],
              }
            }
        },
        components:{
          CoaSnaModalSearchLink,
          CoaSnaModalSearchEmployee
        },
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                    ...
                    {key: 'AccountName', label: 'Tên Hệ thống tài khoản Quốc Gia', thStyle: 'min-width: 300px', field: 'AccountName',searchOnTopRow: {type: 'text'}},
                ];
        ...
        created() {
          ...
          this.settings.Table = 'coa_sna';
          this.settings.FieldInactive = 'Inactive';

          this.settings.ListApi = 'listing/api/coa-sna';
          this.settings.DeleteApi = 'listing/api/coa-sna/delete';
          this.settings.CreateRouter = 'listing-coa-sna-create';
          this.settings.EditRouter = 'listing-coa-sna-edit';
          this.settings.ViewRouter = 'listing-coa-sna-view';
        ...
        methods: {
            ...
            fetchData(){
              ...
              if (this.filter.CoaSnaLink.length) {
                let haveLink = false;
                _.forEach(this.filter.CoaSnaLink, function (coaSnaLink, key) {
                ...
                if (haveLink) {
                  requestData.data.CoaSnaLink = this.filter.CoaSnaLink;
                }
              }
            ...
            let reportJson = await this.$_lists_handleReportTemplate('coa-sna');
            let request = {};
            ...
            if (this.filter.CoaSnaLink.length) {
              ...
              if (haveLink) {
                request.CoaSnaLink = this.filter.CoaSnaLink;
              }
            }
            request.exportData = true;

            let reportData = await this.$_lists_handleReportResponse('listing/api/coa-sna/get-report-data', request);
            this.$_lists_handleDowloadExcel(reportJson, reportData, 'CoaSna');
          },
        },
        watch: {
            currentPage() {
