  ...
  <div>
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-17 col-sm-14 mb-sm-0 mb-md-0 col-20 mb-3 app-object-name">
        <input v-model="value.AccountName" type="text" id="AccountName" class="form-control" placeholder="Tên HTTK QG" name="AccountName"/>
      </div>
    ...
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-17">
        <IjcoreModalSystemParent v-model="value" :title="'Hệ thống tài khoản  Quốc gia'" :api="'/listing/api/common/list'" :table="'coa_sna'" :fieldName="'AccountName'" :fieldNo="'AccountNo'" :fieldID="'AccountID'" :currentID="value.AccountID" :placeholderInput="'Chọn hệ thống tài khoản  Quốc gia cha'" :placeholderSearch="'Nhập tên HTTK QG'" :columnID="'AccountID'" :columnNo="'AccountNo'" :columnName="'AccountName'">
        </IjcoreModalSystemParent>
      </div>
    ...
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-9">
        <coa-sna-modal-search-input-catelist v-model="value.CoaSnaCate" title-modal="Loại HTTK QG" placeholder="Loại HTTK QG">
        </coa-sna-modal-search-input-catelist>
      </div>
...
import CoaSnaModalSearchInputCatelist from "./CoaSnaModalSearchInputCatelist";
import IjcoreModalSearchInput from "../../../../components/IjcoreModalSearchInput";

export default {
  name: 'CoaSnaGeneralForm',
  props: ['value','coaSnaOptions','employeeOptions'],
  components: {
    Select2,
    IjcoreModalListing,
    IjcoreModalSystemParent,
