  ...
  <div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-9 m-0">
        <span v-for="(coaSnaCate, key) in value.CoaSnaCate">
          {{coaSnaCate.CateName}}: {{coaSnaCate.Description}} <span v-if="key < (value.CoaSnaCate.length - 1)"> , </span>
        </span>
      </div>
