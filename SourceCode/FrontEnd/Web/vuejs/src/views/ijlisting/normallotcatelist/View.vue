        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại tiêu chí phân bổ dự toán: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại Tiêu chí phân bổ dự toán: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.normAllotCateValue">
...
const CreateRouter = 'listing-normallotcatelist-create';
const ViewApi = 'listing/api/norm-allot-cate-list/view';
const ListApi = 'listing/api/norm-allot-cate-list';
const DeleteApi = 'listing/api/norm-allot-cate-list/delete';

export default {
  name: 'listing-view-norm-allot',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.normAllotCateList = responsesData.data.normAllotCateList;
          self.model.normAllotCateValue = responsesData.data.normAllotCateValue;

          let parentObj = _.find(self.model.normAllotCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
