                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i>Hệ thống tài khoản Quỹ tín dụng nhân dân</span>
                            </div>
                        </b-col>
                    ...
                    <div class="main-header-filter pt-2">
                      <div class="row mb-2">
                        <div class="col-6 mb-2">
                          <coa-pcf-modal-search-link
                            v-model="filter.CoaPcfLink"
...
<script>
    ...
    import CoaPcfModalSearchLink from "./partials/CoaPcfModalSearchLink";
    import CoaPcfModalSearchEmployee from "./partials/CoaPcfModalSearchEmployee";
    ...
    export default {
        ...
        data() {
            return {
              filter: {
                ...
                CoaPcfLink: (this.$route.query && this.$route.query.CoaPcfLink) ? this.$route.query.CoaPcfLink : [],
              }
            }
        },
        components:{
          CoaPcfModalSearchLink,
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                    ...
                    {key: 'AccountName', label: 'Tên Hệ thống tài khoản Quỹ tín dụng nhân dân', thStyle: 'min-width: 300px', field: 'AccountName',searchOnTopRow: {type: 'text'}},
                ];
        ...
        created() {
          ...
          this.settings.Table = 'coa_pcf';
          this.settings.FieldInactive = 'Inactive';

          this.settings.ListApi = 'listing/api/coa-pcf';
          this.settings.DeleteApi = 'listing/api/coa-pcf/delete';
          this.settings.CreateRouter = 'listing-coa-pcf-create';
          this.settings.EditRouter = 'listing-coa-pcf-edit';
          this.settings.ViewRouter = 'listing-coa-pcf-view';
        ...
        methods: {
            ...
            fetchData(){
              ...
              if (this.filter.CoaPcfLink.length) {
                let haveLink = false;
                _.forEach(this.filter.CoaPcfLink, function (coaPcfLink, key) {
                ...
                if (haveLink) {
                  requestData.data.CoaPcfLink = this.filter.CoaPcfLink;
                }
              }
            ...
            let reportJson = await this.$_lists_handleReportTemplate('coa-pcf');
            let request = {};
            ...
            if (this.filter.CoaPcfLink.length) {
              ...
              if (haveLink) {
                request.CoaPcfLink = this.filter.CoaPcfLink;
              }
            }
            request.exportData = true;

            let reportData = await this.$_lists_handleReportResponse('listing/api/coa-pcf/get-report-data', request);
            this.$_lists_handleDowloadExcel(reportJson, reportData, 'CoaPcf');
          },
        },
        watch: {
            currentPage() {
