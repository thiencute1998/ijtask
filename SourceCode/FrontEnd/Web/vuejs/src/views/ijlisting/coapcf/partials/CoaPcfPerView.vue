    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <coa-pcf-per-field-view class="app-disable" :CoaPcf="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'coa_pcf'" v-model="field.AccessField"></coa-pcf-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <coa-pcf-per-field-view class="app-disable" :CoaPcf="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'coa_pcf'" v-model="field.EditField"></coa-pcf-per-field-view>
          </td>
          <td class="pr-3 text-center">
...
export default {
  ...
  filters: {},
  props: ['title', 'value', 'name', 'api', 'table', 'Task', 'isDetail', 'per', 'EmployeeOption', 'CoaPcfOption'],
}
</script>
<style>
.mr-bottom-3 {
