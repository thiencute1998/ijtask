                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i>Hệ thống tài khoản Quỹ đầu tư phát triển địa phương</span>
                            </div>
                        </b-col>
                    ...
                    <div class="main-header-filter pt-2">
                      <div class="row mb-2">
                        <div class="col-6 mb-2">
                          <coa-ldi-modal-search-link
                            v-model="filter.CoaLdiLink"
...
<script>
    ...
    import CoaLdiModalSearchLink from "./partials/CoaLdiModalSearchLink";
    import CoaLdiModalSearchEmployee from "./partials/CoaLdiModalSearchEmployee";
    ...
    export default {
        ...
        data() {
            return {
              filter: {
                ...
                CoaLdiLink: (this.$route.query && this.$route.query.CoaLdiLink) ? this.$route.query.CoaLdiLink : [],
              }
            }
        },
        components:{
          CoaLdiModalSearchLink,
          CoaLdiModalSearchEmployee
        },
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                    ...
                    {key: 'AccountName', label: 'Tên Hệ thống tài khoản Quỹ đầu tư phát triển địa phương', thStyle: 'min-width: 300px', field: 'AccountName',searchOnTopRow: {type: 'text'}},
                ];
        ...
        created() {
          ...
          this.settings.Table = 'coa_ldi';
          this.settings.FieldInactive = 'Inactive';

          this.settings.ListApi = 'listing/api/coa-ldi';
          this.settings.DeleteApi = 'listing/api/coa-ldi/delete';
          this.settings.CreateRouter = 'listing-coa-ldi-create';
          this.settings.EditRouter = 'listing-coa-ldi-edit';
          this.settings.ViewRouter = 'listing-coa-ldi-view';
        ...
        methods: {
            ...
            fetchData(){
              ...
              if (this.filter.CoaLdiLink.length) {
                let haveLink = false;
                _.forEach(this.filter.CoaLdiLink, function (coaLdiLink, key) {
                ...
                if (haveLink) {
                  requestData.data.CoaLdiLink = this.filter.CoaLdiLink;
                }
              }
            ...
            let reportJson = await this.$_lists_handleReportTemplate('coa-ldi');
            let request = {};
            ...
            if (this.filter.CoaLdiLink.length) {
              ...
              if (haveLink) {
                request.CoaLdiLink = this.filter.CoaLdiLink;
              }
            }
            request.exportData = true;

            let reportData = await this.$_lists_handleReportResponse('listing/api/coa-ldi/get-report-data', request);
            this.$_lists_handleDowloadExcel(reportJson, reportData, 'CoaLdi');
          },
        },
        watch: {
            currentPage() {
