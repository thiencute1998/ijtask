  ...
  <div>
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-17 col-sm-14 mb-sm-0 mb-md-0 col-20 mb-3 app-object-name">
        <input v-model="value.AccountName" type="text" id="AccountName" class="form-control" placeholder="Tên HTTK QĐTPTĐP" name="AccountName"/>
      </div>
    ...
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-17">
        <IjcoreModalSystemParent v-model="value" :title="'Hệ thống tài khoản  quỹ đầu tư phát triển tư phương'" :api="'/listing/api/common/list'" :table="'coa_ldi'" :fieldID="'AccountID'" :fieldNo="'AccountNo'" :fieldName="'AccountName'" :currentID="value.AccountID" :placeholderInput="'Chọn hệ thống tài khoản  quỹ đầu tư phát triển tư phương cha'" :placeholderSearch="'Nhập tên HTTK QĐTPTĐP'" :columnID="'AccountID'" :columnNo="'AccountNo'" :columnName="'AccountName'">
        </IjcoreModalSystemParent>
      </div>
    ...
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-9">
        <coa-ldi-modal-search-input-catelist v-model="value.CoaLdiCate" title-modal="Loại HTTK QĐTPTĐP" placeholder="Loại HTTK QĐTPTĐP">
        </coa-ldi-modal-search-input-catelist>
      </div>
...
import CoaLdiModalSearchInputCatelist from "./CoaLdiModalSearchInputCatelist";
import IjcoreModalSearchInput from "../../../../components/IjcoreModalSearchInput";

export default {
  name: 'CoaLdiGeneralForm',
  props: ['value','coaLdiOptions','employeeOptions'],
  components: {
    Select2,
    IjcoreModalListing,
    IjcoreModalSystemParent,
