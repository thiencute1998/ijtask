    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <coa-ldi-per-field-view class="app-disable" :CoaLdi="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'coa_ldi'" v-model="field.AccessField"></coa-ldi-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <coa-ldi-per-field-view class="app-disable" :CoaLdi="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'coa_ldi'" v-model="field.EditField"></coa-ldi-per-field-view>
          </td>
          <td class="pr-3 text-center">
...
export default {
  ...
  filters: {},
  props: ['title', 'value', 'name', 'api', 'table', 'Task', 'isDetail', 'per', 'EmployeeOption', 'CoaLdiOption'],
}
</script>
<style>
.mr-bottom-3 {
