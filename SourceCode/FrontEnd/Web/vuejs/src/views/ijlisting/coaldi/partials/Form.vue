        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span v-if="idParams"><i class="fa fa-edit mr-2"></i> Hệ thống tài khoản  quỹ đầu tư phát triển địa phương<span v-if="model.AccountName">:</span> {{model.AccountName}}</span>
              <span v-if="!idParams"><i class="fa fa-plus mr-2"></i> Hệ thống tài khoản  quỹ đầu tư phát triển địa phương<span v-if="model.AccountName">:</span> {{model.AccountName}}</span>
            </div>
          </b-col>
          ...
          <b-card>
            <div class="form-group row align-items-center">
              ...
              <div class="col-md-17 col-sm-14 mb-sm-0 mb-md-0 col-20 mb-3 app-object-name">
                <input v-model="model.AccountName" type="text" id="AccountName" class="form-control" placeholder="Tên hệ thống tài khoản quỹ đầu tư phát triển địa phương" name="AccountName"/>
              </div>
            ...
            <div class="form-group row align-items-center">
              ...
              <div class="col-md-17">
                <IjcoreModalSystemParent v-model="model" :title="'Hệ thống tài khoản  quỹ đầu tư phát triển địa phương'" :api="'/listing/api/common/list'" :table="'coa_ldi'" :fieldID="'AccountID'" :fieldNo="'AccountNo'" :fieldName="'AccountName'" :placeholderInput="'Chọn hệ thống tài khoản  quỹ đầu tư phát triển địa phương cha'" :placeholderSearch="'Nhập tên HTTK QĐTPTĐP'" :columnID="'AccountID'" :columnNo="'AccountNo'" :columnName="'AccountName'">
                </IjcoreModalSystemParent>
              </div>
            ...
            <div class="form-group row align-items-center">
              ...
              <div class="col-md-9">
                <CoaLdiModalSearchInputCatelist
                  v-model="model.CoaLdiCate"
                  title-modal="Loại HTTK QĐTPTĐP"
                  placeholder="Loại hệ thống tài khoản  quỹ đầu tư phát triển địa phương"
                ></CoaLdiModalSearchInputCatelist>
              </div>
...
import CoaLdiModalSearchInputCatelist from "@/views/ijlisting/coaldi/partials/CoaLdiModalSearchInputCatelist";
import IjcoreModalSystemParent from "../../../../components/IjcoreModalSystemParent";
import CoaLdiModalSearchEmployee from './CoaLdiModalSearchEmployee';

const ListRouter = 'listing-coa-ldi';
const EditRouter = 'listing-coa-ldi-edit';
const ViewRouter = 'listing-coa-ldi-view';
const CreateRouter = 'listing-coa-ldi-create';
const ViewApi = 'listing/api/coa-ldi/view';
const EditApi = 'listing/api/coa-ldi/edit';
const CreateApi = 'listing/api/coa-ldi/create';
const StoreApi = 'listing/api/coa-ldi/store';
...
export default {
  ...
  methods: {
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          if (_.isArray(responsesData.data.coaLdi)) {

            self.model.CoaLdiOption = [];
            _.forEach(responsesData.data.coaLdi, function (value, key) {
              let tmpObj = {};
              tmpObj.id = value.AccountID;
              tmpObj.text = value.AccountName;
              self.model.CoaLdiOption.push(tmpObj);
            });
          }
    ...
    handleSubmitForm(){
      ...
      const requestData = {
        ...
        data: {
          ...
          CoaLdiCate: this.model.CoaLdiCate,
    ...
    changeUserContact() {
      ...
      if (employee) {
        this.model.LditactName = employee.text;
      }
    }
