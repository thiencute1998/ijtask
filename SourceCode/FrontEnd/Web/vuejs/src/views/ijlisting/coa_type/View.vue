                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span><i class="icon-eye icon mr-2"></i> Tiền tệ: {{model.CoaTypeName}}</span>
                        </div>
                    </b-col>
                    ...
                    <b-card>
                        <div class="form-body">
                            <div class="form-group row">
                              <div class="col-lg-3 col-md-4 mb-md-0 col-sm-2 mb-sm-0 col-4 mb-2" style="white-space: nowrap">Tên</div>
                              <div class="col-lg-16 col-md-14 col-sm-14 mb-sm-0 mb-md-0 col-20 mb-2 app-object-name">
                                {{model.CoaTypeName}}
                              </div>
                              <div class="col-lg-3 col-md-6 col-sm-8 col-24 d-flex app-object-code">
                                <span>Mã số</span>
                                {{model.CoaTypeNo}}
                              </div>
                            </div>
