                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Loại thê thống tài khoản</span>
                            </div>
                        </b-col>
                          ...
                          <div class="kanban-item col-lg-6 col-md-8 col-sm-12 col-24" v-for="(item, key) in itemsArray">
                            <div class="kanban-item-inner" @click="$_lists_onFieldClicked(item)">
                              <div class="kanban-record d-flex justify-content-between">
                                <span class="kanban-title">{{item.CoaTypeName}}</span>
                                <span class="kanban-no">{{item.CoaTypeNo}}</span>
                              </div>
                            </div>
                          </div>
                        </div>
...
<script>
    ...
    const DeleteApi = 'listing/api/coa_type/delete';
    ...
    export default {
      ...
      mixins: [mixinLists],
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                    ...
                    {key: 'CoaTypeNo', label: 'Mã số', thStyle: 'width: 12%; min-width: 100px', field: 'CoaTypeNo',searchOnTopRow: {type: 'text'}},
                    {key: 'CoaTypeName', label: 'Tên loại hệ thống tài khoản', field: 'CoaTypeName',thStyle: 'min-width: 300px', searchOnTopRow: {type: 'text'}, tdClass: 'pr-3'},
                ];
        ...
        created() {
          this.settings.FieldID = 'CoaTypeID';
          this.settings.Table = 'coa_type';
          this.settings.FieldInactive = 'Inactive';

          this.settings.ListApi = 'listing/api/coa_type';
          this.settings.DeleteApi = 'listing/api/coa_type/delete';
          this.settings.CreateRouter = 'listing-coa_type-create';
          this.settings.EditRouter = 'listing-coa_type-edit';
          this.settings.ViewRouter = 'listing-coa_type-view';
        ...
        methods: {
            ...
            fetchData(){
                ...
                if (this.modelSearch.CoaTypeNo !== '') {
                    requestData.data.CoaTypeNo = this.modelSearch.CoaTypeNo;
                }
