        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại nhà cung cấp: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại nhà cung cấp: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.vendorCateValue">
...
const CreateRouter = 'listing-vendorcatelist-create';
const ViewApi = 'listing/api/vendor-cate-list/view';
const ListApi = 'listing/api/vendor-cate-list';
const DeleteApi = 'listing/api/vendor-cate-list/delete';
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.vendorCateList = responsesData.data.vendorCateList;
