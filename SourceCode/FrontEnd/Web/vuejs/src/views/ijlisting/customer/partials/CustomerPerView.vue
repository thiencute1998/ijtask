    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <customer-per-field-view class="app-disable" :Customer="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'customer'" v-model="field.AccessField"></customer-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <customer-per-field-view class="app-disable" :Customer="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'customer'" v-model="field.EditField"></customer-per-field-view>
          </td>
          <td class="pr-3 text-center">
...
export default {
  ...
  filters: {},
  props: ['title', 'value', 'name', 'api', 'table', 'Task', 'isDetail', 'per', 'EmployeeOption', 'CustomerOption'],
}
</script>
<style>
.mr-bottom-3 {
