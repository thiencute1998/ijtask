                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span v-if="idParams"><i class="fa fa-edit mr-2"></i> Hệ thống tài khoản kho bạc nhà nước<span v-if="model.AccountName">:</span> {{model.AccountName}}</span>
                            <span v-if="!idParams"><i class="fa fa-plus mr-2"></i> Hệ thống tài khoản kho bạc nhà nước<span v-if="model.AccountName">:</span> {{model.AccountName}}</span>
                        </div>
                    </b-col>
                    ...
                    <b-card>
                        <div class="form-group row align-items-center">
                          ...
                          <div class="col-md-17 col-sm-14 mb-sm-0 mb-md-0 col-20 mb-3 app-object-name">
                            <input v-model="model.AccountName" type="text" id="AccountName" class="form-control" placeholder="Tên hệ thống tài khoản kho bạc nhà nước" name="AccountName"/>
                          </div>
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-md-17">
                              <IjcoreModalSystemParent
                                v-model="model"
                                :title="'Hệ thống tài khoản kho bạc nhà nước'"
                                :api="'/listing/api/common/get-parent'"
                                :table="'coa_tab'"
                                :fieldName="'AccountName'"
                                :fieldNo="'AccountNo'"
                                :fieldID="'AccountID'"
                                :placeholderInput="'Chọn hệ thống tài khoản  kho bạc nhà nước cha'"
                                :placeholderSearch="'Nhập tên HTTK KBNN'"
                                :columnID="'AccountID'"
                                :columnNo="'AccountNo'"
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-md-9">
                                <CoaTabModalSearchInputCatelist
                                  v-model="model.CoaTabCate"
                                  title-modal="Loại HTTK KBNN"
                                  placeholder="Loại hệ thống tài khoản  kho bạc nhà nước"
                                ></CoaTabModalSearchInputCatelist>
                            </div>
...
<script>
    ...
    import CoaTabModalSearchInputCatelist from "@/views/ijlisting/coatab/partials/CoaTabModalSearchInputCatelist";
    import IjcoreModalSystemParent from "../../../../components/IjcoreModalSystemParent";
    import CoaTabModalSearchEmployee from './CoaTabModalSearchEmployee';

    const ListRouter = 'listing-coa-tab';
    const EditRouter = 'listing-coa-tab-edit';
    const ViewRouter = 'listing-coa-tab-view';
    const CreateRouter = 'listing-coa-tab-create';
    const ViewApi = 'listing/api/coa-tab/view';
    const EditApi = 'listing/api/coa-tab/edit';
    const CreateApi = 'listing/api/coa-tab/create';
    const StoreApi = 'listing/api/coa-tab/store';
            ...
            fetchData() {
                ...
                ApiService.customRequest(requestData).then((responses) => {
                    ...
                    if (responsesData.status === 1) {
                        if (_.isArray(responsesData.data.coaTab)){

                            self.model.CoaTabOption = [];
                            _.forEach(responsesData.data.coaTab, function (value, key) {
                                let tmpObj = {};
                                tmpObj.id = value.AccountID;
                                tmpObj.text = value.AccountName;
                                self.model.CoaTabOption.push(tmpObj);
                            });
                        }
            ...
            handleSubmitForm(){
                ...
                const requestData = {
                    ...
                    data: {
                        ...
                        CoaTabCate: this.model.CoaTabCate,
              ...
              ApiService.customRequest(requestData).then((responses) => {
                ...
                if (responsesData.status === 1) {
                  ...
                  let item = {
                    ...
                    CoaTabCate: self.model.CoaTabCate,
                  }
