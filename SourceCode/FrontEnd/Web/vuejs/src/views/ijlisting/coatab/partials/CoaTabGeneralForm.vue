  ...
  <div>
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-17 col-sm-14 mb-sm-0 mb-md-0 col-20 mb-3 app-object-name">
        <input v-model="value.AccountName" type="text" id="AccountName" class="form-control" placeholder="Tên HTTK KBNN" name="AccountName"/>
      </div>
    ...
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-9">
        <coa-tab-modal-search-input-catelist v-model="value.CoaTabCate" title-modal="Loại HTTK KBNN" placeholder="Loại HTTK KBNN">
        </coa-tab-modal-search-input-catelist>
      </div>
...
import CoaTabModalSearchInputCatelist from "./CoaTabModalSearchInputCatelist";
import IjcoreModalSearchInput from "../../../../components/IjcoreModalSearchInput";

export default {
  name: 'CoaTabGeneralForm',
  props: ['value','coaTabOptions','employeeOptions'],
  components: {
    Select2,
    IjcoreModalListing,
    IjcoreModalSystemParent,
