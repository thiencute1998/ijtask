    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <coa-tab-per-field-view class="app-disable" :CoaTab="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'coa_tab'" v-model="field.AccessField"></coa-tab-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <coa-tab-per-field-view class="app-disable" :CoaTab="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'coa_tab'" v-model="field.EditField"></coa-tab-per-field-view>
          </td>
          <td class="pr-3 text-center">
...
export default {
  ...
  filters: {},
  props: ['title', 'value', 'name', 'api', 'table', 'Task', 'isDetail', 'per', 'EmployeeOption', 'CoaTabOption'],
}
</script>
<style>
.mr-bottom-3 {
