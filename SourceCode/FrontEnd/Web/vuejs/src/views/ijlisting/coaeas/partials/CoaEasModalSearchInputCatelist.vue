<template>
  <div class="ijcore ijcore-modal component-modal-search-ccatelist" @mouseenter="onMouseenter" @mouseleave="onMouseleave">
    ...
    >
      ...
      <div class="ijcore-modal-coa-eas-ccatelist ijcore-modal-search">
...
export default {
  name: 'coa-eas-modal-search-input-catelist',
  components: {
    Select2
  },
  props: {
  ...
  methods: {
    ...
    fetchData(){
      ...
      requestData.url= 'listing/api/coa-eas/get-coa-eas-cate-list';
      ...
      ApiService.customRequest(requestData)
        .then(response =>{
          ...
          self.CateList = responsesData.data.CoaEasCateList;
          ...
          self.CateValue = responsesData.data.CoaEasCateValue;
...
.ijcore-modal-coa-eas-ccatelist .select2.select2-container{
  width: 100%;
}
