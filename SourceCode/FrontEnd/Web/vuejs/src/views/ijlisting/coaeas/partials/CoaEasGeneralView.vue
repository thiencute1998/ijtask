  ...
  <div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-9 m-0">
        <span v-for="(coaEasCate, key) in value.CoaEasCate">
          {{coaEasCate.CateName}}: {{coaEasCate.Description}} <span v-if="key < (value.CoaEasCate.length - 1)"> , </span>
        </span>
      </div>
