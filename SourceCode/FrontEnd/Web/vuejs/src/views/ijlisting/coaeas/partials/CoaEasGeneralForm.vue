<template>
  <div>
    ...
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-9">
        <coa-con-modal-search-input-catelist v-model="value.CoaEasCate" title-modal="Loại HTTKHN" placeholder="Loại HTTKHN">
...
import CoaEasModalSearchInputCatelist from "./CoaEasModalSearchInputCatelist";
import IjcoreModalSearchInput from "../../../../components/IjcoreModalSearchInput";

export default {
  name: 'CoaEasGeneralForm',
  props: ['value','coaEasOptions','employeeOptions'],
  components: {
    Select2,
    IjcoreModalListing,
    IjcoreModalSystemParent,
