<template>
  <div>
    ...
    <b-modal scrollable ref="modal" id="modal-form-input-coa-eas-general" size="xl">
      <template v-slot:modal-title>
        <i class="fa fa-edit" v-if="isForm"></i><i class="icon-eye icon" v-else></i> {{title}}
      </template>
      <coa-eas-general-form v-model="value" :coaEasOptions="coaEasOptions" :employeeOptions="employeeOptions" v-if="isForm"></coa-eas-general-form>
      <coa-eas-general-view :isDetail="true" v-model="value" v-else></coa-eas-general-view>
...
import CoaEasGeneralView from "./CoaEasGeneralView";
import CoaEasGeneralForm from "./CoaEasGeneralForm";

export default {
  name: 'CoaEasGeneralModal',
  props: ['value','title'],
  components: {
    CoaEasGeneralView,
    CoaEasGeneralForm
  ...
  methods: {
    ...
    onUpdate(){
      ...
      let updateAPI = 'listing/api/coa-eas/update/';
      let requestData = {
        method: 'post',
        ...
        data: {
          ...
          CoaEasCate: this.value.CoaEasCate,
        ...
        .then(response=>{
          ...
          if(responsesData.status === 1){
            ...
            let item = {
              ...
              CoaEasCate: self.value.CoaEasCate,
