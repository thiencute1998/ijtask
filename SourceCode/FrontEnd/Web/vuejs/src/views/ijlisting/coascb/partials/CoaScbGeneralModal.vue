<template>
  <div>
    ...
    <b-modal scrollable ref="modal" id="modal-form-input-coa-scb-general" size="xl">
      <template v-slot:modal-title>
        <i class="fa fa-edit" v-if="isForm"></i><i class="icon-eye icon" v-else></i> {{title}}
      </template>
      <coa-scb-general-form v-model="value" :coaScbOptions="coaScbOptions" :employeeOptions="employeeOptions" v-if="isForm"></coa-scb-general-form>
      <coa-scb-general-view :isDetail="true" v-model="value" v-else></coa-scb-general-view>
...
import CoaScbGeneralView from "./CoaScbGeneralView";
import CoaScbGeneralForm from "./CoaScbGeneralForm";

export default {
  name: 'CoaScbGeneralModal',
  props: ['value','title'],
  components: {
    CoaScbGeneralView,
    CoaScbGeneralForm
  ...
  methods: {
    ...
    onUpdate(){
      ...
      let updateAPI = 'listing/api/coa-scb/update/';
      let requestData = {
        method: 'post',
        ...
        data: {
          ...
          CoaScbCate: this.value.CoaScbCate,
      ...
      .then(response=>{
        ...
        if(responsesData.status === 1){
          ...
          let item = {
            ...
            CoaScbCate: self.value.CoaScbCate,
