  ...
  <div>
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-17 col-sm-14 mb-sm-0 mb-md-0 col-20 mb-3 app-object-name">
        <input v-model="value.AccountName" type="text" id="AccountName" class="form-control" placeholder="Tên HTTKX" name="AccountName"/>
      </div>
    ...
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-9">
        <coa-scb-modal-search-input-catelist v-model="value.CoaScbCate" title-modal="Loại HTTKX" placeholder="Loại HTTKX">
        </coa-scb-modal-search-input-catelist>
      </div>
...
import CoaScbModalSearchInputCatelist from "./CoaScbModalSearchInputCatelist";
import IjcoreModalSearchInput from "../../../../components/IjcoreModalSearchInput";

export default {
  name: 'CoaScbGeneralForm',
  props: ['value','coaScbOptions','employeeOptions'],
  components: {
    Select2,
    IjcoreModalListing,
    IjcoreModalSystemParent,
