  ...
  <div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-9 m-0">
        <span v-for="(coaScbCate, key) in value.CoaScbCate">
          {{coaScbCate.CateName}}: {{coaScbCate.Description}} <span v-if="key < (value.CoaScbCate.length - 1)"> , </span>
        </span>
      </div>
