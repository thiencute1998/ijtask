        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại chương trình mục tiêu: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại chương trình mục tiêu: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.programCateValue">
...
const CreateRouter = 'listing-programcatelist-create';
const ViewApi = 'listing/api/program-cate-list/view';
const ListApi = 'listing/api/program-cate-list';
const DeleteApi = 'listing/api/program-cate-list/delete';

export default {
  name: 'listing-view-program',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.programCateList = responsesData.data.programCateList;
          self.model.programCateValue = responsesData.data.programCateValue;

          let parentObj = _.find(self.model.programCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
