  ...
  <div>
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-17 col-sm-14 mb-sm-0 mb-md-0 col-20 mb-3 app-object-name">
        <input v-model="value.AccountName" type="text" id="AccountName" class="form-control" placeholder="Tên HTTK BHXH" name="AccountName"/>
      </div>
    ...
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-17">
        <IjcoreModalSystemParent v-model="value" :title="'Hệ thống tài khoản  Quốc gia'" :api="'/listing/api/common/list'" :table="'coa_sia'" :fieldName="'AccountName'" :fieldNo="'AccountNo'" :fieldID="'AccountID'" :currentID="value.AccountID" :placeholderInput="'Chọn hệ thống tài khoản  Quốc gia cha'" :placeholderSearch="'Nhập tên HTTK BHXH'" :columnID="'AccountID'" :columnNo="'AccountNo'" :columnName="'AccountName'">
        </IjcoreModalSystemParent>
      </div>
    ...
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-9">
        <coa-sia-modal-search-input-catelist v-model="value.CoaSiaCate" title-modal="Loại HTTK BHXH" placeholder="Loại HTTK BHXH">
        </coa-sia-modal-search-input-catelist>
      </div>
...
import CoaSiaModalSearchInputCatelist from "./CoaSiaModalSearchInputCatelist";
import IjcoreModalSearchInput from "../../../../components/IjcoreModalSearchInput";

export default {
  name: 'CoaSiaGeneralForm',
  props: ['value','coaSiaOptions','employeeOptions'],
  components: {
    Select2,
    IjcoreModalListing,
    IjcoreModalSystemParent,
