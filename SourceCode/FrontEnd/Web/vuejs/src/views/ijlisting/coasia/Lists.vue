                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i>Hệ thống tài khoản bảo hiểm xã hội</span>
                            </div>
                        </b-col>
                    ...
                    <div class="main-header-filter pt-2">
                      <div class="row mb-2">
                        <div class="col-6 mb-2">
                          <coa-sia-modal-search-link
                            v-model="filter.CoaSiaLink"
...
<script>
    ...
    import CoaSiaModalSearchLink from "./partials/CoaSiaModalSearchLink";
    import CoaSiaModalSearchEmployee from "./partials/CoaSiaModalSearchEmployee";
    ...
    export default {
        ...
        data() {
            return {
              filter: {
                ...
                CoaSiaLink: (this.$route.query && this.$route.query.CoaSiaLink) ? this.$route.query.CoaSiaLink : [],
              }
            }
        },
        components:{
          CoaSiaModalSearchLink,
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                    ...
                    {key: 'AccountName', label: 'Tên Hệ thống tài khoản bảo hiểm xã hội', thStyle: 'min-width: 300px', field: 'AccountName',searchOnTopRow: {type: 'text'}},
                ];
        ...
        created() {
          ...
          this.settings.Table = 'coa_sia';
          this.settings.FieldInactive = 'Inactive';

          this.settings.ListApi = 'listing/api/coa-sia';
          this.settings.DeleteApi = 'listing/api/coa-sia/delete';
          this.settings.CreateRouter = 'listing-coa-sia-create';
          this.settings.EditRouter = 'listing-coa-sia-edit';
          this.settings.ViewRouter = 'listing-coa-sia-view';
        ...
        methods: {
            ...
            fetchData(){
              ...
              if (this.filter.CoaSiaLink.length) {
                let haveLink = false;
                _.forEach(this.filter.CoaSiaLink, function (coaSiaLink, key) {
                ...
                if (haveLink) {
                  requestData.data.CoaSiaLink = this.filter.CoaSiaLink;
                }
              }
            ...
            let reportJson = await this.$_lists_handleReportTemplate('coa-sia');
            let request = {};
            ...
            if (this.filter.CoaSiaLink.length) {
              ...
              if (haveLink) {
                request.CoaSiaLink = this.filter.CoaSiaLink;
              }
            }
            request.exportData = true;

            let reportData = await this.$_lists_handleReportResponse('listing/api/coa-sia/get-report-data', request);
            this.$_lists_handleDowloadExcel(reportJson, reportData, 'CoaSia');
          },
        },
        watch: {
            currentPage() {
