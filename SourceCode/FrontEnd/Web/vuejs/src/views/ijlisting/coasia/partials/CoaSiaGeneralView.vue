  ...
  <div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-9 m-0">
        <span v-for="(coaSiaCate, key) in value.CoaSiaCate">
          {{coaSiaCate.CateName}}: {{coaSiaCate.Description}} <span v-if="key < (value.CoaSiaCate.length - 1)"> , </span>
        </span>
      </div>
