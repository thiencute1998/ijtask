        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại nhân viên: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại nhân viên: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.employeeCateValue">
...
const CreateRouter = 'listing-employeecatelist-create';
const ViewApi = 'listing/api/employee-cate-list/view';
const ListApi = 'listing/api/employee-cate-list';
const DeleteApi = 'listing/api/employee-cate-list/delete';

export default {
  name: 'listing-view-employee',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.employeeCateList = responsesData.data.employeeCateList;
          self.model.employeeCateValue = responsesData.data.employeeCateValue;

          let parentObj = _.find(self.model.employeeCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
