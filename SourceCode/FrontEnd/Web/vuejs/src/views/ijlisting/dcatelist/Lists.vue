                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Loại tài liệu</span>
                            </div>
                        </b-col>
                    ...
                    <div class="content-body">
                      <div class="content-table content-body-list" v-if="stage.viewType === 'list'">
                        <b-table ref="selectableTable"
                          ...
                          <template v-slot:cell(CateName)="data">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                    ...
                    {key: 'CateName', label: 'Tên loại khách hàng', field: 'CateName',searchOnTopRow: {type: 'text'},thStyle: 'min-width: 300px'},
                ];
        ...
        created() {
          ...
          this.settings.Table = 'doc_cate_list';
          this.settings.FieldInactive = 'Inactive';

          this.settings.ListApi = 'listing/api/doc-cate-list';
          this.settings.DeleteApi = 'listing/api/doc-cate-list/delete';
          this.settings.CreateRouter = 'listing-dcatelist-create';
          this.settings.EditRouter = 'listing-dcatelist-edit';
          this.settings.ViewRouter = 'listing-dcatelist-view';
