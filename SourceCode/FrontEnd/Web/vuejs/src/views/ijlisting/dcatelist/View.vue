                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span><i class="icon-eye icon mr-2"></i> Loại tài liệu: {{model.CateName}}</span>
                        </div>
                    </b-col>
                    ...
                    <b-card>
                        <div class="form-body">
                            <div class="form-group row">
                                <label class="col-md-4 m-0">Tên loại tài liệu</label>
                            ...
                            <div class="form-group row">
                                <label class="col-md-4 m-0">Giá trị loại tài liệu:</label>
...
<script>
    ...
    const DeleteApi = 'listing/api/doc-cate-list/delete';
            ...
            fetchData() {
                ...
                ApiService.customRequest(requestData).then((responses) => {
                    ...
                    if (responsesData.status === 1) {
                        ...
                        self.model.docCateList = responsesData.data.docCateList;
                        self.model.docCateValue = responsesData.data.docCateValue;

                        let parentObj = _.find(self.model.docCateList, ['CateID', self.model.parentID]);
                        if (parentObj) {
