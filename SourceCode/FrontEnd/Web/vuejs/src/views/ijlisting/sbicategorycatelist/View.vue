        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại -loại khoản: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại -loại khoản: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.sbiCategoryCateValue">
...
const CreateRouter = 'listing-sbicategorycatelist-create';
const ViewApi = 'listing/api/sbi-category-cate-list/view';
const ListApi = 'listing/api/sbi-category-cate-list';
const DeleteApi = 'listing/api/sbi-category-cate-list/delete';

export default {
  name: 'listing-view-sbi-category',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.sbiCategoryCateList = responsesData.data.sbiCategoryCateList;
          self.model.sbiCategoryCateValue = responsesData.data.sbiCategoryCateValue;

          let parentObj = _.find(self.model.sbiCategoryCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
