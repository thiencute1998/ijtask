        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại hệ thống tài khoản doanh nghiệp: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại hệ thống tài khoản doanh nghiệp: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.coaEasCateValue">
...
const CreateRouter = 'listing-coaeascatelist-create';
const ViewApi = 'listing/api/coa-eas-cate-list/view';
const ListApi = 'listing/api/coa-eas-cate-list';
const DeleteApi = 'listing/api/coa-eas-cate-list/delete';

export default {
  name: 'listing-view-coa-eas',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.coaEasCateList = responsesData.data.coaEasCateList;
          self.model.coaEasCateValue = responsesData.data.coaEasCateValue;

          let parentObj = _.find(self.model.coaEasCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
