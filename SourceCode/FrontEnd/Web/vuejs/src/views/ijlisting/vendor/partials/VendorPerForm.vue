    ...
    <div class="table-responsive">
      <table class="not-border mb-2">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <vendor-per-field-form :Vendor="value" :disable="!per[key].Access" :keyPer="key" :title="'Phân quyền'" field-model="AccessField" :table="'doc'" v-model="field.AccessField" @updateFromChild="updateParent"></vendor-per-field-form>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <vendor-per-field-form :Vendor="value" :disable="!per[key].Edit" :keyPer="key" :title="'Phân quyền'" field-model="EditField" :table="'doc'" v-model="field.EditField" @updateFromChild="updateParent"></vendor-per-field-form>
          </td>
          <td class="pr-3 text-center">
...
<script>
  ...
  import VendorPerFieldView from "./VendorPerFieldView";
  import VendorPerFieldForm from "./VendorPerFieldForm";
  import Select2 from 'v-select2-component';
  import IjcoreModalMultiListing from "../../../../components/IjcoreModalMultiListing";

  export default {
    name: 'VendorPerForm',
    components: {IjcoreModalMultiListing, VendorPerFieldForm, VendorPerFieldView, Select2},
    computed: {},
    data() {
      return {
        OptionAccessType: {
