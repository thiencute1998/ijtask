...
<!--          </b-button>-->
        ...
        <div class="ijcore-search-vendor-vcatelist ijcore-modal-search">
    ...
    export default {
      ...
      methods: {
        ...
        fetchData(){
          ...
          requestData.url = '/listing/api/vendor/get-cate-list';
          ...
          ApiService.customRequest(requestData).then((responses) => {
            ...
            if (responsesData.status === 1) {
              self.CateList = responsesData.data.VendorCateList;
              ...
              self.CateValue = responsesData.data.VendorCateValue;
...
<style lang="css">
  ...
  .ijcore-search-vendor-vcatelist .select2.select2-container {
    width: 100% !important;
  }
