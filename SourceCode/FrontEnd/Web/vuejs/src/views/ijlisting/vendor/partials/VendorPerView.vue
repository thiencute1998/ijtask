    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <vendor-per-field-view class="app-disable" :Vendor="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'vendor'" v-model="field.AccessField"></vendor-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <vendor-per-field-view class="app-disable" :Vendor="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'vendor'" v-model="field.EditField"></vendor-per-field-view>
          </td>
          <td class="pr-3 text-center">
