  ...
  <div>
    <div class="form-group row align-items-center">
      ...
      <div class="col-lg-17 col-md-20 col-sm-20 mb-sm-2 mb-md-3 mb-lg-0 mb-3 app-object-name">
        <input v-model="value.VendorName" type="text" class="form-control" placeholder="Tên nhà cung cấp"/>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-8 app-object-code d-md-none d-sm-none d-none d-lg-flex align-items-center">
        <span>Mã số</span>
        <input type="text" v-model="value.VendorNo" class="form-control" placeholder="Mã số"/>
      </div>
    ...
    <div class="form-group row align-items-center">
      <label class="col-lg-3 col-md-4 col-sm-4 m-0 mb-lg-0 mb-md-3 mb-sm-3" for="Address" title="Địa chỉ giao dịch">Địa chỉ GD</label>
    ...
    <div class="form-group row align-items-center">
      <label class="col-lg-3 col-md-4 col-sm-4 m-0 mb-lg-0 mb-md-3 mb-sm-3" for="Address" title="Địa chỉ nhận hàng">Địa chỉ NH</label>
      <div class="col-lg-9 col-md-20 col-sm-20 mb-lg-0 mb-md-3 mb-sm-3 mb-3">
    ...
    <div class="form-group row align-items-center">
      <label class="col-lg-3 col-md-4 col-sm-4 m-0 mb-lg-0 mb-md-3 mb-sm-3" for="OfficePhone" title="Điện thoại đơn vị">ĐTĐV</label>
    ...
    <div class="form-group row align-items-center">
      ...
      <label class="col-lg-2 col-md-4 col-sm-4 m-0 pr-0" title="Là khách hàng">Là KH</label>
      <div class="col-lg-4 col-md-3 col-sm-20">
...
<script>
  ...
  import VendorModalSearchInputVcatelist from "./VendorModalSearchInputVcatelist";

  export default {
    name: 'vendor-general-form',
    components: {IjcoreDatePicker, Select2, IjcoreModalSearchInput, VendorModalSearchInputVcatelist},
    computed: {},
    data() {
      return {
        AccessTypeOptions:{
    ...
    props: ['title', 'value', 'name', 'api', 'table', 'Task', 'isDetail', 'per', 'EmployeeOption', 'CompanyOption', 'VendorPerEmployee'],
  }
</script>
<style>
  .table th, .table td {
