        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại hợp đồng: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại hợp đồng: </label>
...
const CreateRouter = 'listing-contractcatelist-create';
const ViewApi = 'listing/api/contract-cate-list/view';
const ListApi = 'listing/api/contract-cate-list';
const DeleteApi = 'listing/api/contract-cate-list/delete';

export default {
  name: 'listing-view-contract',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.contractCateList = responsesData.data.contractCateList;
          self.model.contractCateValue = responsesData.data.contractCateValue;

          let parentObj = _.find(self.model.contractCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
