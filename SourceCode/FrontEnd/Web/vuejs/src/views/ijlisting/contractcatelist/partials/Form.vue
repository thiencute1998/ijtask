          ...
          <b-card>
            <div class="form-group row align-items-center">
              ...
              <div class="col-md-17 col-sm-14 mb-sm-0 mb-md-0 col-20 mb-3 app-object-name">
                <input v-model="model.CateName" type="text" id="RevenuName" class="form-control" placeholder="Tên hợp đồng" name="RevenuName"/>
              </div>
            ...
            <div class="form-group row align-items-center">
              ...
              <div class="col-md-17">
                <IjcoreModalSystemParentCate
                  ...
                  :fieldNo="'CateNo'"
                  :fieldID="'CateID'"
                  :placeholderInput="'Chọn loại hợp đồng cha'"
                  :placeholderSearch="'Nhập loại hợp đồng'"
                  :columnID="'CateID'"
                  :columnNo="'CateNo'"
                  :columnName="'CateName'"
                >
            ...
            <table class="table b-table table-sm table-bordered table-editable">
              ...
              <draggable v-model="model.contractCateValue" tag="tbody" draggable=".draggable" handle=".my-handle" @change="changeContractTableItem">
                <tr class="draggable" v-for="(field, key) in model.contractCateValue">
...
const ListRouter = 'listing-contractcatelist';
const EditRouter = 'listing-contractcatelist-edit';
const CreateRouter = 'listing-contractcatelist-edit';
const ViewRouter = 'listing-contractcatelist-view';
          ...
          if (self.idParams || !_.isEmpty(self.itemCopy)) {
            if (_.isObject(responsesData.data.data)) {
              if( responsesData.data.data.ParentID){
                ...
                let Parent = _.filter(responsesData.data.contractCateList, ["CateID", responsesData.data.data.ParentID])
