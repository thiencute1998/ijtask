                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span><i class="icon-eye icon mr-2"></i> Loại giao dịch báo giá: {{model.CateName}}</span>
                        </div>
                    </b-col>
                    ...
                    <b-card>
                        <div class="form-body">
                            <div class="form-group row">
                                <label class="col-md-4 m-0">Tên loại GDKD</label>
                            ...
                            <div class="form-group row">
                                <label class="col-md-4 m-0">Giá trị loại GDBG:</label>
                            ...
                            <table class="table b-table table-sm table-bordered">
                                ...
                                <tr v-for="(field, key) in model.customerQuotationTransCateValue">
                                    <td class="has-padding">{{field.CateValue}}</td>
                                    <td>{{model.dataTypeOption[field.DataType]}}</td>
                                    <td v-if="field.DataType == 1 || field.DataType == 2 || field.DataType == 3 || field.DataType == 4">{{field.ConvertedValue}}</td>
                                    <td v-if="field.DataType == 5">
                                        <span v-if="field.ConvertedValue == 1">Có</span>
                                        <span v-if="field.ConvertedValue == 2">Không</span>
                                    </td>
                                    <td v-if="field.DataType == 6">
                                        <span v-if="field.ConvertedValue == 1">Đúng</span>
                                        <span v-if="field.ConvertedValue == 2">Sai</span>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
...
<script>
    ...
    const DeleteApi = 'listing/api/customer-quotation-trans-cate-list/delete';
        ...
        data () {
            return {
                ...
                model: {
                    ...
                    customerQuotationTransCateList: [],
                    dataTypeOption: {
                        1: 'Số',
                        2: 'Kí tự',
                        3: 'Ngày',
            ...
            fetchData() {
                ...
                ApiService.customRequest(requestData).then((responses) => {
                    ...
                    if (responsesData.status === 1) {
                        ...
                        self.model.customerQuotationTransCateList = responsesData.data.customerQuotationTransCateList;
                        self.model.customerQuotationTransCateValue = responsesData.data.customerQuotationTransCateValue;

                        // let parentObj = _.find(self.model.customerQuotationTransCateList, ['CateID', self.model.parentID]);
                        // if (parentObj) {
