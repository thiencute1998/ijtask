  ...
  <div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-21 m-0">
        <span v-for="(coaConCate, key) in value.CoaConCate">
          {{coaConCate.CateName}}: {{coaConCate.Description}} <span v-if="key < (value.CoaConCate.length - 1)"> , </span>
        </span>
      </div>
