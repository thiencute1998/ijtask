...
<script>
    ...
    import CoaConModalSearchInputCatelist from "@/views/ijlisting/coacon/partials/CoaConModalSearchInputCatelist";
            ...
            fetchData() {
                ...
                ApiService.customRequest(requestData).then((responses) => {
                    ...
                    if (responsesData.status === 1) {
                        if (_.isArray(responsesData.data.coaCon)){

                            self.model.CoaConOption = [];
                            _.forEach(responsesData.data.coaCon, function (value, key) {
                                let tmpObj = {};
                                tmpObj.id = value.AccountID;
                                tmpObj.text = value.AccountName;
                                self.model.CoaConOption.push(tmpObj);
                            });
                        }
            ...
            handleSubmitForm(){
                ...
                const requestData = {
                    ...
                    data: {
                        ...
                        CoaConCate: this.model.CoaConCate,
              ...
              ApiService.customRequest(requestData).then((responses) => {
                ...
                if (responsesData.status === 1) {
                  ...
                  let item = {
                    ...
                    CoaConCate: self.model.CoaConCate,
                  }
