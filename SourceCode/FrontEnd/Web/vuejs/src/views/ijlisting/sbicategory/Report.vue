  ...
  <div class="main-entry">
        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="fa fa-print mr-2"></i> Loại khoản</span>
            </div>
          </b-col>
    ...
    <div class="main-body">
      <ijcore-report-viewer-listing
        ref="report-viewer"
        report-name="sbi-category"
        :filter="filter"
        @changeReport="updateReport"
        report-data-api="listing/api/sbi-category/get-report-data"></ijcore-report-viewer-listing>
    </div>
...
<script>
  ...
  export default {
    name: 'listing-sbi-category-view',
    data () {
      return {
