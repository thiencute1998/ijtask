        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại dự án: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại dự án: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.projectCateValue">
...
const CreateRouter = 'listing-projectcatelist-create';
const ViewApi = 'listing/api/project-cate-list/view';
const ListApi = 'listing/api/project-cate-list';
const DeleteApi = 'listing/api/project-cate-list/delete';

export default {
  name: 'listing-view-project',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.projectCateList = responsesData.data.projectCateList;
          self.model.projectCateValue = responsesData.data.projectCateValue;

          let parentObj = _.find(self.model.projectCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
