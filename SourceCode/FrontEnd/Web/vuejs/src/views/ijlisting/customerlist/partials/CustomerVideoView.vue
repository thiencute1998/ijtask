    ...
    <table class="not-border">
      ...
      <tr v-for="(item, key) in value">
        ...
        <td style="text-align: center;width: auto; position: absolute; right: 15px;">
          ...
          <customer-video-edit :Customer="Customer" v-model="value[key]"></customer-video-edit>
  ...
  export default {
    ...
    methods: {
      ...
      downloadVideo(FileID, name) {
        let self = this;
        let urlApi = '/listing/api/customer/download-video/' + FileID;
        let requestData = {
          method: 'get',
          url: urlApi,
          data: {},
      ...
      viewVideo(key) {
        ...
        var ValidCustomerTypes = ["pptx", "ppt", "xls", "xlsx", "doc", "docx"];
        let self = this;
        let urlApi = '/listing/api/customer/download-video/' + this.value[key].FileID;
        let requestData = {
          method: 'get',
          url: urlApi,
          data: {},
      ...
      deleteLine(key) {
        let self = this;
        let urlApi = '/listing/api/customer/delete-video/' + self.value[key].LineID;
        let requestData = {
          method: 'post',
          url: urlApi,
          data: {},
