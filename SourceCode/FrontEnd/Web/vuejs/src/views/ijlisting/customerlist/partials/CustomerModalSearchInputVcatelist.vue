...
<!--          </b-button>-->
        ...
        <div class="ijcore-search-customer-vcatelist ijcore-modal-search">
    ...
    export default {
      ...
      methods: {
        ...
        fetchData(){
          ...
          requestData.url = '/listing/api/customer/get-cate-list';
...
<style lang="css">
  ...
  .ijcore-search-customer-vcatelist .select2.select2-container {
    width: 100% !important;
  }
