    ...
    export default {
      ...
      mixins: [mixinLists],
        ...
        created() {
          ...
          this.settings.ListApi = 'listing/api/customerlist';
          this.settings.DeleteApi = 'listing/api/customerlist/delete';
          this.settings.CreateRouter = 'listing-customerlist-create';
          this.settings.EditRouter = 'listing-customerlist-edit';
          this.settings.ViewRouter = 'listing-customerlist-view';
          this.modelSearch = {
