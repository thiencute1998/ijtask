                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Loại công việc</span>
                            </div>
                        </b-col>
...
<script>
    ...
    export default {
      ...
      computed: {
          ...
          captions: function() {
              let fieldsTable = [
                  ...
                  {key: 'CateName', label: 'Tên loại công việc',thStyle: 'min-width: 300px', field: 'CateName',searchOnTopRow: {type: 'text'}},
              ];
      ...
      created() {
        ...
        this.settings.Table = 'task_cate';
        this.settings.FieldInactive = 'Inactive';

        this.settings.ListApi = 'listing/api/task-cate-list';
        this.settings.DeleteApi = 'listing/api/task-cate-list/delete';
        this.settings.CreateRouter = 'listing-tcatelist-create';
        this.settings.EditRouter = 'listing-tcatelist-edit';
        this.settings.ViewRouter = 'listing-tcatelist-view';
