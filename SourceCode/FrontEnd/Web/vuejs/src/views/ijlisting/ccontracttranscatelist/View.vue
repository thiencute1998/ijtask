                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span><i class="icon-eye icon mr-2"></i> Loại giao dịch hợp đồng bán hàng: {{model.CateName}}</span>
                        </div>
                    </b-col>
                ...
                <div class="container-fluid">
                    <b-card>
                        <div class="form-body">
                            ...
                            <div class="form-group row">
                                <label class="col-md-4 m-0">Giá trị loại GDHĐBH:</label>
...
<script>
    ...
    const DeleteApi = 'listing/api/customer-contract-trans-cate-list/delete';
            ...
            fetchData() {
                ...
                ApiService.customRequest(requestData).then((responses) => {
                    ...
                    if (responsesData.status === 1) {
                        ...
                        self.model.customerContractTransCateList = responsesData.data.customerContractTransCateList;
                        self.model.customerContractTransCateValue = responsesData.data.customerContractTransCateValue;

                        // let parentObj = _.find(self.model.customerContractTransCateList, ['CateID', self.model.parentID]);
                        // if (parentObj) {
