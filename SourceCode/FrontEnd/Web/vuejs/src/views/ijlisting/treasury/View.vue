        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Kho bạc: {{model.TreasuryName}}</span>
            </div>
          </b-col>
          ...
          <b-card>
            ...
            <div class="form-group row align-items-center">
              ...
              <div class="col-md-6 col-sm-8 col-24 d-flex align-items-center app-object-code">
                ...
                <span v-if="model.BudgetLevel == 1">KBNN trung ương</span>
                <span v-if="model.BudgetLevel == 2">KBNN tỉnh</span>
                <span v-if="model.BudgetLevel == 3">KBNN huyện</span>
              </div>
            </div>

            <div class="form-group row align-items-center">
              <label v-show="model.activeProvince" class="col-md-3 m-0">Tỉnh</label>
              <div v-show="model.activeProvince" class="col-md-5 mb-3 mb-sm-0 mb-md-0 mb-lg-0">
                {{ model.Province }}
              </div>
              <label v-show="model.activeDistrict" class="col-md-2 m-0">Huyện</label>
              <div v-show="model.activeDistrict" class="col-md-5 mb-3 mb-sm-0 mb-md-0 mb-lg-0">
                {{ model.District }}
              </div>
            </div>
...
const CreateRouter = 'listing-treasury-create';
const ViewApi = 'listing/api/treasury/view';
const ListApi = 'listing/api/treasury';
const DeleteApi = 'listing/api/treasury/delete';

export default {
  name: 'listing-view-treasury',
  data () {
    return {
