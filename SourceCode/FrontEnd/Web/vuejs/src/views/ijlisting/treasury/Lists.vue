                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Kho bạc</span>
                            </div>
                        </b-col>
                          ...
                          <div class="kanban-item col-lg-6 col-md-8 col-sm-12 col-24" v-for="(item, key) in itemsArray">
                            <div class="kanban-item-inner" @click="$_lists_onFieldClicked(item)">
                              <div class="kanban-record d-flex justify-content-between">
                                <span class="kanban-title">{{item.TreasuryName}}</span>
                                <span class="kanban-no">{{item.TreasuryNo}}</span>
                              </div>
                              <div class="kanban-record">
                                <span class="kanban-text" v-if="item.TreasuryAddress && item.TreasuryAddress !== ''">{{item.TreasuryAddress}}</span>
                              </div>
                            </div>
                          </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                    ...
                    {key: 'TreasuryNo', label: 'Mã số', field: 'TreasuryNo', thStyle: 'width: 12%; min-width: 100px', searchOnTopRow: {type: 'text'}},
                    {key: 'TreasuryName', label: 'Tên kho bạc', thStyle: 'min-width: 300px', field: 'TreasuryName',searchOnTopRow: {type: 'text'}},
                    {key: 'TreasuryAddress', label: 'Địa chỉ', thStyle: 'width: 15%; min-width: 150px', field: 'TreasuryAddress',searchOnTopRow: {type: 'text'}},
                ];
        ...
        created() {
          ...
          this.settings.FieldID = 'TreasuryID';
          this.settings.Table = 'treasury';
          this.settings.FieldInactive = 'Inactive';

          this.settings.ListApi = 'listing/api/treasury';
          this.settings.DeleteApi = 'listing/api/treasury/delete';
          this.settings.CreateRouter = 'listing-treasury-create';
          this.settings.EditRouter = 'listing-treasury-edit';
          this.settings.ViewRouter = 'listing-treasury-view';
        ...
        methods: {
            ...
            fetchData(){
              ...
              if (this.modelSearch.TreasuryNo.trim() !== '') {
                  requestData.data.TreasuryNo = this.modelSearch.TreasuryNo;
              }
              if (this.modelSearch.TreasuryName !== '') {
                  requestData.data.TreasuryName = this.modelSearch.TreasuryName;
              }
              if (this.modelSearch.TreasuryAddress !== '') {
                  requestData.data.TreasuryAddress = this.modelSearch.TreasuryAddress;
              }
