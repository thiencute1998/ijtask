        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại hệ thống tài khoản kho bạc nhà nước: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại hệ thống tài khoản kho bạc nhà nước: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.coaTabCateValue">
...
const CreateRouter = 'listing-coatabcatelist-create';
const ViewApi = 'listing/api/coa-tab-cate-list/view';
const ListApi = 'listing/api/coa-tab-cate-list';
const DeleteApi = 'listing/api/coa-tab-cate-list/delete';

export default {
  name: 'listing-view-coa-tab',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.coaTabCateList = responsesData.data.coaTabCateList;
          self.model.coaTabCateValue = responsesData.data.coaTabCateValue;

          let parentObj = _.find(self.model.coaTabCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
