        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại hệ thống tài khoản xã hội: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại hệ thống tài khoản xã hội: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.coaScbCateValue">
...
const CreateRouter = 'listing-coascbcatelist-create';
const ViewApi = 'listing/api/coa-scb-cate-list/view';
const ListApi = 'listing/api/coa-scb-cate-list';
const DeleteApi = 'listing/api/coa-scb-cate-list/delete';

export default {
  name: 'listing-view-coa-scb',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.coaScbCateList = responsesData.data.coaScbCateList;
          self.model.coaScbCateValue = responsesData.data.coaScbCateValue;

          let parentObj = _.find(self.model.coaScbCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
