  ...
  <div class="main-entry">
        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="fa fa-print mr-2"></i> Chương Trình Mục Tiêu </span>
            </div>
          </b-col>
    ...
    <div class="main-body">
      <ijcore-report-viewer-listing
        ...
        report-data-api="listing/api/program/get-report-data"></ijcore-report-viewer-listing>
    </div>
