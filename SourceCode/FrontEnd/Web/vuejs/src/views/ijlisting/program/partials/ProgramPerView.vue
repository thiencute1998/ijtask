...
<!--          <th class="pr-3">Thêm</th>-->
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <program-per-field-view class="app-disable" :Program="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'program'" v-model="field.AccessField"></program-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <program-per-field-view class="app-disable" :Program="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'program'" v-model="field.EditField"></program-per-field-view>
          </td>
          <td class="pr-3 text-center">
...
export default {
  name: 'ProgramPerView',
  components: {ProgramPerFieldView},
  computed: {},
  data() {
    return {
      OptionAccessType: {
  ...
  filters: {},
  props: ['title', 'value', 'name', 'api', 'table', 'Task', 'isDetail', 'per', 'EmployeeOption', 'ProgramOption'],
}
</script>
<style>
.mr-bottom-3 {
