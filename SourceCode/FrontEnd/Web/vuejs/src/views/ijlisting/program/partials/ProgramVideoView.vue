    ...
    <table class="not-border">
      ...
      <tr v-for="(item, key) in value">
        ...
        <td style="text-align: center;width: auto; position: absolute; right: 15px;">
          ...
          <program-video-edit :Program="Program" v-model="value[key]"></program-video-edit>
...
import ProgramVideoEdit from "./ProgramVideoEdit";

export default {
  name: 'program-video-view',
  components: {
    ProgramVideoEdit,
    IjcoreUploadVideo,
  ...
  methods: {
    ...
    downloadVideo(FileID, name) {
      let self = this;
      let urlApi = '/listing/api/program/download-video/' + FileID;
      let requestData = {
        method: 'get',
        url: urlApi,
        data: {},
    ...
    viewVideo(key) {
      ...
      var ValidProgramTypes = ["pptx", "ppt", "xls", "xlsx", "doc", "docx"];
      let self = this;
      let urlApi = '/listing/api/program/download-video/' + this.value[key].FileID;
      let requestData = {
        method: 'get',
        url: urlApi,
        data: {},
    ...
    deleteLine(key) {
      let self = this;
      let urlApi = '/listing/api/program/delete-video/' + self.value[key].LineID;
      let requestData = {
        method: 'post',
        url: urlApi,
        data: {},
