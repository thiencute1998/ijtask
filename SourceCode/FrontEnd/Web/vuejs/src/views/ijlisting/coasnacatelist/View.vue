        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại hệ thống tài khoản quốc gia: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại hệ thống tài khoản quốc gia: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.coaSnaCateValue">
...
const CreateRouter = 'listing-coasnacatelist-create';
const ViewApi = 'listing/api/coa-sna-cate-list/view';
const ListApi = 'listing/api/coa-sna-cate-list';
const DeleteApi = 'listing/api/coa-sna-cate-list/delete';

export default {
  name: 'listing-view-coa-sna',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.coaSnaCateList = responsesData.data.coaSnaCateList;
          self.model.coaSnaCateValue = responsesData.data.coaSnaCateValue;

          let parentObj = _.find(self.model.coaSnaCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
