<template>
  <div class="ijcore-modal-search-input" @mouseenter="onMouseenter">
    <b-input-group>
      <b-form-input placeholder="Chọn đơn vị tính" :readonly="true" v-model="value.UomName" class="input-revenue-uom readonly form-control"></b-form-input>
...
export default {
  ...
  mounted() {
    let self = this;
    this.$el.querySelector('.input-revenue-uom').addEventListener('click', function () {
      self.onToggleModal();
    });
  },
  methods: {
