<template>
  <div class="ijcore ijcore-modal component-modal-search-ccatelist" @mouseenter="onMouseenter" @mouseleave="onMouseleave">
    ...
    <b-modal :id="idModal" :title="titleModal"
      ...
      <div class="ijcore-modal-revenue-ccatelist ijcore-modal-search">
...
export default {
  name: 'revenue-modal-search-input-catelist',
  components: {
    Select2
  },
  props: {
    ...
    fetchData(){
      ...
      ApiService.customRequest(requestData)
        .then(response =>{
          ...
          self.CateList = responsesData.data.RevenueCateList;
          ...
          self.CateValue = responsesData.data.RevenueCateValue;
...
.ijcore-modal-revenue-ccatelist .select2.select2-container{
  width: 100% !important;
}
