  ...
  <div class="main-entry">
        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="fa fa-print mr-2"></i> Khoản thu</span>
            </div>
          </b-col>
    ...
    <div class="main-body">
      <ijcore-report-viewer-listing
        ref="report-viewer"
        report-name="revenue1"
        :filter="filter"
        @changeReport="updateReport"
        report-data-api="listing/api/revenue/get-report-data?XDEBUG_SESSION_START=PHPSTORM"></ijcore-report-viewer-listing>
    </div>
