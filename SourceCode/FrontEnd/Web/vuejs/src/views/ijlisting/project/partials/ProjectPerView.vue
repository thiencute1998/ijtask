    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <project-per-field-view class="app-disable" :Project="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'project'" v-model="field.AccessField"></project-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <project-per-field-view class="app-disable" :Project="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'project'" v-model="field.EditField"></project-per-field-view>
          </td>
          <td class="pr-3 text-center">
...
export default {
  name: 'ProjectPerView',
  components: {ProjectPerFieldView},
  computed: {},
  data() {
    return {
      OptionAccessType: {
  ...
  filters: {},
  props: ['title', 'value', 'name', 'api', 'table', 'Task', 'isDetail', 'per', 'EmployeeOption', 'ProjectOption'],
}
</script>
<style>
.mr-bottom-3 {
