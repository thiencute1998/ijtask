        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại đối tác: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại đối tác: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.partnerCateValue">
...
const CreateRouter = 'listing-partnercatelist-create';
const ViewApi = 'listing/api/partner-cate-list/view';
const ListApi = 'listing/api/partner-cate-list';
const DeleteApi = 'listing/api/partner-cate-list/delete';
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.partnerCateList = responsesData.data.partnerCateList;
          self.model.partnerCateValue = responsesData.data.partnerCateValue;

          let parentObj = _.find(self.model.partnerCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
