    ...
    <table class="not-border">
      ...
      <tr v-for="(item, key) in value">
        ...
        <td style="text-align: center;width: auto; position: absolute; right: 15px;">
          ...
          <invest-asset-video-edit :Invest="Invest" v-model="value[key]"></invest-asset-video-edit>
...
<script>
  ...
  import InvestAssetVideoEdit from "./InvestAssetVideoEdit";

  export default {
    name: 'vendor-video-view',
    components: {
      InvestAssetVideoEdit,
      IjcoreUploadVideo,
