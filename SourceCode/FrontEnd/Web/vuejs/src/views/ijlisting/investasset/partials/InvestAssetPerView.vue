    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <invest-asset-per-field-view class="app-disable" :InvestAsset="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'invest_asset'" v-model="field.AccessField"></invest-asset-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <invest-asset-per-field-view class="app-disable" :InvestAsset="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'invest_asset'" v-model="field.EditField"></invest-asset-per-field-view>
          </td>
          <td class="pr-3 text-center">
...
<script>
  ...
  export default {
    name: 'InvestAssetPerView',
    components: {InvestAssetPerFieldView},
    computed: {},
    data() {
      return {
        OptionAccessType: {
