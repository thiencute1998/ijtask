            ...
            <vue-perfect-scrollbar class="scroll-area" :settings="$store.state.psSettings">
                <div class="container-fluid">
                    <b-card>
                        ...
                        <div class="form-group row align-items-center">
                            <label class="col-md-2 col-sm-4 m-0" for="OfficePhone">ĐTĐV</label>
        ...
        methods: {
                    ...
                    if (responsesData.status === 1) {
                        ...
                        if (self.idParams || !_.isEmpty(self.itemCopy)) {
                            if (_.isObject(responsesData.data)) {
                                self.model.InvestAssetNo = responsesData.data.VendorNo;
                                self.model.InvestAssetName = responsesData.data.VendorName;
            ...
            getItemIds(type){
                ...
                if (this.reqParams.search.InvestAssetNo !== '') {
                    requestData.data.VendorNo = this.reqParams.search.InvestAssetNo;
                }
                if (this.reqParams.search.InvestAssetName !== '') {
                    requestData.data.VendorName = this.reqParams.search.InvestAssetName;
                }
            ...
            handleSubmitForm(){
                ...
                const requestData = {
                    ...
                    url: StoreApi,
                    data: {
                        VendorNo: this.model.InvestAssetNo,
                        VendorName: this.model.InvestAssetName,
