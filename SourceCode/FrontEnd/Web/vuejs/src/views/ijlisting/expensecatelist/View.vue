        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại khoản chi: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại khoản chi: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.expenseCateValue">
...
const CreateRouter = 'listing-expensecatelist-create';
const ViewApi = 'listing/api/expense-cate-list/view';
const ListApi = 'listing/api/expense-cate-list';
const DeleteApi = 'listing/api/expense-cate-list/delete';

export default {
  name: 'listing-view-expense',
  data () {
    return {
  ...
  methods: {
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        self.defaultModel.data.data.Detail = 1;
        if (responsesData.status === 1) {
          ...
          self.model.expenseCateList = responsesData.data.expenseCateList;
          self.model.expenseCateValue = responsesData.data.expenseCateValue;

          let parentObj = _.find(self.model.expenseCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
    ...
    handleCopyItem(){
      debugger
      let req = this.$route.params.req ?  this.$route.params.req : {} ;
      let query = this.$route.query
      this.$router.push({name: CreateRouter, params: {itemCopy: this.defaultModel, req}, query: query});
    },
