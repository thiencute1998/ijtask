    ...
    <div class="table-responsive">
      <table class="not-border mb-2">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <fixed-asset-per-field-form :FixedAsset="value" :disable="!per[key].Access" :keyPer="key" :title="'Phân quyền'" field-model="AccessField" :table="'doc'" v-model="field.AccessField" @updateFromChild="updateParent"></fixed-asset-per-field-form>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <fixed-asset-per-field-form :FixedAsset="value" :disable="!per[key].Edit" :keyPer="key" :title="'Phân quyền'" field-model="EditField" :table="'doc'" v-model="field.EditField" @updateFromChild="updateParent"></fixed-asset-per-field-form>
          </td>
          <td class="pr-3 text-center">
...
<script>
  ...
  import FixedAssetPerFieldView from "./FixedAssetPerFieldView";
  import FixedAssetPerFieldForm from "./FixedAssetPerFieldForm";
  import Select2 from 'v-select2-component';
  import IjcoreModalMultiListing from "../../../../components/IjcoreModalMultiListing";

  export default {
    name: 'FixedAssetPerForm',
    components: {IjcoreModalMultiListing, FixedAssetPerFieldForm, FixedAssetPerFieldView, Select2},
    computed: {},
    data() {
      return {
        OptionAccessType: {
