...
<!--          </b-button>-->
        ...
        <div class="ijcore-search-fixed-asset-vcatelist ijcore-modal-search">
          <table class="table b-table table-sm table-bordered table-editable">
            <thead>
            <tr class="text-center">
              <th class="pr-3">Loại TSCĐ</th>
            ...
            <tr v-for="(item, key) in value">
              <td>
                <Select2 v-model="value[key].CateID" :settings="{allowClear: true, placeholder: {id: null, text: 'Chọn loại tài sản cố định'}}" :options="CateListOptions" @select="onSelectCateList($event, key)"></Select2>
              </td>
              <td>
    ...
    export default {
      ...
      methods: {
        ...
        fetchData(){
          ...
          requestData.url = '/listing/api/fixed-asset/get-cate-list' + '';
          ...
          ApiService.customRequest(requestData).then((responses) => {
            ...
            if (responsesData.status === 1) {
              self.CateList = responsesData.data.FixedAssetCateList;
              ...
              self.CateValue = responsesData.data.FixedAssetCateValue;
...
<style lang="css">
  ...
  .ijcore-search-fixed-asset-vcatelist .select2.select2-container {
    width: 100% !important;
  }
