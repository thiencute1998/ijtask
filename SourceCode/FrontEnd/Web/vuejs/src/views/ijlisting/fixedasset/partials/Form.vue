        ...
        methods: {
                    ...
                    if (responsesData.status === 1) {
                        ...
                        if (self.idParams || !_.isEmpty(self.itemCopy)) {
                            if (_.isObject(responsesData.data)) {
                                self.model.FixedAssetNo = responsesData.data.VendorNo;
                                self.model.FixedAssetName = responsesData.data.VendorName;
            ...
            getItemIds(type){
                ...
                if (this.reqParams.search.FixedAssetNo !== '') {
                    requestData.data.VendorNo = this.reqParams.search.FixedAssetNo;
                }
                if (this.reqParams.search.FixedAssetName !== '') {
                    requestData.data.VendorName = this.reqParams.search.FixedAssetName;
                }
            ...
            handleSubmitForm(){
                ...
                const requestData = {
                    ...
                    url: StoreApi,
                    data: {
                        VendorNo: this.model.FixedAssetNo,
                        VendorName: this.model.FixedAssetName,
