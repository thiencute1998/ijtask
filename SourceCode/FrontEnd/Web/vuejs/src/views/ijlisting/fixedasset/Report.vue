<template>
  <div class="main-entry">
        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="fa fa-print mr-2"></i> Tài sản cố định</span>
            </div>
          </b-col>
    ...
    <div class="main-body">
      <ijcore-report-viewer-listing report-name="fixed-asset" :filter="filter" report-data-api="listing/api/fixed-asset/get-report-data"></ijcore-report-viewer-listing>
    </div>
  </div>
</template>
