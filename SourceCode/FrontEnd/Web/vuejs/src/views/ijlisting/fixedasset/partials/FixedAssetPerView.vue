    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <fixed-asset-per-field-view class="app-disable" :FixedAsset="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'fixed_asset'" v-model="field.AccessField"></fixed-asset-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <fixed-asset-per-field-view class="app-disable" :FixedAsset="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'fixed_asset'" v-model="field.EditField"></fixed-asset-per-field-view>
          </td>
          <td class="pr-3 text-center">
...
<script>
  ...
  export default {
    name: 'FixedAssetPerView',
    components: {FixedAssetPerFieldView},
    computed: {},
    data() {
      return {
        OptionAccessType: {
