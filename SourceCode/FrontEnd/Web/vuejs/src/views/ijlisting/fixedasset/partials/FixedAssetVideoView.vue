    ...
    <table class="not-border">
      ...
      <tr v-for="(item, key) in value">
        ...
        <td style="text-align: center;width: auto; position: absolute; right: 15px;">
          ...
          <fixed-asset-video-edit :Vendor="Vendor" v-model="value[key]"></fixed-asset-video-edit>
...
<script>
  ...
  import FixedAssetVideoEdit from "./FixedAssetVideoEdit";
  ...
  export default {
    ...
    methods: {
      ...
      viewVideo(key) {
        ...
        var ValidVendorTypes = ["pptx", "ppt", "xls", "xlsx", "doc", "docx"];
        let self = this;
