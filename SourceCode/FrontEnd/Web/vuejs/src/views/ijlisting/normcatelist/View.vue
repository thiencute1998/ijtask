          ...
          <b-card>
            <div class="form-body">
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.normCateValue">
...
const CreateRouter = 'listing-normcatelist-create';
const ViewApi = 'listing/api/norm-cate-list/view';
const ListApi = 'listing/api/norm-cate-list';
const DeleteApi = 'listing/api/norm-cate-list/delete';

export default {
  name: 'listing-view-norm',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.normCateList = responsesData.data.normCateList;
          self.model.normCateValue = responsesData.data.normCateValue;

          let parentObj = _.find(self.model.normCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
