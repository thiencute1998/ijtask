    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <sbi-item-per-field-view class="app-disable" :SbiItem="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'sbi-item'" v-model="field.AccessField"></sbi-item-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <sbi-item-per-field-view class="app-disable" :SbiItem="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'sbi-item'" v-model="field.EditField"></sbi-item-per-field-view>
          </td>
          <td class="pr-3 text-center">
...
export default {
  name: 'SbiItemPerView',
  components: {SbiItemPerFieldView},
  computed: {},
  data() {
    return {
      OptionAccessType: {
  ...
  filters: {},
  props: ['title', 'value', 'name', 'api', 'table', 'Task', 'isDetail', 'per', 'EmployeeOption', 'SbiItemOption'],
}
</script>
<style>
.mr-bottom-3 {
