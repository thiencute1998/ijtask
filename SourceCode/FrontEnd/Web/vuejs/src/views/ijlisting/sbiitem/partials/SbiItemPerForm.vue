    ...
    <div class="table-responsive">
      <table class="not-border mb-2">
        ...
        <tr v-for="(field, key) in per" v-if="field.EmployeeID != EmployeeLogin.EmployeeID">
          ...
          <td class="pr-3">
            <sbi-item-per-field-form :SbiItem="value" :disable="!per[key].Access" :keyPer="key" :title="'Phân quyền'" field-model="AccessField" :table="'doc'" v-model="field.AccessField" @updateFromChild="updateParent"></sbi-item-per-field-form>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <sbi-item-per-field-form :SbiItem="value" :disable="!per[key].Edit" :keyPer="key" :title="'Phân quyền'" field-model="EditField" :table="'doc'" v-model="field.EditField" @updateFromChild="updateParent"></sbi-item-per-field-form>
          </td>
          <td class="pr-3 text-center">
...
import SbiItemPerFieldView from "./SbiItemPerFieldView";
import SbiItemPerFieldForm from "./SbiItemPerFieldForm";
import Select2 from 'v-select2-component';
import IjcoreModalMultiListing from "../../../../components/IjcoreModalMultiListing";

export default {
  name: 'SbiItemPerForm',
  components: {IjcoreModalMultiListing, SbiItemPerFieldForm, SbiItemPerFieldView, Select2},
  computed: {
