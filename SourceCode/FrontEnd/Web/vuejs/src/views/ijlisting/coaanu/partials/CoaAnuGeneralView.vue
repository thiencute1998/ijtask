  ...
  <div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-21 m-0">
        <span v-for="(coaAnuCate, key) in value.CoaAnuCate">
          {{coaAnuCate.CateName}}: {{coaAnuCate.Description}} <span v-if="key < (value.CoaAnuCate.length - 1)"> , </span>
        </span>
      </div>
