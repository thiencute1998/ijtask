<template>
  <div>
    ...
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-21">
        <coa-anu-modal-search-input-catelist v-model="value.CoaAnuCate" title-modal="Loại HTTKHN" placeholder="Loại HTTKHN" :disabled="(value.Detail === 0) ? true: false">
        </coa-anu-modal-search-input-catelist>
      </div>
    </div>
    <div class="form-group row align-items-center">
...
import CoaAnuModalSearchInputCatelist from "./CoaAnuModalSearchInputCatelist";
import IjcoreModalSearchInput from "../../../../components/IjcoreModalSearchInput";

export default {
  name: 'CoaAnuGeneralForm',
  props: ['value','coaAnuOptions','employeeOptions'],
  components: {
    Select2,
    IjcoreModalListing,
    IjcoreModalSystemParent,
