    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <coa-anu-per-field-view class="app-disable" :CoaAnu="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'coa_anu'" v-model="field.AccessField"></coa-anu-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <coa-anu-per-field-view class="app-disable" :CoaAnu="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'coa_anu'" v-model="field.EditField"></coa-anu-per-field-view>
          </td>
          <td class="pr-3 text-center">
...
export default {
  ...
  filters: {},
  props: ['title', 'value', 'name', 'api', 'table', 'Task', 'isDetail', 'per', 'EmployeeOption', 'CoaAnuOption'],
}
</script>
<style>
.mr-bottom-3 {
