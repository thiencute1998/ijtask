<template>
  <div class="ijcore ijcore-modal component-modal-search-ccatelist" @mouseenter="onMouseenter" @mouseleave="onMouseleave">
    ...
    >
      ...
      <div class="ijcore-modal-coa-anu-ccatelist ijcore-modal-search">
...
export default {
  name: 'coa-anu-modal-search-input-catelist',
  components: {
    Select2
  },
  props: {
  ...
  methods: {
    ...
    fetchData(){
      ...
      requestData.url= 'listing/api/coa-anu/get-coa-anu-cate-list';
      ...
      ApiService.customRequest(requestData)
        .then(response =>{
          ...
          self.CateList = responsesData.data.CoaAnuCateList;
          ...
          self.CateValue = responsesData.data.CoaAnuCateValue;
...
.ijcore-modal-coa-anu-ccatelist .select2.select2-container{
  width: 100%;
}
