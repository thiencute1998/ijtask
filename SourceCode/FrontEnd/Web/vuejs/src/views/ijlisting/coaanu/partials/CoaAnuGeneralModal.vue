<template>
  <div>
    ...
    <b-modal scrollable ref="modal" id="modal-form-input-coa-anu-general" size="xl">
      <template v-slot:modal-title>
        <i class="fa fa-edit" v-if="isForm"></i><i class="icon-eye icon" v-else></i> {{title}}
      </template>
      <coa-anu-general-form v-model="value" :coaAnuOptions="coaAnuOptions" :employeeOptions="employeeOptions" v-if="isForm"></coa-anu-general-form>
      <coa-anu-general-view :isDetail="true" v-model="value" v-else></coa-anu-general-view>
...
import CoaAnuGeneralView from "./CoaAnuGeneralView";
import CoaAnuGeneralForm from "./CoaAnuGeneralForm";

export default {
  name: 'CoaAnuGeneralModal',
  props: ['value','title'],
  components: {
    CoaAnuGeneralView,
    CoaAnuGeneralForm
  ...
  methods: {
    ...
    onUpdate(){
      ...
      let updateAPI = 'listing/api/coa-anu/update/';
      let requestData = {
        method: 'post',
        ...
        data: {
          ...
          CoaAnuCate: this.value.CoaAnuCate,
        ...
        .then(response=>{
          ...
          if(responsesData.status === 1){
            ...
            let item = {
              ...
              CoaAnuCate: self.value.CoaAnuCate,
