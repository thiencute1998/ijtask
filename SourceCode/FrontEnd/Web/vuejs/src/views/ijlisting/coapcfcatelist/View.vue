        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại hệ thống tài khoản quỹ tín dụng nhân dân: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại hệ thống tài khoản quỹ tín dụng nhân dân: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.coaPcfCateValue">
...
const CreateRouter = 'listing-coapcfcatelist-create';
const ViewApi = 'listing/api/coa-pcf-cate-list/view';
const ListApi = 'listing/api/coa-pcf-cate-list';
const DeleteApi = 'listing/api/coa-pcf-cate-list/delete';

export default {
  name: 'listing-view-coa-pcf',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.coaPcfCateList = responsesData.data.coaPcfCateList;
          self.model.coaPcfCateValue = responsesData.data.coaPcfCateValue;

          let parentObj = _.find(self.model.coaPcfCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
