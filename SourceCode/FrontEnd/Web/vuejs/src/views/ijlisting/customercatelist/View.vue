        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại khách hàng: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại khách hàng: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.customerCateValue">
...
const CreateRouter = 'listing-customercatelist-create';
const ViewApi = 'listing/api/customer-cate-list/view';
const ListApi = 'listing/api/customer-cate-list';
const DeleteApi = 'listing/api/customer-cate-list/delete';
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.customerCateList = responsesData.data.customerCateList;
          self.model.customerCateValue = responsesData.data.customerCateValue;

          let parentObj = _.find(self.model.customerCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
