        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại nguồn vốn: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại nguồn vốn: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.capitalCateValue">
...
const CreateRouter = 'listing-capitalcatelist-create';
const ViewApi = 'listing/api/capital-cate-list/view';
const ListApi = 'listing/api/capital-cate-list';
const DeleteApi = 'listing/api/capital-cate-list/delete';

export default {
  name: 'listing-view-capital',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.capitalCateList = responsesData.data.capitalCateList;
          self.model.capitalCateValue = responsesData.data.capitalCateValue;

          let parentObj = _.find(self.model.capitalCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
