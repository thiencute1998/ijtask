          ...
          <b-row class="mb-2">
            <b-col class="col-md-12">
              <div class="main-header-item main-header-name">
                <span class="text-capitalize"><i class="fa fa-list mr-2"></i>Loại nguồn vốn</span>
              </div>
            </b-col>
...
export default {
  ...
  computed: {
    ...
    captions: function() {
      let fieldsTable = [
        ...
        {key: 'CateName', label: 'Tên loại nguồn vốn', thStyle: 'min-width: 300px; z-index:7', tdClass: 'bg-tree-tr', field: 'CateName',searchOnTopRow: {type: 'text'}},
      ];
  ...
  created() {
    ...
    this.settings.Table = 'capital_cate_list';
    this.settings.FieldInactive = 'Inactive';

    this.settings.ListApi = 'listing/api/capital-cate-list';
    this.settings.DeleteApi = 'listing/api/capital-cate-list/delete';
    this.settings.CreateRouter = 'listing-capitalcatelist-create';
    this.settings.EditRouter = 'listing-capitalcatelist-edit';
    this.settings.ViewRouter = 'listing-capitalcatelist-view';
  ...
  methods: {
    ...
    async handleExportExcel() {
      ...
      let reportJson = await this.$_lists_handleReportTemplate('capital-cate-list');
      let request = {};
      if (this.modelSearch.CateID !== '') {
      ...
      let reportData = await this.$_lists_handleReportResponse('listing/api/capital-cate-list/get-report-data', request);
      this.$_lists_handleDowloadExcel(reportJson, reportData, 'CateCapital');
    },
  },
  watch: {
    currentPage() {
