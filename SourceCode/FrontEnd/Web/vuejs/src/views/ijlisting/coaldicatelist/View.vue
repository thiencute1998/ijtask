        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại hệ thống tài khoản quỹ đầu tư phát triển địa phương: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại hệ thống tài khoản quỹ đầu tư phát triển địa phương: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.coaLdiCateValue">
...
const CreateRouter = 'listing-coaldicatelist-create';
const ViewApi = 'listing/api/coa-ldi-cate-list/view';
const ListApi = 'listing/api/coa-ldi-cate-list';
const DeleteApi = 'listing/api/coa-ldi-cate-list/delete';

export default {
  name: 'listing-view-coa-ldi',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.coaLdiCateList = responsesData.data.coaLdiCateList;
          self.model.coaLdiCateValue = responsesData.data.coaLdiCateValue;

          let parentObj = _.find(self.model.coaLdiCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
