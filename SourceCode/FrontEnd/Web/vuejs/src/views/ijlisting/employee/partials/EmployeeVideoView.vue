    ...
    <table class="not-border">
      ...
      <tr v-for="(item, key) in value">
        ...
        <td style="text-align: center;width: auto; position: absolute; right: 15px;">
          ...
          <employee-video-edit :Employee="Employee" v-model="value[key]"></employee-video-edit>
...
import EmployeeVideoEdit from "./EmployeeVideoEdit";

export default {
  name: 'employee-video-view',
  components: {
    EmployeeVideoEdit,
    IjcoreUploadVideo,
  ...
  methods: {
    ...
    downloadVideo(FileID, name) {
      let self = this;
      let urlApi = '/listing/api/employee/download-video/' + FileID;
      let requestData = {
        method: 'get',
        url: urlApi,
        data: {},
    ...
    viewVideo(key) {
      ...
      var ValidEmployeeTypes = ["pptx", "ppt", "xls", "xlsx", "doc", "docx"];
      let self = this;
      let urlApi = '/listing/api/employee/download-video/' + this.value[key].FileID;
      let requestData = {
        method: 'get',
        url: urlApi,
        data: {},
    ...
    deleteLine(key) {
      let self = this;
      let urlApi = '/listing/api/employee/delete-video/' + self.value[key].LineID;
      let requestData = {
        method: 'post',
        url: urlApi,
        data: {},
