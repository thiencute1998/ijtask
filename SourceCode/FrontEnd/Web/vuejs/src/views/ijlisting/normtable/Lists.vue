<template>
    <div class="component-listing-normtable-list">
                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                  <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Định mức dự toán</span>
                            </div>
                        </b-col>
                      ...
                      <b-col class="col-lg-12 col-md-24 col-sm-24 col-24">
                        <div class="main-header-item main-header-icons">
                          <b-button-group id="main-header-views" class="main-header-views">
                            <b-button id="tooltip-view-list" title="Danh sách" @click="stage.viewType = 'list'"><i class="fa fa-list m-0"></i></b-button>
                          ...
                          <div class="kanban-item col-lg-6 col-md-8 col-sm-12 col-24" v-for="(item, key) in itemsArray">
                            <div class="kanban-item-inner" @click="$_lists_onFieldClicked(item)">
                              <div class="kanban-record d-flex justify-content-between">
                                <span class="kanban-title">{{item.NormTableName}}</span>
                              </div>
                            </div>
                          </div>
                        </div>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                  ...
                  {key: 'NormTableNo', label: 'Mã số', field: 'NormTableNo', thStyle: 'width: 12%; min-width: 100px', searchOnTopRow: {type: 'text'}},
                  {key: 'NormTableName', label: 'Tên', field: 'NormTableName',searchOnTopRow: {type: 'text'}, thStyle: 'min-width: 300px; over-flow: hidden',},
                  {key: 'NormTableDate', label: 'Ngày ban hành', field: 'NormTableDate',searchOnTopRow: {type: 'compareTime'}, thStyle: 'min-width: 50px; width: 13%;', tdClass: 'text-center'},
                  {key: 'EffectiveDate', label: 'Ngày hiệu lực', field: 'EffectiveDate',searchOnTopRow: {type: 'compareTime'}, thStyle: 'min-width: 50px; width: 13%;', tdClass: 'text-center'},
                ];
        ...
        created() {
          this.settings.FieldID = 'NormTableID';
          this.settings.Table = 'norm_table';
          this.settings.FieldInactive = 'Inactive';

          this.settings.ListApi = 'listing/api/norm-table';
          this.settings.DeleteApi = 'listing/api/norm-table/delete';
          this.settings.CreateRouter = 'listing-normtable-create';
          this.settings.EditRouter = 'listing-normtable-edit';
          this.settings.ViewRouter = 'listing-normtable-view';
        ...
        methods: {
          ...
          fetchData(){
            ...
            if (this.modelSearch.NormTableNo !== '') {
              requestData.data.NormTableNo = this.modelSearch.NormTableNo;
            }
            if (this.modelSearch.NormTableName !== '') {
              requestData.data.NormTableName = this.modelSearch.NormTableName;
            }

            if (this.modelSearch.NormTableDate && !_.isEmpty(this.modelSearch.NormTableDate.dateTime) && this.modelSearch.NormTableDate.dateTime !== '__/__/____') {
              requestData.data.NormTableDate = this.modelSearch.NormTableDate;
            }
        ...
        watch: {
          ...
          'modelSearch.NormTableDate.dateTime'(){
            if (this.modelSearch.NormTableDate.dateTime) {
              this.currentPage = 1;
              this.fetchData();
            }
          },
          'modelSearch.EffectiveDate.operator'(){
            if (this.modelSearch.EffectiveDate.dateTime && this.modelSearch.EffectiveDate.dateTime !== '__/__/____') {
              this.currentPage = 1;
              this.fetchData();
            }
          },
...
<style lang="css">
  ...
  .component-listing-normtable-list .component-compare-time .form-group {
    margin-bottom: 0;
  }
  .component-listing-normtable-list .table.b-table td,
  .component-listing-normtable-list .table.b-table td div,
  .component-listing-normtable-list .table.b-table td span {
    overflow: unset;
  }
</style>
