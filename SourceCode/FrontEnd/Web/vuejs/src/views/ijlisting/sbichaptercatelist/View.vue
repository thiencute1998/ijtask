        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại chương: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại chương: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.sbiChapterCateValue">
...
const CreateRouter = 'listing-sbichaptercatelist-create';
const ViewApi = 'listing/api/sbi-chapter-cate-list/view';
const ListApi = 'listing/api/sbi-chapter-cate-list';
const DeleteApi = 'listing/api/sbi-chapter-cate-list/delete';
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.sbiChapterCateList = responsesData.data.sbiChapterCateList;
          self.model.sbiChapterCateValue = responsesData.data.sbiChapterCateValue;

          let parentObj = _.find(self.model.sbiChapterCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
