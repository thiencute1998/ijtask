    ...
    <table class="not-border">
      ...
      <tr v-for="(item, key) in value">
        ...
        <td style="text-align: center;width: auto; position: absolute; right: 15px;">
          ...
          <company-video-edit :Company="Company" v-model="value[key]"></company-video-edit>
...
import CompanyVideoEdit from "./CompanyVideoEdit";

export default {
  name: 'company-video-view',
  components: {
    CompanyVideoEdit,
    IjcoreUploadVideo,
  ...
  methods: {
    ...
    downloadVideo(FileID, name) {
      let self = this;
      let urlApi = '/listing/api/company/download-video/' + FileID;
      let requestData = {
        method: 'get',
        url: urlApi,
        data: {},
    ...
    viewVideo(key) {
      ...
      var ValidCompanyTypes = ["pptx", "ppt", "xls", "xlsx", "doc", "docx"];
      let self = this;
      let urlApi = '/listing/api/company/download-video/' + this.value[key].FileID;
      let requestData = {
        method: 'get',
        url: urlApi,
        data: {},
    ...
    deleteLine(key) {
      let self = this;
      let urlApi = '/listing/api/company/delete-video/' + self.value[key].LineID;
      let requestData = {
        method: 'post',
        url: urlApi,
        data: {},
