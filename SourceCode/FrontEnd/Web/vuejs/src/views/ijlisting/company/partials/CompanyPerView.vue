...
<!--          <th class="pr-3">Thêm</th>-->
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <company-per-field-view class="app-disable" :Company="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'company'" v-model="field.AccessField"></company-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <company-per-field-view class="app-disable" :Company="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'company'" v-model="field.EditField"></company-per-field-view>
          </td>
          <td class="pr-3 text-center">
...
export default {
  name: 'CompanyPerView',
  components: {CompanyPerFieldView},
  computed: {},
  data() {
    return {
      OptionAccessType: {
