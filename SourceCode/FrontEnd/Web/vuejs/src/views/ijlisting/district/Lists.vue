          ...
          <b-row class="mb-2">
            <b-col md="12">
              <div class="main-header-item main-header-name">
                <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Quận-Huyện</span>
              </div>
            </b-col>
            <b-col md="12"></b-col>
          </b-row>
          <b-row class="mb-2">
            <b-col class="col-lg-12 col-md-24 col-sm-24 col-24 mb-4 mb-lg-0 d-lg-flex justify-content-start align-items-center">
              ...
              <div class="row mb-2">
                <div class="col-md-4 col-sm-6 col-12 mb-2">
                  <ijcore-modal-search-input
                    v-model="modelSearch.Area"
                    :select-fields-api="[
                                {field: 'AreaID',fieldForSelected: 'id', showInTable: false, key: 'AreaID'},
                                {field: 'AreaName', fieldForSelected: 'name', showInTable: true, label: 'Tên vùng', key: 'AreaName', sortable: true, thClass: 'd-none'}
                              ]"
                    :search-fields-api="[{field: 'AreaName', placeholder: 'Nhập tên', name: 'AreaName', class: '', style: ''}]"
                    table="area"
                    ref="myModalSearchInputArea"
                    id-modal="myModalSearchInputArea"
                    :item-per-page="8"
                    placeholder="Vùng"
                    :url-api="$store.state.appRootApi + '/listing/api/province/get-area'"
                    name-input="input-area"
                    title-modal="Vùng" size-modal="lg">
                  </ijcore-modal-search-input>
                </div>
                <div class="col-md-4 col-sm-6 col-12 mb-2">
                  <ijcore-modal-search-input
                    ...
                    :item-per-page="8"
                    placeholder="Tỉnh"
                    :request-data="{AreaID: (modelSearch.Area) ? modelSearch.Area.AreaID : null}"
                ...
                <div class="kanban-item col-lg-6 col-md-8 col-sm-12 col-24" v-for="(item, key) in itemsArray">
                  <div class="kanban-item-inner" @click="onFieldClicked(item)">
                    <div class="kanban-record d-flex justify-content-between">
                      <span class="kanban-title">{{item.DistrictName}}</span>
                    </div>
...
<script>
  ...
  import mixinLists from '@/mixins/lists';
    ...
    export default {
      ...
      computed: {
        ...
        captions: function() {
          let fieldsTable = [
            ...
            {key: 'DistrictName', label: 'Tên Huyện', field: 'DistrictName', thStyle: 'min-width: 300px', searchOnTopRow: {type: 'text'}, tdClass: 'pr-3'},
            {key: 'ProvinceName', label: 'Tên Thành phố', field: 'ProvinceName', thStyle: 'width: 50%; min-width: 300px', searchOnTopRow: {type: 'text'},tdClass: 'pr-3'},
          ];
      ...
      created() {
        this.settings.FieldID = 'DistrictID';
        this.settings.Table = 'district';
        this.settings.FieldInactive = 'Inactive';
        this.settings.ListApi = 'listing/api/district';
        this.settings.ViewRouter = 'listing-district-view';
        this.settings.CreateRouter = 'listing-district-create';
        this.settings.DeleteApi = 'listing/api/district/delete';
      ...
      methods: {
        ...
        fetchData(){
          ...
          if (this.modelSearch.ProvinceName.trim() !== '') {
