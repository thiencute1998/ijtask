        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span v-if="idParams"><i class="fa fa-edit mr-2"></i> Quận - Huyện<span v-if="model.DistrictName">:</span> {{model.DistrictName}}</span>
              <span v-if="!idParams"><i class="fa fa-plus mr-2"></i> Quận - Huyện<span v-if="model.DistrictName">:</span> {{model.DistrictName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-group row align-items-center">
              <div class="col-lg-4 col-md-4 mb-md-0 col-sm-2 mb-sm-0 col-4 mb-2" style="white-space: nowrap">Quận - Huyện</div>
              <div class="col-lg-16 col-md-14 col-sm-14 mb-sm-0 mb-md-0 col-20 mb-2 app-object-name">
                <input v-model="model.DistrictName" type="text" id="DistrictName" class="form-control" placeholder="Tên quận - huyện" name="DistrictName" />
              </div>
              <div class="col-lg-4 col-md-6 col-sm-8 col-24 d-flex align-items-center app-object-code">
                <span>Mã số</span>
                <input type="text" v-model="model.DistrictNo" class="form-control" placeholder="Mã số"/>
              </div>
            </div>
...
const ListRouter = 'listing-district';
const EditRouter = 'listing-district-edit';
const CreateRouter = 'listing-district-create';
const ViewRouter = 'listing-district-view';
const ViewApi = 'listing/api/district/view';
const EditApi = 'listing/api/district/edit';
const CreateApi = 'listing/api/district/create';
const StoreApi = 'listing/api/district/store';
const UpdateApi = 'listing/api/district/update';
const ListApi = 'listing/api/district';
  ...
  methods: {
        ...
        if (responsesData.status === 1) {
          ...
          if (self.idParams || !_.isEmpty(self.itemCopy)) {
            if (_.isObject(responsesData.data.data)) {
              ...
              self.model.DistrictNo = responsesData.data.data.DistrictNo;
              self.model.DistrictName = responsesData.data.data.DistrictName;
    ...
    handleSubmitForm() {
      ...
      const requestData = {
        ...
        url: StoreApi + '',
        data: {
            DistrictNo: this.model.DistrictNo,
