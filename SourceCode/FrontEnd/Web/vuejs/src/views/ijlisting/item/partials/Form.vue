        ...
        methods: {
                    ...
                    if (responsesData.status === 1) {
                        ...
                        if (self.idParams || !_.isEmpty(self.itemCopy)) {
                            if (_.isObject(responsesData.data)) {
                                self.model.ItemNo = responsesData.data.VendorNo;
                                self.model.ItemName = responsesData.data.VendorName;
            ...
            getItemIds(type){
                ...
                if (this.reqParams.search.ItemNo !== '') {
                    requestData.data.VendorNo = this.reqParams.search.ItemNo;
                }
                if (this.reqParams.search.ItemName !== '') {
                    requestData.data.VendorName = this.reqParams.search.ItemName;
                }
            ...
            onChangedEmployeeItem(){
                this.model.itemID = this.model.itemObj.value;
            },
            ...
            handleSubmitForm(){
                ...
                const requestData = {
                    ...
                    url: StoreApi,
                    data: {
                        VendorNo: this.model.ItemNo,
                        VendorName: this.model.ItemName,
