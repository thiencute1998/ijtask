    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <item-per-field-view class="app-disable" :Item="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'item'" v-model="field.AccessField"></item-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <item-per-field-view class="app-disable" :Item="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'item'" v-model="field.EditField"></item-per-field-view>
          </td>
          <td class="pr-3 text-center">
