  ...
  <div>
    <div class="form-group row align-items-center">
      ...
      <div class="col-lg-17 col-md-20 col-sm-20 mb-sm-2 mb-md-3 mb-lg-0 mb-3 app-object-name">
        <input v-model="value.ItemName" type="text" class="form-control" placeholder="Tên vật tư - hàng hóa - dịch vụ"/>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-8 app-object-code d-md-none d-sm-none d-none d-lg-flex align-items-center">
        <span>Mã số</span>
        <input type="text" v-model="value.ItemNo" class="form-control" placeholder="Mã số"/>
      </div>
    ...
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-5">
        <b-form-select v-model="value.ItemType" :options="ItemTypeOption"></b-form-select>
      </div>
...
<script>
  ...
  import ItemModalSearchInputVcatelist from "./ItemModalSearchInputVcatelist";

  export default {
    name: 'item-general-form',
    components: {IjcoreDatePicker, Select2, IjcoreModalSearchInput, ItemModalSearchInputVcatelist},
    computed: {},
    data() {
      return {
        ItemTypeOption: {
