  ...
  <a @click="onToggleModal()" class="ij-a-icon" title="Chi tiết">
    ...
    <b-modal ref="modal" id="modal-form-input-task-file-edit" size="lg" no-close-on-backdrop>
      <template slot="modal-title">
        <i class="fa fa-edit"></i> Tệp: {{Invest.InvestName}}
      </template>
      ...
      <div class="form-group row  align-items-center mb-2">
        ...
        <div class="col-md-4">
          <input v-model="value.VideoType" class="form-control" readonly/>
        </div>
        <label class="col-md-4" style="white-space: nowrap">Kích thước</label>
        <div class="col-md-4">
          <input v-model="value.VideoSize" class="form-control" readonly/>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      onUpdate() {
        ...
        formData.append('InvestID', self.value.InvestID);
        ...
        // send upload request
        axios.post('listing/api/vendor/vendor-upload-video/' + self.Invest.InvestID, formData, config)
