    ...
    <div class="table-responsive">
      <table class="not-border mb-2">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <item-per-field-form :Item="value" :disable="!per[key].Access" :keyPer="key" :title="'Phân quyền'" field-model="AccessField" :table="'doc'" v-model="field.AccessField" @updateFromChild="updateParent"></item-per-field-form>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <item-per-field-form :Item="value" :disable="!per[key].Edit" :keyPer="key" :title="'Phân quyền'" field-model="EditField" :table="'doc'" v-model="field.EditField" @updateFromChild="updateParent"></item-per-field-form>
          </td>
          <td class="pr-3 text-center">
...
<script>
  ...
  import ItemPerFieldView from "./ItemPerFieldView";
  import ItemPerFieldForm from "./ItemPerFieldForm";
  import Select2 from 'v-select2-component';
  import IjcoreModalMultiListing from "../../../../components/IjcoreModalMultiListing";

  export default {
    name: 'ItemPerForm',
    components: {IjcoreModalMultiListing, ItemPerFieldForm, ItemPerFieldView, Select2},
    computed: {},
    data() {
      return {
        OptionAccessType: {
