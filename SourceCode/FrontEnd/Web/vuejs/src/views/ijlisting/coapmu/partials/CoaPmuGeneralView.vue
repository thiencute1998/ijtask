  ...
  <div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-9 m-0">
        <span v-for="(coaPmuCate, key) in value.CoaPmuCate">
          {{coaPmuCate.CateName}}: {{coaPmuCate.Description}} <span v-if="key < (value.CoaPmuCate.length - 1)"> , </span>
        </span>
      </div>
