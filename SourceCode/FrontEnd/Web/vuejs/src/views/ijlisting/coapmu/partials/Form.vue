                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span v-if="idParams"><i class="fa fa-edit mr-2"></i> Hệ thống tài khoản ban quản lý dự án<span v-if="model.AccountName">:</span> {{model.AccountName}}</span>
                            <span v-if="!idParams"><i class="fa fa-plus mr-2"></i> Hệ thống tài khoản ban quản lý dự án<span v-if="model.AccountName">:</span> {{model.AccountName}}</span>
                        </div>
                    </b-col>
                    ...
                    <b-card>
                        <div class="form-group row align-items-center">
                          ...
                          <div class="col-md-17 col-sm-14 mb-sm-0 mb-md-0 col-20 mb-3 app-object-name">
                            <input v-model="model.AccountName" type="text" id="AccountName" class="form-control" placeholder="Tên hệ thống tài khoản ban quản lý dự án" name="AccountName"/>
                          </div>
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div class="col-md-9">
                                <CoaPmuModalSearchInputCatelist
                                  v-model="model.CoaPmuCate"
                                  title-modal="Loại HTTK BQLDA"
                                  placeholder="Loại hệ thống tài khoản  ban quản lý dự án"
                                ></CoaPmuModalSearchInputCatelist>
                            </div>
...
<script>
    ...
    import CoaPmuModalSearchInputCatelist from "@/views/ijlisting/coapmu/partials/CoaPmuModalSearchInputCatelist";
    ...
    const ViewRouter = 'listing-coa-pmu-view';
    const CreateRouter = 'listing-coa-pmu-create';
    const ViewApi = 'listing/api/coa-pmu/view';
    const EditApi = 'listing/api/coa-pmu/edit';
    const CreateApi = 'listing/api/coa-pmu/create';
    const StoreApi = 'listing/api/coa-pmu/store';
            ...
            fetchData() {
                ...
                ApiService.customRequest(requestData).then((responses) => {
                    ...
                    if (responsesData.status === 1) {
                        if (_.isArray(responsesData.data.coaPmu)){

                            self.model.CoaPmuOption = [];
                            _.forEach(responsesData.data.coaPmu, function (value, key) {
                                let tmpObj = {};
                                tmpObj.id = value.AccountID;
                                tmpObj.text = value.AccountName;
                                self.model.CoaPmuOption.push(tmpObj);
                            });
                        }
            ...
            handleSubmitForm(){
                ...
                const requestData = {
                    ...
                    data: {
                        ...
                        CoaPmuCate: this.model.CoaPmuCate,
              ...
              ApiService.customRequest(requestData).then((responses) => {
                ...
                if (responsesData.status === 1) {
                  ...
                  let item = {
                    ...
                    CoaPmuCate: self.model.CoaPmuCate,
                  }
