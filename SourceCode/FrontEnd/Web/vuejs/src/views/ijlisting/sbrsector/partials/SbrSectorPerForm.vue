...
<!--          <th class="pr-3">Thêm</th>-->
        ...
        <tbody>
        <tr v-for="(field, key) in per" v-if="field.EmployeeID != EmployeeLogin.EmployeeID">
          ...
          <td class="pr-3">
            <sbr-sector-per-field-form :SbrSector="value" :disable="!per[key].Access" :keyPer="key" :title="'Phân quyền'" field-model="AccessField" :table="'doc'" v-model="field.AccessField" @updateFromChild="updateParent"></sbr-sector-per-field-form>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <sbr-sector-per-field-form :SbrSector="value" :disable="!per[key].Edit" :keyPer="key" :title="'Phân quyền'" field-model="EditField" :table="'doc'" v-model="field.EditField" @updateFromChild="updateParent"></sbr-sector-per-field-form>
          </td>
          <td class="pr-3 text-center">
...
import SbrSectorPerFieldView from "./SbrSectorPerFieldView";
import SbrSectorPerFieldForm from "./SbrSectorPerFieldForm";
import Select2 from 'v-select2-component';
import IjcoreModalMultiListing from "../../../../components/IjcoreModalMultiListing";

export default {
  name: 'SbrSectorPerForm',
  components: {IjcoreModalMultiListing, SbrSectorPerFieldForm, SbrSectorPerFieldView, Select2},
  computed: {
          ...
          _.forEach(dataResponse.data, function (val, key) {
            ...
            if(isExist == 0){
              self.per.push({
                ...
                SbrSectorID: self.value.SbrSectorID,
                Access: true,
                AccessField: 'all',
                Edit: false,
                EditField: '',
  ...
  filters: {},
  props: ['title', 'value', 'name', 'api', 'table', 'Task', 'isDetail', 'per', 'EmployeeOption', 'CompanyOption', 'GroupOption','EmployeeLogin'],
}
</script>
<style>
.mr-bottom-3 {
