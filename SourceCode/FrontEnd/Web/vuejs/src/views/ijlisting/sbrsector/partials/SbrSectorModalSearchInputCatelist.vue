<template>
  <div class="ijcore ijcore-modal component-modal-search-ccatelist" @mouseenter="onMouseenter" @mouseleave="onMouseleave">
    ...
    <b-modal :id="idModal" :title="titleModal"
      ...
      <div class="ijcore-modal-sbr-sector-ccatelist ijcore-modal-search">
...
export default {
  name: 'sbr-sector-modal-search-input-catelist',
  components: {
    Select2
  },
  props: {
    ...
    fetchData(){
      ...
      ApiService.customRequest(requestData)
        .then(response =>{
          ...
          self.CateList = responsesData.data.SbrSectorCateList;
          ...
          self.CateValue = responsesData.data.SbrSectorCateValue;
...
.ijcore-modal-sbr-sector-ccatelist .select2.select2-container{
  width: 100% !important;
}
