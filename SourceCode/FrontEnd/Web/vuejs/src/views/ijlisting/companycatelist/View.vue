        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại đơn vị: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại đơn vị: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.companyCateValue">
...
const CreateRouter = 'listing-companycatelist-create';
const ViewApi = 'listing/api/company-cate-list/view';
const ListApi = 'listing/api/company-cate-list';
const DeleteApi = 'listing/api/company-cate-list/delete';

export default {
  name: 'listing-view-company',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.companyCateList = responsesData.data.companyCateList;
          self.model.companyCateValue = responsesData.data.companyCateValue;

          let parentObj = _.find(self.model.companyCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
