        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại khoản thu: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại khoản thu: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.revenueCateValue">
...
const CreateRouter = 'listing-revenuecatelist-create';
const ViewApi = 'listing/api/revenue-cate-list/view';
const ListApi = 'listing/api/revenue-cate-list';
const DeleteApi = 'listing/api/revenue-cate-list/delete';

export default {
  name: 'listing-view-revenue',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.revenueCateList = responsesData.data.revenueCateList;
          self.model.revenueCateValue = responsesData.data.revenueCateValue;

          let parentObj = _.find(self.model.revenueCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
