...
<!--          <th class="pr-3">Thêm</th>-->
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <sector-per-field-view class="app-disable" :Sector="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'sector'" v-model="field.AccessField"></sector-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <sector-per-field-view class="app-disable" :Sector="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'sector'" v-model="field.EditField"></sector-per-field-view>
          </td>
          <td class="pr-3 text-center">
...
export default {
  ...
  filters: {},
  props: ['title', 'value', 'name', 'api', 'table', 'Task', 'isDetail', 'per', 'EmployeeOption', 'SectorOption'],
}
</script>
<style>
.mr-bottom-3 {
