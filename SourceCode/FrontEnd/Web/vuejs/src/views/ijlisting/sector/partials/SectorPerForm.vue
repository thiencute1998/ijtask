...
<!--          <th class="pr-3">Thêm</th>-->
        ...
        <tr v-for="(field, key) in per" v-if="field.EmployeeID != EmployeeLogin.EmployeeID">
          ...
          <td class="pr-3">
            <sector-per-field-form :Sector="value" :disable="!per[key].Access" :keyPer="key" :title="'Phân quyền'" field-model="AccessField" :table="'doc'" v-model="field.AccessField" @updateFromChild="updateParent"></sector-per-field-form>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <sector-per-field-form :Sector="value" :disable="!per[key].Edit" :keyPer="key" :title="'Phân quyền'" field-model="EditField" :table="'doc'" v-model="field.EditField" @updateFromChild="updateParent"></sector-per-field-form>
          </td>
          <td class="pr-3 text-center">
...
import SectorPerFieldView from "./SectorPerFieldView";
import SectorPerFieldForm from "./SectorPerFieldForm";
import Select2 from 'v-select2-component';
import IjcoreModalMultiListing from "../../../../components/IjcoreModalMultiListing";

export default {
  name: 'SectorPerForm',
  components: {IjcoreModalMultiListing, SectorPerFieldForm, SectorPerFieldView, Select2},
  computed: {
