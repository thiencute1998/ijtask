        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại lĩnh vực chi: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại lĩnh vực chi: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.sectorCateValue">
...
const CreateRouter = 'listing-sectorcatelist-create';
const ViewApi = 'listing/api/sector-cate-list/view';
const ListApi = 'listing/api/sector-cate-list';
const DeleteApi = 'listing/api/sector-cate-list/delete';

export default {
  name: 'listing-view-sector',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.sectorCateList = responsesData.data.sectorCateList;
          self.model.sectorCateValue = responsesData.data.sectorCateValue;

          let parentObj = _.find(self.model.sectorCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
