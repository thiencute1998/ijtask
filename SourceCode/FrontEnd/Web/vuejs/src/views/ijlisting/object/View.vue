                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span><i class="fa fa-th mr-2"></i> Đối tượng khác: {{model.objectName}}</span>
                        </div>
                    </b-col>
            ...
            <vue-perfect-scrollbar class="scroll-area" :settings="$store.state.psSettings">
                <div class="container-fluid">
                    <b-card>
                        ...
                        <div class="form-group row">
                            <label class="col-md-4 m-0">ĐTĐV</label>
                        ...
                        <div class="form-group row">
                          <label class="col-md-4 m-0">Website</label>
                          <label class="col-md-8 m-0">
                            {{model.website}}
                          </label>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-20 m-0" id="view-Note">
                              {{model.note}}
                          </div>
                        </div>
                    </b-card>
...
<script>
    ...
    const DeleteApi = 'listing/api/object/delete';
