        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Chức vụ: {{Position.PositionName}}</span>
            </div>
          </b-col>
...
const DeleteApi = 'listing/api/position/delete';
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          self.Position.PositionID = responsesData.data.data.PositionID;
          self.Position.PositionName = responsesData.data.data.PositionName;
          self.Position.PositionNo = responsesData.data.data.PositionNo;

          //Position
          self.PositionOption = [];
          _.forEach(responsesData.Position, function (val, key) {
            let tmpObj = {};
            tmpObj.id = val.PositionID;
            tmpObj.text = val.PositionName;
