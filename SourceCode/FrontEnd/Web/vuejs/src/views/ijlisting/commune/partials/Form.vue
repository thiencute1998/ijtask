        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span v-if="idParams"><i class="fa fa-edit mr-2"></i> Xã<span v-if="model.CommuneName">:</span> {{model.CommuneName}}</span>
              <span v-if="!idParams"><i class="fa fa-plus mr-2"></i> Xã<span v-if="model.CommuneName">:</span> {{model.CommuneName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-group row align-items-center">
              <div class="col-lg-4 col-md-4 mb-md-0 col-sm-2 mb-sm-0 col-4 mb-2" style="white-space: nowrap">Xã</div>
              <div class="col-lg-16 col-md-14 col-sm-14 mb-sm-0 mb-md-0 col-20 mb-2 app-object-name">
                <input v-model="model.CommuneName" type="text" id="CommuneName" class="form-control" placeholder="Tên xã" name="CommuneName" />
              </div>
              <div class="col-lg-4 col-md-6 col-sm-8 col-24 d-flex align-items-center app-object-code">
                <span>Mã số</span>
                <input type="text" v-model="model.CommuneNo" class="form-control" placeholder="Mã số"/>
              </div>
            </div>
              ...
              <div class="col-md-5 mb-3 mb-sm-0 mb-md-0 mb-lg-0 mr-5">
                <ijcore-modal-search-input
                  ...
                  :select-fields-api="[
                                ...
                                {field: 'ProvinceName', fieldForSelected: 'name', showInTable: true, label: 'Tên tỉnh', key: 'ProvinceName', sortable: true, thClass: 'd-none'}
                              ]"
                  ...
                  :item-per-page="8"
                  placeholder="Tỉnh"
                  :url-api="$store.state.appRootApi + '/listing/api/commune/get-province'"
...
const ListRouter = 'listing-commune';
const EditRouter = 'listing-commune-edit';
const CreateRouter = 'listing-commune-create';
const ViewRouter = 'listing-commune-view';
const ViewApi = 'listing/api/commune/view';
const EditApi = 'listing/api/commune/edit';
const CreateApi = 'listing/api/commune/create';
const StoreApi = 'listing/api/commune/store';
const UpdateApi = 'listing/api/commune/update';
const ListApi = 'listing/api/commune';
  ...
  methods: {
        ...
        if (responsesData.status === 1) {
          ...
          if (self.idParams || !_.isEmpty(self.itemCopy)) {
            if (_.isObject(responsesData.data.data)) {
              ...
              self.model.CommuneNo = responsesData.data.data.CommuneNo;
              self.model.CommuneName = responsesData.data.data.CommuneName;
    ...
    handleSubmitForm() {
      ...
      const requestData = {
        ...
        url: StoreApi + '',
        data: {
            CommuneNo: this.model.CommuneNo,
