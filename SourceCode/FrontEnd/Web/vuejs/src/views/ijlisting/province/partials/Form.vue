        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span v-if="idParams"><i class="fa fa-edit mr-2"></i> Tỉnh<span v-if="model.ProvinceName">:</span> {{model.ProvinceName}}</span>
              <span v-if="!idParams"><i class="fa fa-plus mr-2"></i> Tỉnh<span v-if="model.ProvinceName">:</span> {{model.ProvinceName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-group row align-items-center">
              <div class="col-lg-4 col-md-4 mb-md-0 col-sm-2 mb-sm-0 col-4 mb-2" style="white-space: nowrap">Tỉnh</div>
              <div class="col-lg-16 col-md-14 col-sm-14 mb-sm-0 mb-md-0 col-20 mb-2 app-object-name">
                <input v-model="model.ProvinceName" type="text" id="ProvinceName" class="form-control" placeholder="Tên tỉnh" name="ProvinceName" />
              </div>
              <div class="col-lg-4 col-md-6 col-sm-8 col-24 d-flex align-items-center app-object-code">
                <span>Mã số</span>
                <input type="text" v-model="model.ProvinceNo" class="form-control" placeholder="Mã số"/>
              </div>
            </div>
            ...
            <div class="form-group row align-items-center">
              ...
              <div class="col-md-5 mb-3 mb-sm-0 mb-md-0 mb-lg-0 mr-5">
                <ijcore-modal-search-listing
                  v-model="model" :title="'Quốc gia'" :table="'country'" :api="'/listing/api/common/list'"
                  :fieldID="'CountryID'" :fieldNo="'CountryNo'" :fieldName="'CountryName'"
                  :fieldAssignID="'CountryID'" :fieldAssignNo="'CountryNo'" :fieldAssignName="'CountryName'"
                  :hide-fied-no-or-i-d="true"
                >
                </ijcore-modal-search-listing>
              </div>
                ...
                <div class="col-md-5 mb-3 mb-sm-0 mb-md-0 mb-lg-0 mr-5">
                  <ijcore-modal-search-listing
                    v-model="model" :title="'Vùng'" :table="'area'" :api="'/listing/api/common/list'"
                    :fieldID="'AreaID'" :fieldNo="'AreaNo'" :fieldName="'AreaName'"
                    :fieldAssignID="'AreaID'" :fieldAssignNo="'AreaNo'" :fieldAssignName="'AreaName'"
                    :hide-fied-no-or-i-d="true"
                  >
                  </ijcore-modal-search-listing>
                </div>
...
const ListRouter = 'listing-province';
const EditRouter = 'listing-province-edit';
const CreateRouter = 'listing-province-create';
const ViewRouter = 'listing-province-view';
const ViewApi = 'listing/api/province/view';
const EditApi = 'listing/api/province/edit';
const CreateApi = 'listing/api/province/create';
const StoreApi = 'listing/api/province/store';
const UpdateApi = 'listing/api/province/update';
const ListApi = 'listing/api/province';
