        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Tỉnh: {{ model.ProvinceName }}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-group row align-items-center">
              <div class="col-lg-3 col-md-3 mb-md-0 col-sm-2 mb-sm-0 col-4 mb-2" style="white-space: nowrap">Tỉnh: </div>
              <div class="col-lg-17 col-md-15 col-sm-14 mb-sm-0 mb-md-0 col-20 mb-2 app-object-name">
                {{ model.ProvinceName }}
              </div>
            ...
            <div class="form-group row align-items-center">
              <div class="col-lg-3 col-md-3 mb-md-0 col-sm-2 mb-sm-0 col-4 mb-2" style="white-space: nowrap">Quốc gia: </div>
              <div class="col-md-5 mb-3 mb-sm-0 mb-md-0 mb-lg-0 mr-5">
                {{ model.CountryName }}
              </div>

              <label class="col-md-3">Vùng:</label>
              <div class="col-md-5 mb-3 mb-sm-0 mb-md-0 mb-lg-0 mr-5">
                {{model.AreaName}}
              </div>
            </div>
...
const DeleteApi = 'listing/api/province/delete';
