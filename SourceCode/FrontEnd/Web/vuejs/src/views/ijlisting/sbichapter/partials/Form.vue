        ...
        methods: {
                    ...
                    if (responsesData.status === 1) {
                        ...
                        if (self.idParams || !_.isEmpty(self.itemCopy)) {
                            if (_.isObject(responsesData.data)) {
                                self.model.SbiChapterNo = responsesData.data.VendorNo;
                                self.model.SbiChapterName = responsesData.data.VendorName;
            ...
            getItemIds(type){
                ...
                if (this.reqParams.search.SbiChapterNo !== '') {
                    requestData.data.VendorNo = this.reqParams.search.SbiChapterNo;
                }
                if (this.reqParams.search.SbiChapterName !== '') {
                    requestData.data.VendorName = this.reqParams.search.SbiChapterName;
                }
            ...
            handleSubmitForm(){
                ...
                const requestData = {
                    ...
                    url: StoreApi,
                    data: {
                        VendorNo: this.model.SbiChapterNo,
                        VendorName: this.model.SbiChapterName,
