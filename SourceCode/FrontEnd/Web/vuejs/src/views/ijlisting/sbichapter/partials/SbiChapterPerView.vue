    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <sbi-chapter-per-field-view class="app-disable" :SbiChapter="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'fixed_asset'" v-model="field.AccessField"></sbi-chapter-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <sbi-chapter-per-field-view class="app-disable" :SbiChapter="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'fixed_asset'" v-model="field.EditField"></sbi-chapter-per-field-view>
          </td>
          <td class="pr-3 text-center">
...
<script>
  ...
  export default {
    name: 'SbiChapterPerView',
    components: {SbiChapterPerFieldView},
    computed: {},
    data() {
      return {
        OptionAccessType: {
