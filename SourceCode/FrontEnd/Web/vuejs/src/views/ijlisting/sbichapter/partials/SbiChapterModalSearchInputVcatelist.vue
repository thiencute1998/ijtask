...
<!--          </b-button>-->
        ...
        <div class="ijcore-search-sbi-chapter-vcatelist ijcore-modal-search">
          <table class="table b-table table-sm table-bordered table-editable">
            <thead>
            <tr class="text-center">
              <th class="pr-3">Loại chương</th>
            ...
            <tr v-for="(item, key) in value">
              <td>
                <Select2 v-model="value[key].CateID" :settings="{allowClear: true, placeholder: {id: null, text: 'Chọn loại chương'}}" :options="CateListOptions" @select="onSelectCateList($event, key)"></Select2>
              </td>
              <td>
    ...
    export default {
      ...
      methods: {
        ...
        fetchData(){
          ...
          requestData.url = '/listing/api/sbi-chapter/get-cate-list' + '?XDEBUG_SESSION_START=PHPSTORM';
          ...
          ApiService.customRequest(requestData).then((responses) => {
            ...
            if (responsesData.status === 1) {
              self.CateList = responsesData.data.SbiChapterCateList;
              ...
              self.CateValue = responsesData.data.SbiChapterCateValue;
...
<style lang="css">
  ...
  .ijcore-search-sbi-chapter-vcatelist .select2.select2-container {
    width: 100% !important;
  }
