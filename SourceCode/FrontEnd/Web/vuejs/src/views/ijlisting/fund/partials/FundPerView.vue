    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <fund-per-field-view class="app-disable" :Fund="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'fund'" v-model="field.AccessField"></fund-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <fund-per-field-view class="app-disable" :Fund="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'fund'" v-model="field.EditField"></fund-per-field-view>
          </td>
          <td class="pr-3 text-center">
...
export default {
  ...
  filters: {},
  props: ['title', 'value', 'name', 'api', 'table', 'Task', 'isDetail', 'per', 'EmployeeOption', 'FundOption'],
}
</script>
<style>
.mr-bottom-3 {
