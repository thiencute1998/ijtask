                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Loại giao dịch hỗ trợ</span>
                            </div>
                        </b-col>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                    ...
                    {key: 'CateName', label: 'Tên giao dịch hỗ trợ', field: 'CateName',searchOnTopRow: {type: 'text'}, thStyle: 'min-width: 300px'},
        ...
        created() {
          ...
          this.settings.Table = 'customer_support_trans_cate_list';
          this.settings.FieldInactive = 'Inactive';

          this.settings.ListApi = 'listing/api/customer-support-trans-cate-list';
          this.settings.DeleteApi = 'listing/api/customer-support-trans-cate-list/delete';
          this.settings.CreateRouter = 'listing-csupporttranscatelist-create';
          this.settings.EditRouter = 'listing-csupporttranscatelist-edit';
          this.settings.ViewRouter = 'listing-csupporttranscatelist-view';
