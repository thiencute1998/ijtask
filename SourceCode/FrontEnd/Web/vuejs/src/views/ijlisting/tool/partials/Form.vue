                    ...
                    <b-card>
                        ...
                        <div class="form-group row align-items-center">
                          ...
                          <div class="col-lg-18 col-md-22 col-sm-20 mb-sm-2 mb-md-3 mb-lg-0 mb-3 app-object-name">
                            <input v-model="model.ToolName" type="text" class="form-control" placeholder="Tên tài sản đầu tư"/>
                          </div>
        ...
        methods: {
                    ...
                    if (responsesData.status === 1) {
                        ...
                        if (self.idParams || !_.isEmpty(self.itemCopy)) {
                            if (_.isObject(responsesData.data)) {
                                self.model.ToolNo = responsesData.data.VendorNo;
                                self.model.ToolName = responsesData.data.VendorName;
            ...
            getItemIds(type){
                ...
                if (this.reqParams.search.ToolNo !== '') {
                    requestData.data.VendorNo = this.reqParams.search.ToolNo;
                }
                if (this.reqParams.search.ToolName !== '') {
                    requestData.data.VendorName = this.reqParams.search.ToolName;
                }
            ...
            handleSubmitForm(){
                ...
                const requestData = {
                    ...
                    url: StoreApi,
                    data: {
                        VendorNo: this.model.ToolNo,
                        VendorName: this.model.ToolName,
