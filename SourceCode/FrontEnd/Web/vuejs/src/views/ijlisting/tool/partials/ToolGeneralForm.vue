  ...
  <div>
    <div class="form-group row align-items-center">
      ...
      <div class="col-lg-17 col-md-20 col-sm-20 mb-sm-2 mb-md-3 mb-lg-0 mb-3 app-object-name">
        <input v-model="value.ToolName" type="text" class="form-control" placeholder="Tên công cụ dụng cụ"/>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-8 app-object-code d-md-none d-sm-none d-none d-lg-flex align-items-center">
        <span>Mã số</span>
        <input type="text" v-model="value.ToolNo" class="form-control" placeholder="Mã số"/>
      </div>
    ...
    <div class="form-group row align-items-center">
      <div class="col-lg-3 col-md-4 col-sm-4 mb-lg-0 mb-md-3 mb-sm-3" title="Loại công cụ dụng cụ">Loại CCDC</div>
      <div class="col-lg-21 col-md-20 col-sm-20 mb-lg-0 mb-md-3 mb-sm-3 mb-3">
        <tool-modal-search-input-vcatelist
          v-model="value.ToolCate"
...
<script>
  ...
  import ToolModalSearchInputVcatelist from "./ToolModalSearchInputVcatelist";

  export default {
    name: 'tool-general-form',
    components: {IjcoreDatePicker, Select2, IjcoreModalSearchInput, ToolModalSearchInputVcatelist},
    computed: {},
    data() {
      return {
        AccessTypeOptions:{
    ...
    props: ['title', 'value', 'name', 'api', 'table', 'Task', 'isDetail', 'per', 'EmployeeOption', 'CompanyOption', 'ToolPerEmployee'],
  }
</script>
<style>
  .table th, .table td {
