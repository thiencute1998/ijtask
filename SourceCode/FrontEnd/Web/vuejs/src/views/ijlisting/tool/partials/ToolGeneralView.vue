<template>
  <div>
    ...
    <div class="form-group row align-items-center">
      <div class="col-lg-3 col-lg-3 col-md-4 col-sm-4 mb-lg-0 mb-md-3 mb-sm-3" title="Loại công cụ dụng cụ">Loại CCDC</div>
      <div class="col-lg-9 col-lg-9 col-md-20 col-sm-20 mb-lg-0 mb-md-3 mb-sm-3 mb-3">
        <span v-for="(ToolCate, key) in value.ToolCate" v-if="value.ToolCate.length">
            {{ToolCate.CateName}}: {{ToolCate.Description}} <span v-if="key < (value.ToolCate.length - 1)">,</span>
          </span>
      </div>
    </div>
