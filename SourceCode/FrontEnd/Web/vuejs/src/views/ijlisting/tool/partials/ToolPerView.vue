    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <tool-per-field-view class="app-disable" :Tool="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'invest_asset'" v-model="field.AccessField"></tool-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <tool-per-field-view class="app-disable" :Tool="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'invest_asset'" v-model="field.EditField"></tool-per-field-view>
          </td>
          <td class="pr-3 text-center">
