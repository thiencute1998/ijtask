        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="icon-eye icon mr-2"></i> Loại chỉ thị: {{model.CateName}}</span>
            </div>
          </b-col>
        ...
        <div class="container-fluid">
          <b-card>
            <div class="form-body">
              ...
              <div class="form-group row">
                <label class="col-md-10 m-0">Giá trị loại chỉ thị: </label>
              ...
              <table class="table b-table table-sm table-bordered">
                ...
                <tbody>
                <tr v-for="(field, key) in model.directionCateValue">
...
const CreateRouter = 'listing-directioncatelist-create';
const ViewApi = 'listing/api/direction-cate-list/view';
const ListApi = 'listing/api/direction-cate-list';
const DeleteApi = 'listing/api/direction-cate-list/delete';

export default {
  name: 'listing-view-direction',
  data () {
    return {
    ...
    fetchData() {
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.model.directionCateList = responsesData.data.directionCateList;
          self.model.directionCateValue = responsesData.data.directionCateValue;

          let parentObj = _.find(self.model.directionCateList, ['CateID', self.model.parentID]);
          if (parentObj) {
