                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i>Hệ thống tài khoản dự trữ Quốc gia</span>
                            </div>
                        </b-col>
                    ...
                    <div class="main-header-filter pt-2">
                      <div class="row mb-2">
                        <div class="col-6 mb-2">
                          <coa-snr-modal-search-link
                            v-model="filter.CoaSnrLink"
...
<script>
    ...
    import CoaSnrModalSearchLink from "./partials/CoaSnrModalSearchLink";
    import CoaSnrModalSearchEmployee from "./partials/CoaSnrModalSearchEmployee";
    ...
    export default {
        ...
        data() {
            return {
              filter: {
                ...
                CoaSnrLink: (this.$route.query && this.$route.query.CoaSnrLink) ? this.$route.query.CoaSnrLink : [],
              }
            }
        },
        components:{
          CoaSnrModalSearchLink,
          CoaSnrModalSearchEmployee
        },
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                    ...
                    {key: 'AccountName', label: 'Tên Hệ thống tài khoản dự trữ Quốc gia', thStyle: 'min-width: 300px', field: 'AccountName',searchOnTopRow: {type: 'text'}},
                ];
        ...
        created() {
          ...
          this.settings.Table = 'coa_snr';
          this.settings.FieldInactive = 'Inactive';

          this.settings.ListApi = 'listing/api/coa-snr';
          this.settings.DeleteApi = 'listing/api/coa-snr/delete';
          this.settings.CreateRouter = 'listing-coa-snr-create';
          this.settings.EditRouter = 'listing-coa-snr-edit';
          this.settings.ViewRouter = 'listing-coa-snr-view';
        ...
        methods: {
            ...
            fetchData(){
              ...
              if (this.filter.CoaSnrLink.length) {
                let haveLink = false;
                _.forEach(this.filter.CoaSnrLink, function (coaSnrLink, key) {
                ...
                if (haveLink) {
                  requestData.data.CoaSnrLink = this.filter.CoaSnrLink;
                }
              }
            ...
            let reportJson = await this.$_lists_handleReportTemplate('coa-snr');
            let request = {};
            ...
            if (this.filter.CoaSnrLink.length) {
              ...
              if (haveLink) {
                request.CoaSnrLink = this.filter.CoaSnrLink;
              }
            }
            request.exportData = true;

            let reportData = await this.$_lists_handleReportResponse('listing/api/coa-snr/get-report-data', request);
            this.$_lists_handleDowloadExcel(reportJson, reportData, 'CoaSnr');
          },
        },
        watch: {
            currentPage() {
