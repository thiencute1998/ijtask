  ...
  <div>
    ...
    <div class="form-group row">
      ...
      <div class="col-md-9 m-0">
        <span v-for="(coaSnrCate, key) in value.CoaSnrCate">
          {{coaSnrCate.CateName}}: {{coaSnrCate.Description}} <span v-if="key < (value.CoaSnrCate.length - 1)"> , </span>
        </span>
      </div>
