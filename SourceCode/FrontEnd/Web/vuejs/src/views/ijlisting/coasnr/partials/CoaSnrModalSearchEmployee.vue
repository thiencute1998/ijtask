<template>
  <div class="ijcore-modal-search-input" @mouseenter="onMouseenter">
    <b-input-group>
      <b-form-input placeholder="Chọn người liên hệ" :readonly="true" v-model="value.ContactName" class="input-coa-snr-employee readonly form-control"></b-form-input>
...
export default {
  name: 'CoaSnrModalSearchEmployee',
  mixins: [mixinLists],
  components: {
  },
  computed: {
  ...
  mounted() {
    let self = this;
    this.$el.querySelector('.input-coa-snr-employee').addEventListener('click', function () {
      self.onToggleModal();
    });
  },
  methods: {
