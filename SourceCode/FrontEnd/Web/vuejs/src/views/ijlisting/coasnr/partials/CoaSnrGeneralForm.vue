  ...
  <div>
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-17 col-sm-14 mb-sm-0 mb-md-0 col-20 mb-3 app-object-name">
        <input v-model="value.AccountName" type="text" id="AccountName" class="form-control" placeholder="Tên HTTK DTQG" name="AccountName"/>
      </div>
    ...
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-17">
        <IjcoreModalSystemParent v-model="value" :title="'Hệ thống tài khoản  dự trữ Quốc gia'" :api="'/listing/api/common/list'" :table="'coa_snr'" :fieldName="'AccountName'" :fieldNo="'AccountNo'" :fieldID="'AccountID'" :currentID="value.AccountID" :placeholderInput="'Chọn hệ thống tài khoản  dự trữ Quốc gia cha'" :placeholderSearch="'Nhập tên HTTK DTQG'" :columnID="'AccountID'" :columnNo="'AccountNo'" :columnName="'AccountName'">
        </IjcoreModalSystemParent>
      </div>
    ...
    <div class="form-group row align-items-center">
      ...
      <div class="col-md-9">
        <coa-snr-modal-search-input-catelist v-model="value.CoaSnrCate" title-modal="Loại HTTK DTQG" placeholder="Loại HTTK DTQG">
        </coa-snr-modal-search-input-catelist>
      </div>
...
import CoaSnrModalSearchInputCatelist from "./CoaSnrModalSearchInputCatelist";
import IjcoreModalSearchInput from "../../../../components/IjcoreModalSearchInput";

export default {
  name: 'CoaSnrGeneralForm',
  props: ['value','coaSnrOptions','employeeOptions'],
  components: {
    Select2,
    IjcoreModalListing,
    IjcoreModalSystemParent,
