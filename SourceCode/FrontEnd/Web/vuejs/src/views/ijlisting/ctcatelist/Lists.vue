...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                    ...
                    {key: 'CateName', label: 'Tên loại hợp đồng', field: 'CateName',searchOnTopRow: {type: 'text'}, thStyle: 'min-width: 300px'},
        ...
        created() {
          ...
          this.settings.CreateRouter = 'listing-ctcatelist-create';
          this.settings.EditRouter = 'listing-ctcatelist-edit';
          this.settings.ViewRouter = 'listing-ctcatelist-view';
