    ...
    <div class="table-responsive">
      <table class="not-border mb-2">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <partner-per-field-form :Partner="value" :disable="!per[key].Access" :keyPer="key" :title="'Phân quyền'" field-model="AccessField" :table="'doc'" v-model="field.AccessField" @updateFromChild="updateParent"></partner-per-field-form>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <partner-per-field-form :Partner="value" :disable="!per[key].Edit" :keyPer="key" :title="'Phân quyền'" field-model="EditField" :table="'doc'" v-model="field.EditField" @updateFromChild="updateParent"></partner-per-field-form>
          </td>
          <td class="pr-3 text-center">
...
<script>
  ...
  import PartnerPerFieldView from "./PartnerPerFieldView";
  import PartnerPerFieldForm from "./PartnerPerFieldForm";
  import Select2 from 'v-select2-component';
  import IjcoreModalMultiListing from "../../../../components/IjcoreModalMultiListing";

  export default {
    name: 'PartnerPerForm',
    components: {IjcoreModalMultiListing, PartnerPerFieldForm, PartnerPerFieldView, Select2},
    computed: {},
    data() {
      return {
        OptionAccessType: {
            ...
            _.forEach(dataResponse.data, function (val, key) {
              ...
              if(isExist == 0){
                self.per.push({
                  ...
                  PartnerID: self.value.PartnerID,
                  Access: true,
                  AccessField: 'all',
                  Edit: false,
                  EditField: '',
