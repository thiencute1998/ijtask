        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span v-if="idParams"><i class="fa fa-edit mr-2"></i> Đối tác <span v-if="model.PartnerName">:</span> {{model.PartnerName}}</span>
              <span v-if="!idParams"><i class="fa fa-plus mr-2"></i> Đối tác <span v-if="model.PartnerName">:</span> {{model.PartnerName}}</span>
            </div>
          </b-col>
          ...
          <b-card>
            <div class="form-group row align-items-center">
              ...
              <div class="col-lg-17 col-md-21 col-sm-20 mb-sm-2 mb-md-3 mb-lg-0 mb-3 app-object-name">
                <input v-model="model.PartnerName" type="text" class="form-control" placeholder="Tên đối tác"/>
              </div>
            ...
            <div class="form-group row align-items-center">
              <label class="col-md-3 col-sm-4 m-0 mb-lg-0 mb-md-3 mb-sm-3" for="Address">Địa chỉ đối tác</label>
              <div class="col-lg-17 col-md-21 col-sm-20 mb-sm-2 mb-md-3 mb-lg-0 mb-3 app-object-name">
                <input class="form-control" v-model="model.PartnerAddress" id="Address" placeholder="Địa chỉ đối tác" name="Address"/>
              </div>

            </div>
            <div class="form-group row align-items-center">
              <label class="col-md-3 col-sm-4 m-0 mb-lg-0 mb-md-3 mb-sm-3" for="fullName">Tên nhân viên</label>
              <div class="col-md-9 col-sm-20 mb-lg-0 mb-md-3 mb-sm-3 mb-3">
                <input class="form-control" v-model="model.FullName" id="fullName" placeholder="Tên nhân viên" name="fullName"/>
              </div>
              <label class="col-md-3 col-sm-4 m-0" for="PartnerIdNo" title="Chứng minh nhân dân/Căn cước công dân">CMND/CCCD</label>
              <div class="col-md-9 col-sm-20">
                <input class="form-control" v-model="model.PartnerIdNo" id="PartnerIdNo" placeholder="Số Chứng minh nhân dân/ Căn cước công dân" name="partnerIdNo"/>
              </div>
            </div>
            <div class="form-group row align-items-center">
              <div class="col-lg-3 col-md-3 col-sm-4 mb-lg-0 mb-md-3 mb-sm-3" title="Loại đối tác">Loại đối tác</div>
              <div class="col-lg-9 col-md-9 col-sm-20 mb-lg-0 mb-md-3 mb-sm-3 mb-3">
                <partner-modal-search-input-vcatelist
                  v-model="model.PartnerCate"
                  tableApi="partner_cate_list"
                  refModal="myModalSearchVcatelist"
                  id-modal="myModalSearchVcatelist"
                  placeholder="Loại đối tác"
                  title-modal="Loại đối tác" size-modal="lg"></partner-modal-search-input-vcatelist>
              </div>
              <div class="col-lg-3 col-md-3 col-sm-4" title="Loại đối tác">Quyền truy cập</div>
            ...
            <div class="form-group row align-items-center">
              <label class="col-md-3 col-sm-4 m-0 mb-lg-0 mb-md-3 mb-sm-3" for="Tel">Số điện thoại</label>
              <div class="col-md-9 col-sm-20 mb-lg-0 mb-md-3 mb-sm-3 mb-3">
                <input v-model="model.Tel" type="number" id="Tel" class="form-control" placeholder="Số Điện Thoại" name="Tel" />
              </div>

              <label class="col-md-3 col-sm-4 m-0">Email</label>
              <div class="col-md-9 col-sm-20">
...
import PartnerModalSearchInputVcatelist from "./partials/PartnerModalSearchInputVcatelist";
...
export default {
  ...
  components: {
    ...
    PartnerModalSearchInputVcatelist
  },
  beforeCreate() {},
  mounted() {
        ...
        if (responsesData.status === 1) {
          ...
          if (self.idParams || !_.isEmpty(self.itemCopy)) {
            if (_.isObject(responsesData.data)) {
              self.model.PartnerNo = responsesData.data.data.PartnerNo;
              ...
              self.model.FistName = responsesData.data.data.FistName;
              self.model.MiddleName = responsesData.data.data.MiddleName;
              self.model.LastName = responsesData.data.data.LastName;
              self.model.FullName = responsesData.data.data.FullName;
              self.model.PartnerIdNo = responsesData.data.PartnerIdNo;
              self.model.BirthDay = responsesData.data.data.BirthDay;
              self.model.PartnerIdIssuedDate = responsesData.data.data.PartnerIdIssuedDate;
              self.model.Nationality = responsesData.data.data.Nationality;
              self.model.NativeCountry = responsesData.data.data.NativeCountry;
              self.model.PermanceAddress = responsesData.data.data.PermanceAddress;
              self.model.ResidenceAddress = responsesData.data.data.ResidenceAddress;
              ...
              self.model.PartnerCate = responsesData.data.data.PartnerCate;
    ...
    handleSubmitForm(){
      ...
      const requestData = {
        ...
        data: {
          ...
          FistName: this.model.FirstName,
          MiddleName : this.model.MiddleName,
          LastName : this.model.LastName,
          BirthDay : this.model.BirthDay,
          PartnerIdIssuedDate: this.model.PartnerIdIssuedDate,
          Nationality: this.model.Nationality,
          NativeCountry: this.model.NativeCountry,
          PermanceAddress: this.model.PermanceAddress,
          FullName: this.model.FullName,
          PartnerIdNo: this.model.PartnerIdNo,
      ...
      if (this.model.PartnerCate && this.model.PartnerCate.length) {
        requestData.data.PartnerCate = this.model.PartnerCate;
      }
      ...
      if (!_.isEmpty(this.itemCopy)) {
        requestData.data.CopyID = this.itemCopy.data.data.PartnerID;
      }
      ...
      ApiService.customRequest(requestData).then((responses) => {
        ...
        if (responsesData.status === 1) {
          ...
          self.$router.push({
            ...
            params: {id: responsesData.data.PartnerID, req: self.$route.params.req, message: 'Bản ghi đã được cập nhật!'}
          });
        } else {
