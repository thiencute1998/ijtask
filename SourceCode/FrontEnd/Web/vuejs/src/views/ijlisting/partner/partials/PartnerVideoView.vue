    ...
    <table class="not-border">
      ...
      <tr v-for="(item, key) in value">
        ...
        <td style="text-align: center;width: auto; position: absolute; right: 15px;">
          ...
          <partner-video-edit :Partner="Partner" v-model="value[key]"></partner-video-edit>
...
<script>
  ...
  import PartnerVideoEdit from "./PartnerVideoEdit";

  export default {
    name: 'partner-video-view',
    components: {
      PartnerVideoEdit,
      IjcoreUploadVideo,
    ...
    methods: {
      ...
      downloadVideo(FileID, name) {
        let self = this;
        let urlApi = '/listing/api/partner/download-video/' + FileID;
        let requestData = {
          method: 'get',
          url: urlApi,
          data: {},
      ...
      viewVideo(key) {
        ...
        var ValidPartnerTypes = ["pptx", "ppt", "xls", "xlsx", "doc", "docx"];
        let self = this;
        let urlApi = '/listing/api/partner/download-video/' + this.value[key].FileID;
        let requestData = {
          method: 'get',
          url: urlApi,
          data: {},
      ...
      deleteLine(key) {
        let self = this;
        let urlApi = '/listing/api/partner/delete-video/' + self.value[key].LineID;
        let requestData = {
          method: 'post',
          url: urlApi,
          data: {},
