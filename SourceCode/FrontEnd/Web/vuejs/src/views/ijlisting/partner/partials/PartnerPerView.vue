    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <partner-per-field-view class="app-disable" :Partner="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'partner'" v-model="field.AccessField"></partner-per-field-view>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <partner-per-field-view class="app-disable" :Partner="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'partner'" v-model="field.EditField"></partner-per-field-view>
          </td>
          <td class="pr-3 text-center">
...
<script>
  ...
  export default {
    name: 'PartnerPerView',
    components: {PartnerPerFieldView},
    computed: {},
    data() {
      return {
        OptionAccessType: {
