...
<!--          </b-button>-->
        ...
        <div class="ijcore-search-partner-vcatelist ijcore-modal-search">
          <table class="table b-table table-sm table-bordered table-editable">
            ...
            <tr v-for="(item, key) in value">
              <td>
                <Select2 v-model="value[key].CateID" :settings="{allowClear: true, placeholder: {id: null, text: 'Chọn loại đối tác'}}" :options="CateListOptions" @select="onSelectCateList($event, key)"></Select2>
              </td>
              <td>
    ...
    export default {
      ...
      methods: {
        ...
        fetchData(){
          ...
          requestData.url = '/listing/api/partner/get-cate-list';
          ...
          ApiService.customRequest(requestData).then((responses) => {
            ...
            if (responsesData.status === 1) {
              self.CateList = responsesData.data.PartnerCateList;
              ...
              self.CateValue = responsesData.data.PartnerCateValue;
...
<style lang="css">
  ...
  .ijcore-search-partner-vcatelist .select2.select2-container {
    width: 100% !important;
  }
