<template>
    <div>
        <b-input-group>
            <b-form-input placeholder="Chọn công việc cha" :readonly="true" v-model="this.value['ParentName']" class="readonly form-control"  @click="onToggleModal()"></b-form-input>
            <input type="hidden" :readonly="true" v-model="this.value['ParentID']" class="readonly form-control"></input>
