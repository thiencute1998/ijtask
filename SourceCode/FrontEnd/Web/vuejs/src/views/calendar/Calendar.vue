<template>
  <div class="animated fadeIn">
    <b-card no-body>
      <div slot="header">
        <i class="cui-calendar mr-1"></i> Lịch làm việc
...
<script>
  ...
  const sampleEvents = [
    ...
    },
    {
      ...
      desc: 'Hội nghị lớn cho những người quan trọng',
      classes: 'orange'
    },
    {
      title: 'Cuộc họp',
    ...
    {
      title: 'Từ chối do sai số tài khoản',
