    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <DocPerFieldView :Doc="value" :disable="!per[key].Access" :title="'Phân quyền'" :table="'doc'" v-model="field.AccessField"></DocPerFieldView>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <DocPerFieldView :Doc="value" :disable="!per[key].Edit" :title="'Phân quyền'" :table="'doc'" v-model="field.EditField"></DocPerFieldView>
          </td>
          <td class="pr-3 text-center">
