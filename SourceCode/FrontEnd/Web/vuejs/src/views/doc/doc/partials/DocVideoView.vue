    ...
    <table class="not-border">
      ...
      <tr v-for="(item, key) in value">
        ...
        <td style="text-align: center;width: auto; position: absolute; right: 15px;">
          ...
          <DocVideoEdit :Doc="Doc" v-model="value[key]"></DocVideoEdit>
...
<script>
  ...
  import DocVideoEdit from "./DocVideoEdit";
  ...
  export default {
    ...
    methods: {
      ...
      downloadVideo(FileID, name) {
        let self = this;
        let urlApi = '/doc/api/doc/download-video/' + FileID;
        let requestData = {
          method: 'get',
          url: urlApi,
          data: {},
      ...
      deleteLine(key) {
        let self = this;
        let urlApi = '/doc/api/doc/delete-video/' + self.value[key].LineID;
        let requestData = {
          method: 'post',
          url: urlApi,
          data: {},
