    ...
    <div class="table-responsive">
      <table class="not-border">
        ...
        <tr v-for="(field, key) in per">
          ...
          <td class="pr-3">
            <DocPerFieldForm :Doc="value" :disable="!per[key].Access" :keyPer="key" :title="'Phân quyền'" field-model="AccessField" :table="'doc'" v-model="field.AccessField" @updateFromChild="updateParent"></DocPerFieldForm>
          </td>
          <td class="pr-3 text-center">
          ...
          <td class="pr-3">
            <DocPerFieldForm :Doc="value" :disable="!per[key].Edit" :keyPer="key" :title="'Phân quyền'" field-model="EditField" :table="'doc'" v-model="field.EditField" @updateFromChild="updateParent"></DocPerFieldForm>
          </td>
          <td class="pr-3 text-center">
...
<script>
  ...
  import DocPerFieldView from "./DocPerFieldView";
  import DocPerFieldForm from "./DocPerFieldForm";
  ...
  export default {
    name: 'DocPerForm',
    mixins: [mixinLists],
    components: {IjcoreModalMultiListing, DocPerFieldForm, DocPerFieldView, Select2},
    computed: {},
    data() {
      return {
        OptionAccessType: {
