                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Cơ hội</span>
                            </div>
                        </b-col>
...
<!--                                :striped="propsTable.striped"-->
                          ...
                          <template v-slot:cell(OpportunityName)="data">
                            <span :title="data.item.OpportunityName">{{data.item.OpportunityName}}</span>
                          </template>
                          ...
                          <div class="kanban-item col-lg-6 col-md-8 col-sm-12 col-24" v-for="(item, key) in itemsArray">
                            <div class="kanban-item-inner" @click="onFieldClicked(item)">
                              <div class="kanban-record d-flex justify-content-between">
                                <span class="kanban-title">{{item.OpportunityName}}</span>
                                <span class="kanban-no">{{item.CustomerName}}</span>
                                <span class="kanban-no">{{item.OTAmount}}</span>
                                <span class="kanban-no">{{item.ExpectedDate}}</span>
...
<script>
    ...
    export default {
      ...
      computed: {
          ...
          captions: function() {
              let fieldsTable = [
                  ...
                  {key: 'OpportunityName', label: 'Cơ hội', field: 'OpportunityName', thStyle: 'min-width: 150px', searchOnTopRow: {type: 'text'}, tdClass: 'pr-3'},
                  {key: 'CustomerName', label: 'Người liên hệ', field: 'CustomerName', thStyle: 'min-width: 150px', searchOnTopRow: {type: 'text'}, tdClass: 'pr-3'},
                  {key: 'OTAmount', label: 'Giá trị cơ hội', field: 'OTAmount', thStyle: 'min-width: 150px', searchOnTopRow: {type: 'text'}, tdClass: 'pr-3'},
                  {key: 'ExpectedDate', label: 'Ngày chốt dự kiến', field: 'ExpectedDate', thStyle: 'min-width: 150px', searchOnTopRow: {type: 'text'}, tdClass: 'pr-3'},
                  {key: 'EmployeeName', label: 'Giao cho', field: 'EmployeeName', thStyle: 'min-width: 150px', searchOnTopRow: {type: 'text'}, tdClass: 'pr-3'},
              ];
      ...
      created() {
        this.settings.FieldID = 'OpportunityID';
        this.settings.Table = 'opportunity';
        this.settings.FieldInactive = 'Inactive';

        this.settings.ListApi = 'customer/api/opportunity';
        this.settings.DeleteApi = 'customer/api/opportunity/delete';
        this.settings.CreateRouter = 'customer-opportunity-create';
        this.settings.EditRouter = 'customer-opportunity-edit';
        this.settings.ViewRouter = 'customer-opportunity-view';
      ...
      methods: {
          ...
          fetchData(){
              ...
              if (this.modelSearch.OpportunityName !== '') {
                  requestData.data.OpportunityName = this.modelSearch.OpportunityName;
              }
