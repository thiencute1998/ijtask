<template>
    <a @click="onToggleModal()" class="ij-a-icon" title="Chi tiết">
        ...
        <b-modal scrollable ref="modal" id="modal-form-input-task-general" size="xl" @hide="onHideModalDataflow($event)">
            ...
            <CustomerContractTransContent v-model="value" v-if="!isForm" :isDetail="true" :Customer="Customer" :StatusOption="StatusOption" :CustomerContractTransCate="CustomerContractTransCate">
            </CustomerContractTransContent>
            <CustomerContractTransContent v-model="value" v-if="isForm" :isForm="true" :Customer="Customer" :StatusOption="StatusOption" :CustomerContractTransCate="CustomerContractTransCate">
            </CustomerContractTransContent>
          ...
          fetchData() {
            ...
            onUpdate() {
              ...
              const requestData = {
                ...
                data: {
                  CustomerContractTrans: self.value,
                  CustomerContractTransCate: this.CustomerContractTransCate
                }
              };
              // edit user
