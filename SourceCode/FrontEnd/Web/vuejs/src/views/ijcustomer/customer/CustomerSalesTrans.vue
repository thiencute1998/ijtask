<template>
    <a @click="onToggleModal()" class="ij-a-icon" title="Chi tiết">
        ...
        <b-modal scrollable ref="modal" id="modal-form-input-task-general" size="xl" @hide="onHideModalDataflow($event)">
            ...
            <CustomerSalesTransContent v-model="value" v-if="!isForm" :isDetail="true" :Customer="Customer" :StatusOption="StatusOption" :CustomerSalesTransCate="CustomerSalesTransCate">
            </CustomerSalesTransContent>
            <CustomerSalesTransContent v-model="value" v-if="isForm" :isForm="true" :Customer="Customer" :StatusOption="StatusOption" :CustomerSalesTransCate="CustomerSalesTransCate">
            </CustomerSalesTransContent>
            ...
            onUpdate() {
              ...
              const requestData = {
                ...
                data: {
                  ...
                  // },
                  CustomerSalesTrans: self.value,
                  CustomerSalesTransCate: this.CustomerSalesTransCate
                }
              };
              // edit user
