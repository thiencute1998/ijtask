<template>
    <a @click="onToggleModal()" class="ij-a-icon" title="Chi tiết">
        ...
        <b-modal scrollable ref="modal" id="modal-form-input-task-general" size="xl" @hide="onHideModalDataflow($event)">
            ...
            <CustomerQuotationTransContent v-model="value" v-if="!isForm" :isDetail="true" :Customer="Customer" :StatusOption="StatusOption" :CustomerQuotationTransCate="CustomerQuotationTransCate">
            </CustomerQuotationTransContent>
            <CustomerQuotationTransContent v-model="value" v-if="isForm" :isForm="true" :Customer="Customer" :StatusOption="StatusOption" :CustomerQuotationTransCate="CustomerQuotationTransCate">
            </CustomerQuotationTransContent>
            ...
            onUpdate() {
              ...
              const requestData = {
                ...
                data: {
                  ...
                  // },
                  CustomerQuotationTrans: self.value,
                  CustomerQuotationTransCate: this.CustomerQuotationTransCate
                }
              };
              // edit user
