                  ...
                  <b-row class="mb-2">
                      <b-col md="6" class="col-24">
                          <div class="main-header-item main-header-name">
                              <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Chứng từ chung</span>
                          </div>
                      </b-col>
...
<script>
    ...
    export default {
      ...
      created() {
        ...
        this.settings.ListApi = 'accounting/api/actgvouctrans';
        this.settings.DeleteApi = 'accounting/api/actgvouctrans/delete';
        this.settings.CreateRouter = 'accounting-actgvouctrans-create';
        this.settings.EditRouter = 'accounting-actgvouctrans-edit';
        this.settings.ViewRouter = 'accounting-actgvouctrans-view';
