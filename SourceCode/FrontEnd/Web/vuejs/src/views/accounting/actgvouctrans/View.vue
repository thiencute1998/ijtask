                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span><i class="icon-eye icon mr-2"></i> Chứng từ chung</span>
                        </div>
                    </b-col>
                          ...
                          <b-dropdown variant="primary" id="dropdown-actions"  class="main-header-action mr-2" text="Thao tác">
                                <li class="dropdown b-dropdown dropright">
                                  ...
                                  <ul role="menu" tabindex="-1" class="dropdown-sub-menu dropdown-menu m-0">
                                    <li role="presentation"><a role="menuitem" target="_self" href="#" class="dropdown-item" @click="handleExportPrint">Chứng từ chung</a></li>
                                    <li role="presentation"><a role="menuitem" target="_self" href="#" class="dropdown-item" @click="handleExportReport">Quyết định dự toán</a></li>
                                  </ul>
                                </li>
        ...
        <div class="main-body main-body-view-action">
            <vue-perfect-scrollbar class="scroll-area" :settings="$store.state.psSettings">
                <div class="container-fluid">
                  <div class="card">
                  <div class="form-group row" style="margin-bottom: 0px !important; margin-top: 10px;">
                      ...
                      <b-tabs card>
                        <b-tab title="Cơ quan chính quyền" active>
                          <b-card-text>
                            ...
                            <div class="form-group row align-items-center">
                              <label class="col-md-4 col-xl-3 m-0" >Mã số:</label>
                              <div class="col-md-20 col-xl-5">
                                {{model.CompanyNo}}
                              </div>

                              <label class="col-md-4 col-xl-3 m-0 text-nowrap" >Mã ĐV: </label>
                              <div class="col-md-20 col-xl-5 mt-2 mt-xl-0">
                                {{model.CompanyMOFNo}}
                              </div>

                              <label class="col-md-4 col-xl-3 m-0 text-nowrap" >Mã địa bàn:</label>
                              <div class="col-md-20 col-xl-5 mt-2 mt-xl-0">
                        ...
                        <b-tab title="Nhà cung cấp">
                          <b-card-text>
                            ...
                            <div class="form-group row align-items-center">
                              ...
                              <label class="col-md-4 col-xl-3 m-0" >Nơi mở: </label>
                              <div class="col-md-20 col-xl-9 mt-2 mt-xl-0">
                                {{model.VendorBankName}}
                              </div>
                            </div>
                            <div class="form-group row align-items-center">
                              <label class="col-md-4 col-xl-3 m-0">Đại diện:</label>
                              <div class="col-md-20 col-xl-9">
                                {{model.VendorContactName}}
                              </div>

                              <label class="col-md-4 col-xl-3 m-0" >Chức vụ: </label>
                              <div class="col-md-20 col-xl-9 mt-2 mt-xl-0">
                                {{model.VendorContactPosition}}
                              </div>
                            </div>
                        ...
                        <b-tab title="Đối tác">
                          <b-card-text>
                            ...
                            <div class="form-group row align-items-center">
                              ...
                              <label class="col-md-4 col-xl-3 m-0" >Chức vụ: </label>
                              <div class="col-md-20 col-xl-9 mt-2 mt-xl-0">
                                {{model.PartnerContactPosition}}
                              </div>
                            </div>
                            <div class="form-group row align-items-center">
                              <label class="col-md-4 col-xl-3 m-0 text-nowrap">CMT/CCCD:</label>
                              <div class="col-md-20 col-xl-5">
                                {{model.PartnerCitizenIdNo}}
                              </div>

                              <label class="col-md-4 col-xl-3 m-0" >Ngày cấp: </label>
                              <div class="col-md-20 col-xl-5 mt-2 mt-xl-0">
                                {{model.PartnerCitizenIdDate}}
                              </div>

                              <label class="col-md-4 col-xl-3 m-0" >Nơi cấp:</label>
                              <div class="col-md-20 col-xl-5 mt-2 mt-xl-0">
                                {{model.PartnerCitizenIdAt}}
                              </div>
                            </div>
...
<!--                    </b-card>-->
                  ...
                  <div class="col-md-8 col-lg-8 w-form-control" style="margin-top: 28px;">
                    <div class="form-group row align-items-center" style="margin-bottom: 0.01rem !important;">
                      <label class="col-md-12 col-lg-12 col-xl-5 m-0 p-1" >Số CTG:</label>
                      <div class="col-md-12 col-lg-12 col-xl-7 p-1">
                        {{model.TransNo}}
                      </div>
                      <label class="col-md-12 col-lg-12 col-xl-5 m-0 p-0" >Ngày CTG:</label>
                      <div class="col-md-12 col-lg-12 col-xl-7 p-1">
                    ...
                    <div class="form-group row align-items-center" style="margin-bottom: 0.01rem !important;">
                      ...
                      <label class="col-md-12 col-lg-12 col-xl-5 m-0 p-0" >Ngày CTĐT:</label>
                      <div class="col-md-12 col-lg-12 col-xl-7 p-1">
                    ...
                    <div class="form-group row align-items-center" style="margin-bottom: 0.01rem !important;">
                      ...
                      <label class="col-md-12 col-lg-12 col-xl-5 m-0 p-0" >Loại HTTK:</label>
                      <div class="col-md-12 col-lg-12 col-xl-7 p-1">
                        {{model.CoaTypeName}}
                      </div>
                    </div>
                    <div class="form-group row align-items-center" style="margin-bottom: 0.01rem !important;">
                      ...
                      <label class="col-md-24 col-lg-24 col-xl-12 m-0 p-0 ml-md-auto" >{{model.PeriodFromDate | convertServerDateToClientDate}} - {{model.PeriodToDate | convertServerDateToClientDate}}</label>
                    </div>
                    <div class="form-group row align-items-center" style="margin-bottom: 0.01rem !important;">
                      ...
                      <div class="col-md-12 col-lg-12 col-xl-12 p-0">
                        <b-form-checkbox type="check" v-model="model.isAdjustTrans" class="form-control" style="width: 93%;"></b-form-checkbox> <label style="position: absolute; left: 25px; top: 3px; right: -35px;">Là CT điều chỉnh</label>
                      </div>
                    </div>
                  </div>
                </div>
...
<!--                      </div>-->
                  ...
                  <table class="table b-table table-sm table-bordered table-tree table-view table-column-resizable border-0">
                    ...
                    <tr>
                      ...
                      <th scope="col" style="min-width: 120px" class="text-center">Đơn giá <i v-if="model.item_tt" style="font-style: normal !important;">(NT)</i> </th>
                      <th v-if="model.item_tt" scope="col" style="min-width: 120px" class="text-center">Đơn giá (QĐ) </th>
                      <!-- -->
                      <th v-if="model.item_tt" scope="col" style="min-width: 120px" class="text-center">Nợ nguyên tệ</th>
                      <th v-else scope="col" style="min-width: 120px" class="text-center">Nợ </th>
                      <th v-if="model.item_tt" scope="col" style="min-width: 120px" class="text-center">Có nguyên tệ</th>
                      <th v-else scope="col" style="min-width: 120px" class="text-center">Có </th>
                      <th v-if="model.item_tt" scope="col" style="min-width: 120px" class="text-center">Nợ quy đổi</th>
                      <th v-if="model.item_tt" scope="col" style="min-width: 120px" class="text-center">Có quy đổi</th>
                      <!-- -->
                    ...
                    <tbody>
<!--                    <tr v-for="(field, key) in AccountingTrans">-->
                    <tr v-if="AccountingTrans[key].Show" v-for="(field, key) in AccountingTrans">
                      ...
                      <td v-if="model.item_tkhn">
                        <span class="text-left" :title="field.CoAccountName">{{field.CoAccountNo}}</span>
                      </td>
                      <!-- Định mức chỉ tiêu -->
                      ...
                      <td class="bg-tree-tr pl-0 b-table-sticky-column" style="background: #fff">
                        <span class="bg-tree-dot p-0" :style="{'left': (level * 12) + 'px', top: 0}" v-for="level in AccountingTrans[key].Level"></span>
                        <div class="bg-tree-content bg-tree-td"
                             :style="{'margin-left': (AccountingTrans[key].Level * 12 - 12) + 'px', width: 'calc(100% - ' + (AccountingTrans[key].Level * 12 - 12) + 'px)'}" style="position: absolute; top: 0; bottom: 0">
                          <span style="padding-left: 20px" :title="AccountingTrans[key].Description">{{AccountingTrans[key].Description}}</span>
                          <i class="fa fa-minus-square-o bg-tree-icon-action" v-if="!AccountingTrans[key].Detail" @click="onToggleChildNodes($event, AccountingTrans[key])"></i>
                        </div>
                      </td>
                      <!--Tiền tệ -->
...
<!--                        {{field.ItemName}}-->
                      ...
                      <td v-if="model.item_tt">
                        <span class="text-right">{{field.LCUnitPrice | convertNumberToText}}</span>
                      </td>
                      <!-- -->
                      <td>
                      ...
                      <td>
                        <span class="text-right">{{field.FCCreditAmount | convertNumberToText}}</span>
                      </td>
                      <!-- Tiền tệ -->
                      <td v-if="model.item_tt">
                      ...
                      <td v-if="model.item_tt">
                        <span class="text-right">{{field.LCCreditAmount | convertNumberToText}}</span>
                      </td>
                      <td>
                      ...
                      <td v-if="model.item_dt">
                        <span class="text-center" :title="field.EmployeeName">{{field.EmployeeNo}}</span>
                      </td>
                      <td v-if="model.item_dt">
                      ...
                      <td>
                        <span class="text-left" :title="field.FundName">{{field.FundNo}}</span>
                      </td>
                      <td>
                      ...
                      <!-- Định mức chỉ tiêu -->
                      <td>
                        <span class="text-left" :title="field.NormName">{{field.NormNo}}</span>
                      </td>
                      <!--Nguồn vốn -->
                      ...
                      <td v-if="model.item_mlns">
                        <span class="text-left" :title="field.SbiChapterName">{{field.SbiChapterNo}}</span>
                      </td>
                      <td v-if="model.item_mlns">
                        <span class="text-left" :title="field.SbiCategoryName">{{field.SbiCategoryNo}}</span>
                      </td>
                      <td v-if="model.item_mlns" class="border-right-0">
                        <span class="text-left" :title="field.SbiItemName">{{field.SbiItemNo}}</span>
                      </td>
...
<script>
    ...
    const DeleteApi = 'accounting/api/actgvouctrans/delete';
    const CompanyType = {
        1: 'Đơn vị tổng hợp',
        2: 'Đơn vị trực thuộc',
        3: 'Đơn vị liên kết',
    ...
    export default {
        ...
        methods: {
            fetchData() {
                ...
                ApiService.customRequest(requestData).then((responses) => {
                    ...
                    if (responsesData.status === 1) {
                        ...
                        self.AccountingTrans = responsesData.data.AccountingTrans;
                      _.forEach(self.AccountingTrans, function (item, key) {
                        self.$set(self.AccountingTrans[key], 'Show', true);
                      });
                        self.Actautoact = responsesData.data.Actautoact;
                        //self.AccountingTrans.AutoactID = (responsesData.data.AccountingTrans.AutoactID && AutoactType[responsesData.data.AccountingTrans.AutoactID]) ? AutoactType[responsesData.data.AccountingTrans.AutoactID] : '';
          ...
          actbook(TransID) {
            ...
            const requestData = {
              method: 'post',
              url: 'accounting/api/actgvouctrans/actbook',
              data: {
                ...
                isAdjustTrans: this.model.isAdjustTrans,
          ...
          onToggleChildNodes(e, itemParent) {
            ...
            if (e && e.target.classList.contains('fa-minus-square-o')) {
              ...
              let allChildTableItem = this.getAllChildTableItem(itemParent, this.AccountingTrans);
              if (allChildTableItem && allChildTableItem.length) {
                _.forEach(allChildTableItem, function (childTableItem, key) {
                  let indexItem = _.findIndex(self.AccountingTrans, ['LineID', childTableItem.LineID]);
                  if (indexItem > -1) {
                    self.AccountingTrans[indexItem].Show = false;
                  }
                });
              }
            } else {
              ...
              let allChildren = _.filter(this.AccountingTrans, ['ParentID', itemParent.LineID]);
              if (allChildren.length) {
                _.forEach(allChildren, function (childTableItem, key) {
                  let indexItem = _.findIndex(self.AccountingTrans, ['LineID', childTableItem.LineID]);
                  if (indexItem > -1) {
                    self.AccountingTrans[indexItem].Show = true;
                    $('#table-item-' + self.AccountingTrans[indexItem].LineID + ' .bg-tree-icon-action').removeClass('fa-minus-square-o');
                    $('#table-item-' + self.AccountingTrans[indexItem].LineID + ' .bg-tree-icon-action').addClass('fa-plus-square-o');
                  }
                });
              }
            }
