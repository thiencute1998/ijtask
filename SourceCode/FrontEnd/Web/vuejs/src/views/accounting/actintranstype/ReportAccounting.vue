<template>
  <div class="main-entry">
    ...
    <div class="main-body">
      <ijcore-report-viewer-listing report-name="accounting" :filter="filter" report-data-api="accounting/api/actgvouctrans/get-detail-report-data"></ijcore-report-viewer-listing>
    </div>
  </div>
</template>
