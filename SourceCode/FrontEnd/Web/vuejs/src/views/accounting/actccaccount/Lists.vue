                  ...
                  <b-row class="mb-2">
                      <b-col md="6" class="col-24">
                          <div class="main-header-item main-header-name">
                              <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Tài khoản đồng thời</span>
                          </div>
                      </b-col>
                        ...
                        <div class="b-table-sticky-header table-responsive">
                          <table role="table" aria-busy="false" aria-colcount="2" aria-multiselectable="true"
                            ...
                            <tr role="row" class="">
                              ...
                              <th role="columnheader" scope="col" style="width: 90%; min-width: 200px" aria-sort="none" @click="sortTableByField($event, 'TransDate')" v-if="stage.viewType === 'list'">Tên loại hệ thống tài khoản</th>
                              <th role="columnheader" scope="col" style="width: 90%; min-width: 200px" v-else>Tên loại hệ thống tài khoản</th>
                            </tr>
                            </thead>
                            <tbody role="rowgroup">
...
<script>
    ...
    export default {
      ...
      created() {
        // init setting
        this.settings.FieldID = 'CCAccountID';
        this.settings.Table = 'act_ccaccount';
        this.settings.FieldInactive = 'Inactive';

        this.settings.ListApi = 'accounting/api/actccaccount';
        this.settings.DeleteApi = 'accounting/api/actccaccount/delete';
        this.settings.CreateRouter = 'accounting-actccaccount-create';
        this.settings.EditRouter = 'accounting-actccaccount-edit';
        this.settings.ViewRouter = 'accounting-actccaccount-view';
