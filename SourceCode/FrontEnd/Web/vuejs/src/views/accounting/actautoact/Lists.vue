        ...
        <div class="main-entry">
            <div class="main-header">
                <div class="main-header-padding">
                  <b-row class="mb-2">
                      <b-col md="24" class="col-24">
                          <div class="main-header-item main-header-name">
                              <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Nghiệp vụ hạch toán tự động</span>
                          </div>
                      </b-col>
                        ...
                        <div class="b-table-sticky-header table-responsive">
                          <table role="table" aria-busy="false" aria-colcount="2" aria-multiselectable="true"
                            ...
                            <tr role="row" class="">
                              ...
                              <th role="columnheader" scope="col" style="width: 95%; min-width: 120px" aria-sort="none" @click="sortTableByField($event, 'TransDate')" v-if="stage.viewType === 'list'">Tên nghiệp vụ hạch toán tự động</th>
                              <th role="columnheader" scope="col" style="width: 95%; min-width: 120px" v-else>Tên nghiệp vụ hạch toán tự động</th>
                            </tr>
                            </thead>
                            <tbody role="rowgroup">
<!--                            <transition-group tag="tbody" name="slide-fade">-->
                              <tr role="row" :key="'table-top-row'" class="b-table-top-row">
                                ...
                                <td role="cell" class="">
                                  <b-form-input v-model="modelSearch.AutoactName " @change="$_lists_handleSubmitSearch">
                                  </b-form-input>
                                </td>
                              </tr>
                              <tr role="row" tabindex="0"
                                ...
                                <td @click="onRowClicked(item)" aria-colindex="2" role="cell" class="text-left">{{item.AutoactName }}</td>
                              </tr>
<!--                            </transition-group>-->
                            </tbody>
                          </table>
...
<script>
    ...
    export default {
      ...
      computed: {
        ...
        captions: function() {
          let fieldsTable = [
            ...
            {key: 'AutoactName', label: 'Tên nghiệp vụ hạch toán tự động', field: 'AutoactName',searchOnTopRow: {type: 'text'}, thStyle: 'width: 8%'},
          ];
      ...
      created() {
        // init setting
        this.settings.FieldID = 'AutoactID';
        this.settings.Table = 'act_autoact';
        this.settings.FieldInactive = 'Inactive';

        this.settings.ListApi = 'accounting/api/actautoact';
        this.settings.DeleteApi = 'accounting/api/actautoact/delete';
        this.settings.CreateRouter = 'accounting-actautoact-create';
        this.settings.EditRouter = 'accounting-actautoact-edit';
        this.settings.ViewRouter = 'accounting-actautoact-view';
      ...
      methods: {
        ...
        fetchData(){
          ...
          if (this.modelSearch.AutoactName  !== '') {
            requestData.data.AutoactName  = this.modelSearch.AutoactName ;
          }
        ...
        handleExportPrint() {
          ...
          let request = {};
          if (this.modelSearch.AutoactName  !== '') {
            request.AutoactName  = this.modelSearch.AutoactName ;
          }
          if (this.fullTextSearch !== '') {
