...
<script>
    ...
    export default {
      ...
      created() {
        ...
        this.settings.Table = 'sys_status';
        this.settings.FieldInactive = 'Inactive';

        this.settings.ListApi = 'sysadmin/api/sys-status';
        this.settings.DeleteApi = 'sysadmin/api/sys-status/delete';
        this.settings.CreateRouter = 'sysadmin-sys-status-create';
        this.settings.EditRouter = 'sysadmin-sys-status-edit';
        this.settings.ViewRouter = 'sysadmin-sys-status-view';
