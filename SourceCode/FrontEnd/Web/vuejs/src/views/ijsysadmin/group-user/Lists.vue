                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Danh sách nhóm người dùng</span>
                            </div>
                        </b-col>
                          ...
                          <div class="kanban-item col-lg-6 col-md-8 col-sm-12 col-24" v-for="(item, key) in itemsArray">
                            <div class="kanban-item-inner" @click="$_lists_onFieldClicked(item)">
                              <div class="kanban-record d-lg-flex justify-content-between">
                                <span class="kanban-title">{{item.UserGroupName}}</span>
                              </div>
                              <div class="kanban-record">
                                <span class="kanban-text" v-if="item.Note && item.Note !== ''">{{item.Note}}</span>
                              </div>
                            </div>
                          </div>
                        </div>
...
<script>
    ...
    export default {
      ...
      computed: {
        ...
        captions: function() {
          let fieldsTable = [
              ...
              {key: 'UserGroupName', label: 'Tên nhóm',field: 'UserGroupName', thStyle: 'width: 30%; min-width: 200px', searchOnTopRow: {type: 'text'}},
              {key: 'Note', label: 'Ghi chú', thStyle: 'width: 50%; min-width: 300px'},
          ];
      ...
      created() {
        this.settings.FieldID = 'UserGroupID';
        this.settings.Table = 'sys_user_group';
        this.settings.FieldInactive = 'Inactive';

        this.settings.ListApi = 'sysadmin/api/group-user';
        this.settings.DeleteApi = 'sysadmin/api/group-user/delete';
        this.settings.CreateRouter = 'sysadmin-group-user-create';
        this.settings.EditRouter = 'sysadmin-group-user-edit';
        this.settings.ViewRouter = 'sysadmin-group-user-view';
      ...
      methods: {
        ...
        fetchData(){
            ...
            if (this.modelSearch.UserGroupName.trim() !== '') {
                requestData.data.UserGroupName = this.modelSearch.UserGroupName;
            }
