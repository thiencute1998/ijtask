                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span><i class="icon-eye icon mr-2"></i> Trạng thái chức năng: {{model.statusName}}</span>
                        </div>
                    </b-col>
                    ...
                    <b-card>
                        <div class="form-body">
                            <div class="form-group row align-items-center">
                                <div class="col-md-4 col-sm-8 col-24 mb-2 mb-sm-0 mb-md-0">Tên</div>
                                <div class="col-md-20 col-sm-16 col-24">
                                    {{model.statusName}}
                                </div>
                            </div>

                            <div class="form-group row align-items-center">
                                <div class="col-md-4 col-sm-8 col-24 mb-2 mb-sm-0 mb-md-0">Chức năng</div>
                                <div class="col-md-20 col-sm-16 col-24">
                                    {{model.featureName}}
                                </div>
                            </div>
                            ...
                            <div class="form-group row align-items-center">
                                <div class="col-md-24">Giá trị loại trạng thái:</div>
                            </div>
                            ...
                            <table class="table b-table table-sm table-bordered">
                                ...
                                <tr v-for="(field, key) in model.sysFeatureStatusItem">
                                    <td class="has-padding">{{field.StatusDescription}}</td>
                                    <td>{{model.dataTypeOption[field.DataType]}}</td>
                                    <td v-if="field.DataType == 1 || field.DataType == 2 || field.DataType == 3 || field.DataType == 4">{{field.StatusValue}}</td>
                                    <td v-if="field.DataType == 5">
                                        <span v-if="field.StatusValue == 1">Có</span>
                                        <span v-if="field.StatusValue == 2">Không</span>
                                    </td>
                                    <td v-if="field.DataType == 6">
                                        <span v-if="field.StatusValue == 1">Đúng</span>
                                        <span v-if="field.StatusValue == 2">Sai</span>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
...
<script>
    ...
    const DeleteApi = 'sysadmin/api/fstatuslist/delete';
    ...
    export default {
        ...
        methods: {
            fetchData() {
                ...
                ApiService.customRequest(requestData).then((responses) => {
                    ...
                    if (responsesData.status === 1) {
                        ...
                        let feature = _.find(self.model.feature, ['FeatureID', responsesData.data.data.FeatureID]);
                        if (feature) {
                            self.model.featureName = feature.FeatureName;
                        }
                    }
            ...
            getItemIds(type){
                ...
                if (this.reqParams.search.taskCodeName !== '') {
                    requestData.data.TaskCodeName = this.reqParams.search.taskCodeName;
                }
                ...
                ApiService.customRequest(requestData).then((response) => {
                    ...
                    if (dataResponse.status === 1) {
                        ...
                        _.forEach(dataResponse.data.data, function (value, key) {
                            self.reqParams.idsArray.push(value.TaskCodeID);
                        });
