                    ...
                    <b-row class="mb-2">
                        <b-col class="col-md-12">
                            <div class="main-header-item main-header-name">
                                <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Kiểu dữ liệu nhị phân</span>
                            </div>
                        </b-col>
                          ...
                          <div class="kanban-item col-lg-6 col-md-8 col-sm-12 col-24" v-for="(item, key) in itemsArray">
                            <div class="kanban-item-inner" @click="$_lists_onFieldClicked(item)">
                              <div class="kanban-record d-flex justify-content-between">
                                <span class="kanban-title">{{item.BinaryDataName}}</span>
                                <span class="kanban-no">{{item.BinaryDataNo}}</span>
                              </div>
                            </div>
                          </div>
                        </div>
...
<script>
    ...
    const DeleteApi = 'sysadmin/api/binarydata/delete';
    ...
    export default {
      ...
      mixins: [mixinLists],
        ...
        computed: {
            ...
            captions: function() {
                let fieldsTable = [
                    ...
                    {key: 'BinaryDataNo', label: 'Mã số', thStyle: 'width: 12%; min-width: 100px', field: 'BinaryDataNo',searchOnTopRow: {type: 'text'}},
                    {key: 'BinaryDataName', label: 'Tên ', field: 'BinaryDataName',thStyle: 'min-width: 300px', searchOnTopRow: {type: 'text'}, tdClass: 'pr-3', thClass: 'pr-3'},
                ];
        ...
        created() {
          this.settings.FieldID = 'BinaryDataID';
          this.settings.Table = 'binarydata';
          this.settings.FieldInactive = 'Inactive';

          this.settings.ListApi = 'sysadmin/api/binarydata';
          this.settings.DeleteApi = 'sysadmin/api/binarydata/delete';
          this.settings.CreateRouter = 'sysadmin-binarydata-create';
          this.settings.EditRouter = 'sysadmin-binarydata-edit';
          this.settings.ViewRouter = 'sysadmin-binarydata-view';
        ...
        methods: {
            ...
            fetchData(){
                ...
                if (this.modelSearch.BinaryDataNo !== '') {
                    requestData.data.BinaryDataNo = this.modelSearch.BinaryDataNo;
                }
                if (this.modelSearch.BinaryDataName !== '') {
                    requestData.data.BinaryDataName = this.modelSearch.BinaryDataName;
                }
