                  ...
                  <b-row class="mb-2">
                      <b-col md="6" class="col-24">
                          <div class="main-header-item main-header-name">
                              <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Xem xét dự toán</span>
                          </div>
                      </b-col>
                  ...
                  <b-row class="mb-2">
                    <b-col class="col-lg-16 col-md-24 col-sm-24 col-24 mb-2 mb-lg-0 d-lg-flex justify-content-start align-items-center">
                      <div class="main-header-item main-header-actions">
                        ...
                        <IjcoreModalTransTemp @changed="changeTemplate" v-model="TransTemp" :options="options" :OptionsTransType="OptionsTransType" :TransTypeID="2" :title="'lập dự toán'" :api="'/state-budget-planning/api/sbpreviewplan/get-list'"></IjcoreModalTransTemp>

<!--                        <b-button class="main-header-action mr-2" variant="primary" @click="$_lists_handleAddNewFrom" size="md">-->
<!--                          <i class="fa fa-plus"></i> Thêm từ-->
<!--                        </b-button>-->
<!--                        <b-button class="main-header-action mr-2" variant="primary" @click="$_lists_handleAddNewItem" size="md">-->
    ...
    export default {
      ...
      data() {
          return {
            ...
            options: [
              { item: '0', name: 'Chưa xem xét DT' },
              { item: '1', name: 'Đã Xem xét DT' }
            ],
            OptionsTransType: [{value: '2', text: 'Lập dự toán'},{value: '3', text: 'Xem xét dự toán'},],
          }
      },
      components:{
        IjcoreUsersIcon,
      ...
      created() {
        ...
        this.settings.ListApi = 'state-budget-planning/api/sbpreviewplan';
        this.settings.DeleteApi = 'state-budget-planning/api/sbpreviewplan/delete';
        this.settings.CreateRouter = 'statebudgetplanning-sbpreviewplan-create';
        this.settings.EditRouter = 'statebudgetplanning-sbpreviewplan-edit';
        this.settings.ViewRouter = 'statebudgetplanning-sbpreviewplan-view';
