                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span><i class="icon-eye icon mr-2"></i> Giao dự toán</span>
                        </div>
                    </b-col>
                          ...
                          <b-dropdown variant="primary" id="dropdown-actions" class="main-header-action mr-2" text="Thao tác">
                                <li class="dropdown b-dropdown dropright">
                                  ...
                                  <ul role="menu" tabindex="-1" class="dropdown-sub-menu dropdown-menu m-0">
                                    <li role="presentation"><a role="menuitem" target="_self" class="dropdown-item" @click="handleExportPrintDTNSSChungTuGiaoDuToan01">Quyết định về việc giao dự toán thu chi ngân sách nhà nước</a></li>
                                    <li role="presentation"><a role="menuitem" target="_self" class="dropdown-item" @click="handleExportPrintDTNSSChungTuGiaoDuToan02">Quyết định về việc giao dự toán thu chi ngân sách nhà nước mb02</a></li>
                                    <li role="presentation"><a role="menuitem" target="_self" class="dropdown-item" @click="handleExportPrintDTNSSChungTuGiaoDuToan03">Quyết định về việc giao dự toán thu chi ngân sách nhà nước mb03</a></li>
                                    <li v-if="model.TransID == 152" role="presentation"><a role="menuitem" target="_self" href="/#/report/UocThucHien_VPSoNN-Giao" class="dropdown-item" @click="handleExportPrint">Giao dự toán ngân sách nhà nước</a></li>
                                    <li v-if="model.TransID == 145" role="presentation"><a role="menuitem" target="_self" href="/#/report/SBP_UTH_SOKHDT_06" class="dropdown-item" @click="handleExportPrint">Phụ lục kèm theo Quyết định giao dự toán</a></li>
                                    <li v-if="model.TransID == 158" role="presentation"><a role="menuitem" target="_self" href="/#/report/SBP_UTH_Demo_modul_du_toan_04" class="dropdown-item" @click="handleExportPrint">Giao dự toán ngân sách nhà nước</a></li>

                                    <li v-if="model.TransID == 145" role="presentation"><a role="menuitem" target="_self" href="/#/report/SBP_PB_02" class="dropdown-item" @click="handleExportPrint">Quyết định giao dự toán</a></li>
...
<script>
    ...
    const DeleteApi = 'state-budget-planning/api/sbpassignplan/delete';
    const CompanyType = {
        1: 'Đơn vị tổng hợp',
        2: 'Đơn vị trực thuộc',
        3: 'Đơn vị liên kết',
    ...
    export default {
        ...
        methods: {
          ...
          addLineHttk(link) {
            ...
            handleExportPrintDTNSSChungTuGiaoDuToan01: function(){
              let request = {};
              request.id = this.idParams;
              request.exportData = true;
              this.$router.push({
                name: 'PFMIS_DTNSNN_CHUNGTU_GIAODT_MS-01',
                query: request
              });
            },
          handleExportPrintDTNSSChungTuGiaoDuToan02: function(){
              let request = {};
              request.id = this.idParams;
              request.exportData = true;
              this.$router.push({
                name: 'PFMIS_DTNSNN_CHUNGTU_GIAODT_MS-02',
                query: request
              });
            },
          handleExportPrintDTNSSChungTuGiaoDuToan03: function(){
            let request = {};
            request.id = this.idParams;
            request.exportData = true;
            this.$router.push({
              name: 'PFMIS_DTNSNN_CHUNGTU_GIAODT_MS-03',
              query: request
            });
          },
            updateModel() {
          ...
          actbook(TransID) {
            ...
            const requestData = {
              method: 'post',
              url: 'state-budget-planning/api/sbpassignplan/actbook',
              data: {
