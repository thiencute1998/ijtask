<template>
  <div class="main-entry">
        ...
        <b-row class="mb-2">
          <b-col class="col-md-18">
            <div class="main-header-item main-header-name">
              <span><i class="fa fa-print mr-2"></i> Chứng từ chung</span>
            </div>
          </b-col>
    ...
    <div class="main-body">
      <ijcore-report-viewer-listing report-name="actgvouctrans-detail" :filter="filter" report-data-api="accounting/api/actgvouctrans/get-detail-report-data"></ijcore-report-viewer-listing>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    name: 'listing-actgvouctrans-detail-report',
    data () {
      return {
    ...
    methods: {
      onBackToList() {
        ...
        this.$router.push({
          path: '/accounting/actgvouctrans/view/' + query.id
        });
      },
    },
    watch: {}
