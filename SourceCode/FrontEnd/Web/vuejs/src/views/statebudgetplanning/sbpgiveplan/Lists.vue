                  ...
                  <b-row class="mb-2">
                      <b-col md="6" class="col-24">
                          <div class="main-header-item main-header-name">
                              <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Cấp dự toán </span>
                          </div>
                      </b-col>
                  ...
                  <b-row class="mb-2">
                    <b-col class="col-lg-16 col-md-24 col-sm-24 col-24 mb-2 mb-lg-0 d-lg-flex justify-content-start align-items-center">
                      <div class="main-header-item main-header-actions">
                        ...
                        <IjcoreModalTransTemp @changed="changeTemplate" v-model="TransTemp" :options="options" :OptionsTransType="OptionsTransType" :TransTypeID="6" :title="'giao dự toán'" :api="'/state-budget-planning/api/sbpgiveplan/get-list'"></IjcoreModalTransTemp>
    ...
    export default {
      ...
      data() {
          return {
            ...
            options: [
              { item: '0', name: 'Chưa cấp dự toán' },
              { item: '1', name: 'Đã cấp dự toán' }
            ],
            OptionsTransType: [{value: '6', text: 'Giao dự toán'},{value: '7', text: 'Cấp dự toán'},],
          }
      },
      components:{
        IjcoreUsersIcon,
      ...
      created() {
        ...
        this.settings.ListApi = 'state-budget-planning/api/sbpgiveplan';
        this.settings.DeleteApi = 'state-budget-planning/api/sbpgiveplan/delete';
        this.settings.CreateRouter = 'statebudgetplanning-sbpgiveplan-create';
        this.settings.EditRouter = 'statebudgetplanning-sbpgiveplan-edit';
        this.settings.ViewRouter = 'statebudgetplanning-sbpgiveplan-view';
