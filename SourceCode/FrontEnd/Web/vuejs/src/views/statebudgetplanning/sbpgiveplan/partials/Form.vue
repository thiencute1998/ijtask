                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span v-if="idParams"><i class="fa fa-edit mr-2"></i> Cấp dự toán <span v-if="model.companyName">:</span> {{model.companyName}}</span>
                            <span v-if="!idParams"><i class="fa fa-plus mr-2"></i> Cấp dự toán <span v-if="model.companyName">:</span> {{model.companyName}}</span>
                        </div>
                    </b-col>
                  ...
                  <div class="card">
                    <div class="form-group row" style="margin-bottom: 0px !important; margin-top: 10px; margin-right: 0px;">
                      <div class="col-md-13 col-lg-13 top-trans">
                        <!--                      <b-card no-body>-->
                        <b-tabs card>
                          <b-tab title="Đơn vị cấp" active>
                            <b-card-text>
                              <div class="form-group row align-items-center">
                                <label class="col-md-3 m-0">Tên</label>
                                <div class="col-md-21">
                                  <IjcoreModalSearchCompany
                                    v-model="model.ParentCompanyName" :fieldCateList="'28'" :fieldCateValue="[0,1,2]" :title="'Đơn vị cấp'" :table="'company'" :api="'/listing/api/company/get-cate-value'"
                                    :placeholderInput="'Đơn vị cấp'" @changeCompanyState1="handleGetChangedCompany1">
                                  </IjcoreModalSearchCompany>
                                </div>
                              </div>
                              <!--                              <div class="form-group row align-items-center">-->
                              ...
                              <!--                              </div>-->
                              <div class="form-group row align-items-center">
                                <label class="col-md-3 m-0" >Đại diện</label>
                                <div class="col-md-21">
                          ...
                          <b-tab title="Đơn vị nhận">
                            <b-card-text>
                              <div class="form-group row align-items-center">
                                <label class="col-md-3 m-0">Tên</label>
                                <div class="col-md-21">
                                  <IjcoreModalSearchCompany
                                    v-model="model.CompanyName" :fieldCateList="'28'" :fieldCateValue="[3,4]" :title="'Đơn vị nhận'" :table="'company'" :api="'/listing/api/company/get-cate-value'"
                                    :placeholderInput="'Đơn vị nhận'" @changeCompanyState="handleGetChangedCompany">
                                  </IjcoreModalSearchCompany>
                                </div>
                              </div>
                              <!--                              <div class="form-group row align-items-center">-->
    ...
    <!--                      </div>-->
                  ...
                  <table class="table b-table table-sm table-bordered table-editable table-tree table-column-resizable" style="border-left: none !important;">
                    ...
                    <tr>
                      ...
                      <!-- Phân bổ dự toán -->
                      <th scope="col" style="min-width: 150px" class="text-center">Số phê duyệt <span v-if="model.item_tt">NT</span>  </th>
                      <th v-if="model.item_tt" scope="col" style="min-width: 150px" class="text-center">Số phê duyệt QĐ </th>
                      <!--Tài sản/Vật tư -->
                      ...
                      <!-- Số tiền -->
                      <th scope="col" style="min-width: 150px" class="text-center">Số giao <span v-if="model.item_tt">NT</span>  </th>
                      <th v-if="model.item_tt" scope="col" style="min-width: 150px" class="text-center">Số giao QĐ  </th>
                      <!-- -->
...
<!--                          <IjcoreModalAutoact-->
<!--                            v-model="model.ActgvoucTransItem[key]" :title="'bút toán'" :api="'/listing/api/common/list'" :FieldWhere="{SysAutoactTypeID : 120}"-->
...
<!--                          </IjcoreModalAutoact>-->
                        ...
                        <!-- Định mức -->
                        <td>
                          <ijcore-number v-model="model.ActgvoucTransItem[key].FCNormAmount" @input="addtoFCNormAmount(model.ActgvoucTransItem[key].FCNormAmount, key)"></ijcore-number>
                        </td>
                        <td v-if="model.item_tt">
                        ...
                        <!-- Phê duyệt dự toán -->
                        <td>
                          <ijcore-number v-model="model.ActgvoucTransItem[key].FCApprovedAmount" @input="addtoFCApprovedAmount(model.ActgvoucTransItem[key].FCApprovedAmount, key)"></ijcore-number>
                        </td>
                        <td v-if="model.item_tt">
                          <ijcore-number v-model="model.ActgvoucTransItem[key].LCApprovedAmount" ></ijcore-number>
                        </td>
                        <!--Tài sản/Vật tư -->
...
<script>
    ...
    const ListRouter = 'statebudgetplanning-sbpgiveplan';
    const EditRouter = 'statebudgetplanning-sbpgiveplan-edit';
    const ViewRouter = 'statebudgetplanning-sbpgiveplan-view';
    const CreateRouter = 'statebudgetplanning-sbpgiveplan-create';
    const ViewApi = 'state-budget-planning/api/sbpgiveplan/view';
    const EditApi = 'state-budget-planning/api/sbpgiveplan/edit';
    const CreateApi = 'state-budget-planning/api/sbpgiveplan/create';
    const StoreApi = 'state-budget-planning/api/sbpgiveplan/store';
    const UpdateApi = 'state-budget-planning/api/sbpgiveplan/update';
    const ListApi = 'state-budget-planning/api/sbpgiveplan';
    ...
    export default {
        ...
        created() {
          ...
          // fieldObj.LineID = 1;
          // fieldObj.entry = 1;
          // fieldObj.ConCoAccountID = '';
          // fieldObj.ConCoAccountNo = '';
        ...
        methods: {
            ...
            onCloneFieldChildrenOnTable(keyClone){
              ...
              //this.model.ActgvoucTransItem = __.insertBeforeKey(this.model.ActgvoucTransItem, keyClone + 1, cloneObj);
              //this.model.ActgvoucTransItem.push(cloneObj);
              //this.$forceUpdate();
            },
            onAddFieldOnTable() {
              let fieldObj = {};
          ...
          addtoFCAssignedAmount(evt, key){
            let FCAssignedAmount = this.model.ActgvoucTransItem[key].FCAssignedAmount;
            let ExchangeRate = this.model.ActgvoucTransItem[key].ExchangeRate;
            let LCAssignedAmount = Number(FCAssignedAmount) * Number(ExchangeRate);
            if(LCAssignedAmount=='Infinity'){LCAssignedAmount='';}
            if(LCAssignedAmount){//alert(LCAssignedAmount);
              this.model.ActgvoucTransItem[key].LCAssignedAmount = LCAssignedAmount;
            }else{
              this.model.ActgvoucTransItem[key].LCAssignedAmount ='';
            }
            //this.$forceUpdate()
          },
          ...
          selectednormtable(){
              ...
              const requestData = {
                method: 'post',
                url: 'state-budget-planning/api/sbpgiveplan/getNormTableItem',
                data: {
                  NormTableID: this.model.NormTableID,
                }
              };
          ...
          changeTemplate() {
            ...
            requestData.url = '/state-budget-planning/api/sbpgiveplan/load-temp/' + this.cloneTransID;
            this.$store.commit('isLoading', true);
            ApiService.setHeader();
            ApiService.customRequest(requestData).then((responses) => {
              let responsesData = responses.data;
              if (responsesData.status === 1) {
                ...
                self.model.NormTableNo = responsesData.data.data.NormTableNo;
                self.model.NormTableName = responsesData.data.data.NormTableName;
                self.model.TransTypeID = 7;

                self.model.ActgvoucTransItem = responsesData.data.SbpmakeplanTrans;
                _.map(self.model.ActgvoucTransItem, function (value, key){
                  //value.AutoactName = value.actautoact.AutoactName;
                  value.AutoactID = 37;
                  value.AutoactName = 'Cấp dự toán';
                  value.FCNormAmount = value.FCDebitAmount;
                  value.LCNormAmount = value.LCDebitAmount;
                  value.FCAssignedAmount = value.FCDebitAmount;
                  value.LCAssignedAmount = value.LCDebitAmount;
                  self.$set(self.model.ActgvoucTransItem[key], 'Show', true);
                  self.$set(self.model.ActgvoucTransItem[key], 'ShowPagination', false);
                  if (value.LineID > self.RowItem) {
                    self.RowItem = value.LineIDTmp;
