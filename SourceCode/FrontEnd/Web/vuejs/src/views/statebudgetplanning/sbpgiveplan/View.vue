                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span><i class="icon-eye icon mr-2"></i> Cấp dự toán </span>
                        </div>
                    </b-col>
                          ...
                          <b-dropdown variant="primary" id="dropdown-actions" class="main-header-action mr-2" text="Thao tác">
                                <li class="dropdown b-dropdown dropright">
                                  ...
                                  <ul role="menu" tabindex="-1" class="dropdown-sub-menu dropdown-menu m-0">
                                    <li role="presentation"><a role="menuitem" target="_self" href="/#/report/Demo_modul_du_toan_ms05" class="dropdown-item" @click="handleExportPrint">Cấp dự toán thu, chi ngân sách nhà nước</a></li>
                                    <li role="presentation"><a role="menuitem" target="_self" href="/#/report/QD_GiaoBoSungDuToan_NguonSuNghiep" class="dropdown-item" @click="handleExportPrint">Quyết định Về việc bổ sung dự toán ngân sách Nhà nước</a></li>
                                    <li role="presentation"><a role="menuitem" target="_self" href="/#/report/QD_GiaoDuToan_NguonSuNghiep" class="dropdown-item" @click="handleExportPrint">Quyết định Về việc giao dự toán ngân sách Nhà nước năm - Giám đốc sở nông nghiệp và phát triển nông thôn</a></li>
                                    <li role="presentation"><a role="menuitem" target="_self" href="/#/report/QD_GiaoDuToanNguon_QLNN" class="dropdown-item" @click="handleExportPrint">Quyết đinh về việc giao dự toán ngân sách Nhà nước - Ủy ban nhân dân tỉnh</a></li>
                                    <li role="presentation"><a role="menuitem" target="_self" href="/#/report/QD_PhanBoDuToan_VPUBNDTinh" class="dropdown-item" @click="handleExportPrint">'Quyết định về việc giao dự toán ngân sách Nhà nước - Chánh văn phòng ủy ban nhân dân tỉnh</a></li>
                                    <li v-if="model.TransID == 159" role="presentation"><a role="menuitem" target="_self" href="/#/report/Demo_modul_du_toan_ms05" class="dropdown-item" @click="handleExportPrint">Cấp dự toán ngân sách nhà nước - Chi cục Trồng trọt và bảo vệ thực vật</a></li>
                    ...
                    <div class="form-group row" style="margin-bottom: 0px !important; margin-top: 10px; margin-right: 0px">
                        ...
                        <b-tabs card>
                          <b-tab title="Đơn vị cấp" active>
                            <b-card-text>
                              ...
                              <!--                            </div>-->
                              <div class="form-group row align-items-center">
                                <label class="col-md-4 m-0">Địa chỉ:</label>
                                <div class="col-md-20">
                              ...
                              <!--                            </div>-->
                              <div class="form-group row align-items-center">
                                <label class="col-md-4 m-0" >Đại diện:</label>
                                <div class="col-md-20">
                      ...
                      <div class="col-md-10 col-lg-10" style="margin-top: 32px;">
                        ...
                        <div class="form-group row align-items-center">
                          ...
                          <label class="col-md-5 m-0" >Kỳ HT:</label>
                          <div class="col-md-7">
                            {{model.PeriodName}}
                          </div>
    ...
    <!--                      </div>-->
                  ...
                  <table class="table b-table table-sm table-bordered table-tree table-view table-column-resizable border-0">
                    ...
                    <tr v-if="SbpmakeplanTrans[key].Show" v-for="(field, key) in SbpmakeplanTrans">
                      ...
                      <!-- Phê duyệt dự toán -->
                      <td>
                        <span class="text-right">{{field.FCApprovedAmount | convertNumberToText}}</span>
                      </td>
                      <td v-if="model.item_tt">
                        <span class="text-right">{{field.LCApprovedAmount | convertNumberToText}}</span>
                      </td>
                      <!--Tài sản/Vật tư -->
...
<script>
    ...
    const DeleteApi = 'state-budget-planning/api/sbpgiveplan/delete';
    const CompanyType = {
        1: 'Đơn vị tổng hợp',
        2: 'Đơn vị trực thuộc',
        3: 'Đơn vị liên kết',
    ...
    export default {
        ...
        methods: {
          ...
          actbook(TransID) {
            ...
            const requestData = {
              method: 'post',
              url: 'state-budget-planning/api/sbpgiveplan/actbook',
              data: {
