                  ...
                  <b-row class="mb-2">
                      <b-col md="6" class="col-24">
                          <div class="main-header-item main-header-name">
                              <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Ước thực hiện dự toán</span>
                          </div>
                      </b-col>
                  ...
                  <b-row class="mb-2">
                    <b-col class="col-lg-16 col-md-24 col-sm-24 col-24 mb-2 mb-lg-0 d-lg-flex justify-content-start align-items-center">
                      <div class="main-header-item main-header-actions">
                        ...
                        <IjcoreModalTransTemp @changed="changeTemplate" v-model="TransTemp" :options="options" :OptionsTransType="OptionsTransType" :TransTypeID="6" :title="'giao dự toán'" :api="'/state-budget-planning/api/sbpestimateplan/get-list'"></IjcoreModalTransTemp>
    ...
    export default {
      ...
      data() {
          return {
            ...
            options: [
              { item: '0', name: 'Chưa ước thực hiện' },
              { item: '1', name: 'Đã ước thực hiện' }
            ],
            OptionsTransType: [{value: '6', text: 'Giao dự toán'},{value: '8', text: 'Ước thực hiện dự toán'},],
          }
      },
      components:{
        IjcoreUsersIcon,
      ...
      created() {
        ...
        this.settings.ListApi = 'state-budget-planning/api/sbpestimateplan';
        this.settings.DeleteApi = 'state-budget-planning/api/sbpestimateplan/delete';
        this.settings.CreateRouter = 'statebudgetplanning-sbpestimateplan-create';
        this.settings.EditRouter = 'statebudgetplanning-sbpestimateplan-edit';
        this.settings.ViewRouter = 'statebudgetplanning-sbpestimateplan-view';
