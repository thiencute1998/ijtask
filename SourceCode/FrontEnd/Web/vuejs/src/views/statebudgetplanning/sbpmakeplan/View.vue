                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span><i class="icon-eye icon mr-2"></i> Lập dự toán</span>
                        </div>
                    </b-col>
                    <b-col class="col-md-6"></b-col>
                </b-row>
                <b-row>
                    <b-col class="col-24 mb-2 mb-sm-2 mb-md-2 mb-lg-2 mb-xl-2 col-sm-18 col-md-18 col-lg-18 col-xl-12">
                          ...
                          <b-dropdown variant="primary" id="dropdown-actions" class="main-header-action mr-2" text="Thao tác">
                                <li class="dropdown b-dropdown dropright">
                                  ...
                                  <ul role="menu" tabindex="-1" class="dropdown-sub-menu dropdown-menu m-0">
                                    <li role="presentation"><a role="menuitem" target="_self" class="dropdown-item" @click="handleExportPrintDTNSSChungtuLDTmb01">Chứng từ lập dự toán - biểu 01</a></li>
                                    <li role="presentation"><a role="menuitem" target="_self" class="dropdown-item" @click="handleExportPrintDTNSSChungtuLDTmb02">Chứng từ lập dự toán - biểu 02</a></li>
                                    <li v-if="model.TransID == 149" role="presentation"><a role="menuitem" target="_self" href="/#/report/UocThucHien_VPSoNN-LapDT" class="dropdown-item" @click="handleExportPrint">Lập dự toán ngân sách nhà nước</a></li>
                                    <li v-if="model.TransID == 141 || model.TransID == 176" role="presentation"><a role="menuitem" target="_self" href="/#/report/SBP_UTH_SOKHDT_03" class="dropdown-item" @click="handleExportPrint">Lập dự toán ngân sách nhà nước</a></li>
                                    <li v-if="model.TransID == 132" role="presentation"><a role="menuitem" target="_self" href="/#/report/LapDT" class="dropdown-item" @click="handleExportPrint">Lập dự toán thu chi ngân sách nhà nước</a></li>
                                    <li v-if="model.TransID == 155" role="presentation"><a role="menuitem" target="_self" href="/#/report/SBP_UTH_Demo_modul_du_toan_01" class="dropdown-item" @click="handleExportPrint">Lập dự toán ngân sách nhà nước</a></li>

                                    <li v-if="model.TransID == 141 || model.TransID == 176" role="presentation"><a role="menuitem" target="_self" href="/#/report/demo_Dung_bc16" class="dropdown-item" @click="handleExportPrint">Thuyết minh dự toán</a></li>
                                    <li v-if="model.TransID == 155" role="presentation"><a role="menuitem" target="_self" href="/#/report/Demo_26-2020-CV-CCBVTV" class="dropdown-item" @click="handleExportPrint">Công văn Xây dựng Kế hoạch</a></li>
                                    <li v-if="model.TransID == 155" role="presentation"><a role="menuitem" target="_self" href="/#/report/ThuyetMinh_DuToan-2021_CC-TTbVTV" class="dropdown-item" @click="handleExportPrint">Thuyết minh dự toán</a></li>

                                    <li v-if="model.TransID == 161" role="presentation"><a role="menuitem" target="_self" href="/#/report/demo_Dung_bc20" class="dropdown-item" @click="handleExportPrint">Công văn Xây dựng Kế hoạch</a></li>
                                    <li v-if="model.TransID == 161" role="presentation"><a role="menuitem" target="_self" href="/#/report/demo_Dung_bc21" class="dropdown-item" @click="handleExportPrint">Thuyết minh dự toán</a></li>
                                    <li v-if="model.TransID == 141 || model.TransID == 176" role="presentation"><a role="menuitem" target="_self" href="/#/report/demo_Dung_bc15" class="dropdown-item" @click="handleExportPrint">Công văn</a></li>
                    ...
                    <b-col class="col-24 col-sm-6 col-md-6 col-xl-6 col-xl-12">
          ...
          <div class="container-fluid">
                  <div class="card">
                    <div class="form-group row" style="margin-bottom: 0px !important; margin-top: 10px; margin-right: 0px">
                        ...
                        <b-tabs card>
                          <b-tab title="Đơn vị lập" active>
                            <b-card-text>
                              <div class="form-group row align-items-center">
                                <label class="col-sm-5 col-md-5 col-lg-5 col-xl-4 m-0">Tên:</label>
                                <div class="col-sm-19 col-md-19 col-lg-19 col-xl-20">
                                  {{model.CompanyName}}
                                </div>
                              </div>
                              <div class="form-group row align-items-center">
                                <label class="col-sm-5 col-md-5 col-lg-5 col-xl-4 m-0">Địa chỉ:</label>
                                <div class="col-sm-19 col-md-19 col-lg-19 col-xl-20">
                                  {{model.CompanyAddress}}
                                </div>
                              </div>
                              <div class="form-group row align-items-center">
                                <label class="col-sm-5 col-md-5 col-lg-5 col-xl-4 mb-2 mb-sm-2 mb-md-2 mb-lg-2 mb-xl-0" >Đại diện:</label>
                                <div class="col-sm-19 col-md-19 col-lg-19 col-xl-20 mb-2 mb-sm-2 mb-md-2 mb-lg-2 mb-xl-0">
                                  {{model.CompanyContactName}}
                                </div>

                              </div>
                              <div class="form-group row align-items-center">
                                <label class="col-sm-5 col-md-5 col-lg-5 col-xl-4 m-0" >Chức vụ: </label>
                                <div class="col-sm-19 col-md-19 col-lg-19 col-xl-20">
                          ...
                          <b-tab title="Đơn vị xét duyệt" >
                            <b-card-text>
                              ...
                              <div class="form-group row align-items-center">
                                <label class="col-sm-5 col-md-5 col-lg-5 col-xl-4">Địa chỉ:</label>
                                <div class="col-sm-19 col-md-19 col-lg-19 col-xl-20">
                                  {{model.ParentCompanyAddress}}
                                </div>
                              </div>
                              <div class="form-group row align-items-center">
                                <label class="col-sm-5 col-md-5 col-lg-5 col-xl-4 mb-2" >Đại diện:</label>
                                <div class="col-sm-19 col-md-19 col-lg-19 col-xl-20 mb-2">
                      ...
                      <div class="col-md-10 col-lg-10 col-lg-10 mx-sm-3 mx-md-0 mx-lg-0 mx-xl-0" style="margin-top: 32px;">
                        <div class="form-group row align-items-center">
                    ...
                    <div class="form-group justify-content-end row" style="width: 100%; text-align: right; margin-left: 10px; margin-bottom: 0.3rem !important;">
                      <div class="col-md-12 col-xl-12 m-0 ml-0">
                        <div class="form-group row justify-content-end">
                          ...
                          <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5 text-nowrap">
                      ...
                      <div class="col-md-11 col-xl-11 m-0 ml-0">
                        <div class="form-group row justify-content-between text-left">
                          ...
                          <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 text-nowrap" style="padding-left: 28px;">
                            <b-form-checkbox type="check" v-model="model.item_nv" class="form-control">Nguồn vốn</b-form-checkbox>
                          </div>
                          <div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 ml-0 text-nowrap" style="padding-left: 37px;">
...
<!--                      <th scope="col" style="min-width: 80px" class="text-center">Quỹ </th>-->
                      ...
                      <th v-if="model.item_mlns" scope="col" style="min-width: 85px" class="text-center">Mục/tm </th>
                    ...
                    <tr v-if="SbpmakeplanTrans[key].Show" v-for="(field, key) in SbpmakeplanTrans">
                      ...
                      <td class="has-padding field-task-name text-left">
                        <span :id="'button-2' + key">{{getTitle(field.AutoactID)}}</span>
                        <b-tooltip :target="'button-2' + key" placement="left">
                          {{getTitle(field.AutoactID)}}
                        </b-tooltip>
                      </td>
                      <td v-if="model.item_tkhn" class="text-left">
                        <span>{{field.AccountNo}}</span>
                      </td>
                      <!-- Định mức chỉ tiêu -->
                      ...
                      <!--Nội dung-->
                      <td class="bg-tree-tr pl-0 b-table-sticky-column" style="background-color: #ffffff">
                        <span class="bg-tree-dot" :style="{'left': (level * 12) + 'px', top: 0}" v-for="level in SbpmakeplanTrans[key].Level"></span>
                      ...
                      <!--Tiền tệ -->
                      <td v-if="model.item_tt" class="text-center">
                        <span>{{field.CcyName}}</span>
                      </td>
                      <td v-if="model.item_tt" class="text-center">
                        <span>{{field.ExchangeRate}}</span>
                      </td>
                      <!-- Định mức -->
                      <td class="text-right">
                        <span>{{field.FCNormAmount | convertNumberToText}}</span>
                      </td>
                      <td v-if="model.item_tt" class="text-right">
                        <span>{{field.LCNormAmount | convertNumberToText}}</span>
                      </td>
                      <!-- Ước thực hiện -->
                      <td class="text-right">
                        <span>{{field.FCEstimatedAmount | convertNumberToText}}</span>
                      </td>
                      <td v-if="model.item_tt" class="text-right">
                        <span>{{field.LCEstimatedAmount | convertNumberToText}}</span>
                      </td>
                      <!--Tài sản/Vật tư -->
                      <td v-if="model.item_ts" class="text-center">
                        <span v-if="check_ts == 1" :title="field.ItemName">{{field.ItemNo}}</span>
                        <span v-if="check_ts == 2" :title="field.FixedAssetName">{{field.FixedAssetNo}}</span>
                        <span v-if="check_ts == 3" :title="field.ToolName">{{field.ToolNo}}</span>
                        <span v-if="check_ts == 4" :title="field.InvestAssetName">{{field.InvestAssetNo}}</span>
                      </td>
                      <td class="text-left">
                        <span>{{field.UomName}}</span>
                      </td>
                      <td class="text-right">
                        <span class="text-right">{{field.Quantity}}</span>
                      </td>
                      <td class="text-right">
                        <span>{{field.FCUnitPrice | convertNumberToText}}</span>
                      </td>
                      <!-- Số tiền -->
                      <td class="text-right">
                        <span>{{field.FCDebitAmount | convertNumberToText}}</span>
                      </td>
                      <td v-if="model.item_tt" class="text-right">
                        <span>{{field.LCDebitAmount | convertNumberToText}}</span>
                      </td>
                      <!-- -->
                      <td v-if="model.item_3n" class="text-right">
                        <span>{{field.FCDebitAmount1 | convertNumberToText}}</span>
                      </td>
                      <td v-if="model.item_3n && model.item_tt" class="text-right">
                        <span>{{field.LCDebitAmount1 | convertNumberToText}}</span>
                      </td>
                      <td v-if="model.item_3n" class="text-right">
                        <span>{{field.FCDebitAmount2 | convertNumberToText}}</span>
                      </td>
                      <td v-if="model.item_3n && model.item_tt" class="text-right">
                        <span>{{field.LCDebitAmount2 | convertNumberToText}}</span>
                      </td>
                      <td v-if="model.item_3n" class="text-right">
                        <span>{{field.FCDebitAmount3 | convertNumberToText}}</span>
                      </td>
                      <td v-if="model.item_3n && model.item_tt" class="text-right">
                        <span>{{field.LCDebitAmount3 | convertNumberToText}}</span>
                      </td>
                      <td v-if="model.item_5n" class="text-right">
                        <span>{{field.FCDebitAmount4 | convertNumberToText}}</span>
                      </td>
                      <td v-if="model.item_5n && model.item_tt" class="text-right">
                        <span>{{field.LCDebitAmount4 | convertNumberToText}}</span>
                      </td>
                      <td v-if="model.item_5n" class="text-right">
                        <span>{{field.FCDebitAmount5 | convertNumberToText}}</span>
                      </td>
                      <td v-if="model.item_5n && model.item_tt" class="text-right">
                        <span>{{field.LCDebitAmount5 | convertNumberToText}}</span>
                      </td>
                      <!-- -->
                      <td>
                      ...
                      <!--Hóa đơn -->
                      <td v-if="model.item_hd" class="text-right">
                        <span>{{field.FCTaxAmount | convertNumberToText}}</span>
                      </td>
                      <td v-if="model.item_hd" class="text-center">
                        <span>{{field.TaxRate}}</span>
                      </td>
                      <td v-if="model.item_hd" class="text-center">
                        <span>{{field.InvoiceNo}}</span>
                      </td>
                      <td v-if="model.item_hd" class="text-center">
                        <span>{{field.InvoiceDate | convertServerDateToClientDate}}</span>
                      </td>
                      <td v-if="model.item_hd" class="text-center">
                        <span>{{field.InvoiceSerialNo}}</span>
                      </td>
                      <td v-if="model.item_hd" class="text-center">
                        <span>{{field.InvoiceFormNo}}</span>
                      </td>
                      <td v-if="model.item_hd" class="text-center">
                        <span>{{field.InvoiceSecurityCode}}</span>
                      </td>
                      <td v-if="model.item_hd">
                        {{field.InvoiceLookupAddress}}
                      </td>
                      <!--Dự án -->
                      <td v-if="model.item_da" class="text-center">
                        <span :title="field.ProjectName">{{field.ProjectNo}}</span>
                      </td>
                      <td v-if="model.item_da" class="text-center">
                        <span :title="field.ProgramName">{{field.ProgramNo}}</span>
                      </td>
                      <td v-if="model.item_da" class="text-center">
                        <span :title="field.ContractName">{{field.ContractNo}}</span>
                      </td>
                      <!--Đối tượng -->
                      <td v-if="model.item_dt" class="text-left">
                        <span>{{field.InTransTypeName}}</span>
                      </td>
                      <td v-if="model.item_dt" class="text-center">
                        <span>{{field.EmployeeNo}}</span>
                      </td>
                      <td v-if="model.item_dt" class="text-center">
                        <span>{{field.VendorNo}}</span>
                      </td>
                      <td v-if="model.item_dt" class="text-center">
                        <span>{{field.CustomerNo}}</span>
                      </td>
                      <td v-if="model.item_dt" class="text-left">
                        <span>{{field.FullName}}</span>
                      </td>
                      <td class="text-left">
                        <span :title="field.RevenueName">{{field.RevenueNo}}</span>
                      </td>
                      <!-- Lĩnh vực thu -->
                      <td>
                      ...
                      <td class="text-left">
                        <span :title="field.ExpenseName">{{field.ExpenseNo}}</span>
                      </td>
                      <!-- Lĩnh vực chi -->
                      <td class="text-left">
                        <span :title="field.SectorName">{{field.SectorNo}}</span>
                      </td>
                      <!--Nguồn vốn -->
                      <td v-if="model.item_nv" class="text-left">
                        <span>{{BudgetLevel[field.BudgetLevel]}}</span>
                      </td>
                      <td v-if="model.item_nv" class="text-left">
                        <span>{{FiscalPeriod[field.FiscalPeriod]}}</span>
                      </td>
                      <td v-if="model.item_nv" class="text-center">
                        <span>{{field.FiscalYear}}</span>
                      </td>
                      <td v-if="model.item_nv" class="text-left">
                        <span :title="field.CapitalName">{{field.CapitalNo}}</span>
                      </td>
                      <td v-if="model.item_nv" class="text-left">
                        <span :title="ReceiveBy[field.ReceiveBy]">{{ReceiveBy[field.ReceiveBy]}}</span>
                      </td>
                      <td v-if="model.item_nv" class="text-left">
                        <span :title="BudgetAllocType[field.BudgetAllocTypeID]">{{BudgetAllocType[field.BudgetAllocTypeID]}}</span>
                      </td>
                      <!--MLNS -->
                      <td v-if="model.item_mlns" class="text-left">
                        <span>{{field.SbiChapterNo}}</span>
                      </td>
                      <td v-if="model.item_mlns" class="text-left">
                        <span>{{field.SbiCategoryNo}}</span>
                      </td>
                      <td v-if="model.item_mlns" class="text-left">
                        <span>{{field.SbiItemNo}}</span>
                      </td>
...
<script>
    ...
    const DeleteApi = 'state-budget-planning/api/sbpmakeplan/delete';
    const CompanyType = {
        1: 'Đơn vị tổng hợp',
        2: 'Đơn vị trực thuộc',
        3: 'Đơn vị liên kết',
    ...
    export default {
        ...
        methods: {
            fetchData() {
                ...
                ApiService.customRequest(requestData).then((responses) => {
                    ...
                    if (responsesData.status === 1) {
                      ...
                      //Check PeriodType
                      let PostDate = moment(__.convertDateToString(this.model.PostDate), 'L');
                      let yyyy = PostDate.get("year");
                      if(this.model.PeriodType == 8){
                        this.model.item_3n = true;
                        this.model.item_5n = false;
                        this.yyyy1 = yyyy + 1;
                        this.yyyy2 = yyyy + 2;
                        this.yyyy3 = yyyy + 3;
                      }else if(this.model.PeriodType == 9){
                        this.model.item_3n = true;
          ...
          handleExportPrintDTNSSChungtuLDTmb01: function(){
            let request = {};
            request.id = this.idParams;
            request.exportData = true;
            this.$router.push({
              name: 'PFMIS_DUTOAN_CVTT-ĐVDT_CQTC-CV',
              query: request
            });
          },
          handleExportPrintDTNSSChungtuLDTmb02: function(){
            let request = {};
            request.id = this.idParams;
            request.exportData = true;
            this.$router.push({
              name: 'PFMIS_DUTOAN_CVĐV-STC',
              query: request
            });
          },
          ...
          actbook(TransID) {
            ...
            const requestData = {
              method: 'post',
              url: 'state-budget-planning/api/sbpmakeplan/actbook',
              data: {
