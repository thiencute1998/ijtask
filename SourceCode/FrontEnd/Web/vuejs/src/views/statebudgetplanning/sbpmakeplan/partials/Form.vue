    ...
    <div class="main-entry component-sbp-form">
                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span v-if="idParams"><i class="fa fa-edit mr-2"></i> Lập dự toán<span v-if="model.companyName">:</span> {{model.companyName}}</span>
                            <span v-if="!idParams"><i class="fa fa-plus mr-2"></i> Lập dự toán<span v-if="model.companyName">:</span> {{model.companyName}}</span>
                        </div>
                    </b-col>
        ...
        <div class="main-body main-body-view-action" id="main-body">
          <div class="container-fluid">
            <div class="card">
              <div class="form-group row" style="margin-bottom: 0 !important; margin-top: 10px; margin-right: 0px;">
                <div class="col-md-13 col-lg-13 col-xl-13 top-trans">
                  <!--                      <b-card no-body>-->
                  <b-tabs card >
                    <b-tab title="Đơn vị lập" active>
                      <b-card-text>
                        <div class="form-group row align-items-center">
                          <label class="col-sm-5 col-md-5 col-lg-5 col-xl-3 m-0">Tên</label>
                          <div class="col-sm-19 col-md-19 col-lg-19 col-xl-21">
                        ...
                        <div class="form-group row align-items-center">
                          <label class="col-sm-5 col-md-5 col-lg-5 col-xl-3 m-0">Địa chỉ</label>
                          <div class="col-sm-19 col-md-19 col-lg-19 col-xl-21">
                            <input v-model="model.CompanyAddress" class="form-control" rows="3" placeholder="Địa chỉ"/>
                          </div>
                        </div>
                        <div class="form-group row align-items-center">
                          <label class="col-sm-5 col-md-5 col-lg-5 col-xl-3 mb-2 mb-sm-2 mb-md-2 mb-lg-2 mb-xl-0" >Đại diện</label>
                          <div class="col-sm-19 col-md-19 col-lg-19 col-xl-21 mb-2 mb-sm-2 mb-md-2 mb-lg-2 mb-xl-0">
                    ...
                    <b-tab title="Đơn vị xét duyệt">
                      <b-card-text>
                        ...
                        <div class="form-group row align-items-center">
                          <label class="col-sm-5 col-md-5 col-lg-5 col-xl-3">Địa chỉ</label>
                          <div class="col-sm-19 col-md-19 col-lg-19 col-xl-21">
                            <input v-model="model.ParentCompanyAddress" class="form-control" rows="3" placeholder="Địa chỉ"/>
                          </div>
                        </div>
                        <div class="form-group row align-items-center">
                          <label class="col-sm-5 col-md-5 col-lg-5 col-xl-3 mb-2" >Đại diện</label>
                          <div class="col-sm-19 col-md-19 col-lg-19 col-xl-21 mb-2">
                            <IjcoreModalMultipleCategory
                              v-model="model" :title="'đại diện'" :api="'/listing/api/common/list'"
                ...
                <div class="col-md-10 col-lg-10 col-lg-10 mx-sm-3 mx-md-0 mx-lg-0 mx-xl-0 w-form-control" style="margin-top: 32px;">
                  <div class="form-group row align-items-center">
                    <label class="col-sm-5 col-md-12 col-lg-12 col-xl-5 mb-2 mb-sm-2 mb-md-2 mb-lg-2 mb-xl-0" >Số CTG</label>
                    <div class="col-sm-19 col-md-12 col-lg-12 col-xl-7 mb-2 mb-sm-2 mb-md-2 mb-lg-2 mb-xl-0">
                      <input type="text" v-model="model.TransNo" class="form-control" placeholder="Số CTG"/>
                    </div>
                    <label class="col-sm-5 col-md-12 col-lg-12 col-xl-5 m-0" >Ngày CTG</label>
                    <div class="col-sm-19 col-md-12 col-lg-12 col-xl-7">
                      <IjcoreDatePicker v-model="model.TransDate" style="width: 100%;" @input="changeTransDate"></IjcoreDatePicker>
                    </div>
                  </div>
                  <div class="form-group row align-items-center">
                    <label class="col-sm-5 col-md-12 col-lg-12 col-xl-5 mb-2 mb-sm-2 mb-md-2 mb-lg-2 mb-xl-0" >Số CTĐT</label>
                    <div class="col-sm-19 col-md-12 col-lg-12 col-xl-7 mb-2 mb-sm-2 mb-md-2 mb-lg-2 mb-xl-0">
                      <input type="text" v-model="model.eTransNo" class="form-control" placeholder="Số CTĐT"/>
                    </div>
                    <label class="col-sm-5 col-md-12 col-lg-12 col-xl-5 mb-0" >Ngày CTĐT</label>
                    <div class="col-sm-19 col-md-12 col-lg-12 col-xl-7 mb-0">
                      <IjcoreDatePicker v-model="model.eTransDate" style="width: 100%;"></IjcoreDatePicker>
                    </div>
                  </div>
                  <div class="form-group row align-items-center">
                    <label class="col-sm-5 col-md-12 col-lg-12 col-xl-5 mb-2 mb-sm-2 mb-md-2 mb-lg-2 mb-xl-0" >Ngày HT</label>
                    <div class="col-sm-19 col-md-12 col-lg-12 col-xl-7 mb-2 mb-sm-2 mb-md-2 mb-lg-2 mb-xl-0">
                      <IjcoreDatePicker v-model="model.PostDate" style="width: 100%;"></IjcoreDatePicker>
                    </div>
                    <label class="col-sm-5 col-md-12 col-lg-12 col-xl-5 mb-0" >Kỳ HT
                    ...
                    <div v-if="model.item_DF599" class="col-sm-19 col-md-12 col-lg-12 col-xl-7 mb-0">
                      <b-form-select
                        v-model="model.PeriodID"
                        :options="model.ArrPeriodOption" @change="changePeriodName">
                      </b-form-select>
                    </div>
                    <div v-if="model.item_599" class="col-sm-19 col-md-12 col-lg-12 col-xl-7 mb-0">
                      <IjcoreDatePicker v-model="model.PeriodFromDate" style="width: 100%;"></IjcoreDatePicker>
                    </div>
                  </div>
                  <div class="form-group row align-items-center">
                    <label class="col-sm-5 col-md-12 col-lg-12 col-xl-5 mb-2 mb-sm-2 mb-md-2 mb-lg-2 mb-xl-0" >Loại HTTK</label>
                    <div class="col-sm-19 col-md-12 col-lg-12 col-xl-7 mb-2 mb-sm-2 mb-md-2 mb-lg-2 mb-xl-0">
                      <b-form-select v-model="model.CoaTypeID" :options="model.Coatype" @change="changeCoatype"></b-form-select>
                    </div>
                    <label class="col-sm-5 col-md-12 col-lg-12 col-xl-5 mb-0" >Trạng thái</label>
                    <div class="col-sm-19 col-md-12 col-lg-12 col-xl-7 mb-0">
                ...
                <div class="form-group justify-content-end row" style="width: 100%; text-align: right; margin-left: 10px;">
                  <div class="col-md-12 col-xl-12 m-0 ml-0">
                    <div class="form-group row justify-content-end">
                      <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5 m-0 ml-0">
                        <norm-table-form @changed="onAddLine"></norm-table-form>
                      </div>
                      <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5 m-0 ml-0">
                        <b-form-checkbox type="check" v-model="model.item_tt" class="form-control">Tiền tệ</b-form-checkbox>
                      </div>
                      <div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 m-0 ml-0">
                  ...
                  <div class="col-md-11 col-xl-11 m-0 ml-0">
                    <div class="form-group row justify-content-between text-left">
                      ...
                      <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 m-0 ml-0 text-nowrap" style="padding-left: 28px;">
                ...
                <div class="table-responsive b-table-sticky-header b-table-sticky-custom m-0" style="max-height: 350px;">
                  <table class="table b-table table-sm table-bordered table-editable table-tree table-column-resizable" style="border-left: none !important;">
                    ...
                    <tr>
                      ...
                      <!-- Ước thực hiện -->
                      <th scope="col" style="min-width: 150px" class="text-center">Ước thực hiện <span v-if="model.item_tt">NT</span> </th>
                      <th v-if="model.item_tt" scope="col" style="min-width: 150px" class="text-center">Ước thực hiện QĐ </th>
                      <!--Tài sản/Vật tư -->
                      <th v-if="model.item_ts" scope="col" style="min-width: 120px" class="text-center">{{item_ts_name}} </th>
                      <th scope="col" style="min-width: 138px; z-index: 10" class="text-center">ĐVT </th>
...
<!--                      <td style="border-left: 1px solid #c8ced3; border-right: 0px; max-width: 1px !important;" class="bg-tree-tr b-table-sticky-column"></td>-->
...
<!--                        <IjcoreModalAutoact-->
<!--                          v-model="model.ActgvoucTransItem[key]" :title="'bút toán'" :api="'/listing/api/common/list'" :FieldWhere="{SysAutoactTypeID : 116}"-->
...
<!--                        </IjcoreModalAutoact>-->
                        <b-form-select v-model="model.ActgvoucTransItem[key].AutoactID" :options="model.Autoact | filterAutoact(model.ActgvoucTransItem[key].NormType)"  @change="changeAutoact1($event,key)"></b-form-select>
                      </td>
                      ...
                      <!-- Ước thực hiện -->
                      <td>
                        <ijcore-number v-model="model.ActgvoucTransItem[key].FCEstimatedAmount" @input="addtoFCEstimatedAmount(model.ActgvoucTransItem[key].FCEstimatedAmount, key)"></ijcore-number>
                      </td>
                      <td v-if="model.item_tt">
                        <ijcore-number v-model="model.ActgvoucTransItem[key].LCEstimatedAmount" ></ijcore-number>
                      </td>
                      <!--Tài sản/Vật tư -->
...
<!--                        </b-form-input>-->
                      ...
                      <td>
                        <IjcoreModalAccounting
                          ...
                          :FieldUpdate="['SbrSectorID', 'SbrSectorNo', 'SbrSectorName', 'isRevenueRegulationRate']" @changed="changeRevenueNo($event, key)">
                        </IjcoreModalAccounting>
                      </td>
                      <!-- Lĩnh vực thu -->
                      <td>
...
<!--                <div style="margin-left: 2px;" class="mb-3 mb-xl-0">-->
<!--                  <a @click="onAddFieldOnTable" class="new-row" style="width: 120px;">-->
<!--                    <i aria-hidden="true" class="fa fa-plus-square-o ij-icon ij-icon-plus"></i> Thêm dòng-->
<!--                  </a>-->
<!--                </div>-->
...
<script>
    ...
    import NormTableForm from "../../sbpreviewplan/partials/NormTableForm";
    moment.locale('vi');
    import mixinTablePagination from "@/mixins/tablePagination";
    import tableTree from "../../../../mixins/tableTree";

    const ListRouter = 'statebudgetplanning-sbpmakeplan';
    const EditRouter = 'statebudgetplanning-sbpmakeplan-edit';
    const ViewRouter = 'statebudgetplanning-sbpmakeplan-view';
    const CreateRouter = 'statebudgetplanning-sbpmakeplan-create';
    const ViewApi = 'state-budget-planning/api/sbpmakeplan/view';
    const EditApi = 'state-budget-planning/api/sbpmakeplan/edit';
    const CreateApi = 'state-budget-planning/api/sbpmakeplan/create';
    const StoreApi = 'state-budget-planning/api/sbpmakeplan/store';
    const UpdateApi = 'state-budget-planning/api/sbpmakeplan/update';
    const ListApi = 'state-budget-planning/api/sbpmakeplan';
    ...
    export default {
        ...
        methods: {
                    ...
                    if (responsesData.status === 1) {
                        ...
                        if (self.idParams || !_.isEmpty(self.itemCopy)) {
                          if (_.isObject(responsesData.data.data)) {
                            ...
                            self.model.CompanyContactID = responsesData.data.data.CompanyContactID;
                            self.model.CompanyContactNo = responsesData.data.data.CompanyContactNo;
                            ...
                            self.model.ParentCompanyContactID = responsesData.data.data.ParentCompanyContactID;
                            self.model.ParentCompanyContactNo = responsesData.data.data.ParentCompanyContactNo;
            ...
            onAddFieldChildrenOnTable1(keyParent,ReguRate){
              let tmpObj = {};
              this.model.ActgvoucTransItem[keyParent].Detail = 0;
              this.model.ActgvoucTransItem[keyParent].isReguRate = true;
              tmpObj.LineID = this.RowItem; this.RowItem ++;
              tmpObj.Level = this.model.ActgvoucTransItem[keyParent].Level + 1;
              tmpObj.Detail = 1;
              tmpObj.ReguRate = ReguRate;
              tmpObj.ParentID = this.model.ActgvoucTransItem[keyParent].LineID;
              tmpObj.AutoactID = this.model.ActgvoucTransItem[keyParent].AutoactID;
              tmpObj.AutoactName = this.model.ActgvoucTransItem[keyParent].AutoactName;
              tmpObj.AccountID = this.model.ActgvoucTransItem[keyParent].AccountID;
              ...
              tmpObj.CoAccountID = this.model.ActgvoucTransItem[keyParent].CoAccountID;
              tmpObj.CoAccountNo = this.model.ActgvoucTransItem[keyParent].CoAccountNo;
              tmpObj.FCDebitAmount = (Number(this.model.ActgvoucTransItem[keyParent].FCDebitAmount) * Number(ReguRate))/100;
              tmpObj.LCDebitAmount = (Number(this.model.ActgvoucTransItem[keyParent].LCDebitAmount) * Number(ReguRate))/100;
              tmpObj.FCExecAmount = (Number(this.model.ActgvoucTransItem[keyParent].FCExecAmount) * Number(ReguRate))/100;
              tmpObj.LCExecAmount = (Number(this.model.ActgvoucTransItem[keyParent].LCExecAmount) * Number(ReguRate))/100;
              tmpObj.Description = this.model.ActgvoucTransItem[keyParent].Description;
              tmpObj.CcyID = this.model.ActgvoucTransItem[keyParent].CcyID;
              tmpObj.CcyName = 'VND';
              tmpObj.ExchangeRate = this.model.ActgvoucTransItem[keyParent].ExchangeRate;
              ...
              const requestData = {
                ...
                data: {
                  master: {
                    ...
                    CompanyContactID: this.model.CompanyContactID,
                    CompanyContactNo: this.model.CompanyContactNo,
                    ...
                    ParentCompanyContactID: this.model.ParentCompanyContactID,
                    ParentCompanyContactNo: this.model.ParentCompanyContactNo,
          ...
          addtoFCEstimatedAmount(evt, key){
            let FCEstimatedAmount = this.model.ActgvoucTransItem[key].FCEstimatedAmount;
            let ExchangeRate = this.model.ActgvoucTransItem[key].ExchangeRate;
            let LCEstimatedAmount = Number(FCEstimatedAmount) * Number(ExchangeRate);
            if(LCEstimatedAmount=='Infinity'){LCEstimatedAmount='';}
            if(LCEstimatedAmount){//alert(LCUnitPrice);
              this.model.ActgvoucTransItem[key].LCEstimatedAmount = LCEstimatedAmount;
            }else{
              this.model.ActgvoucTransItem[key].LCEstimatedAmount ='';
            }
            //this.$forceUpdate()
          },
          addtoFCAllocatedAmount(evt, key){
            let FCAllocatedAmount = this.model.ActgvoucTransItem[key].FCAllocatedAmount;
            let ExchangeRate = this.model.ActgvoucTransItem[key].ExchangeRate;
            let LCAllocatedAmount = Number(FCAllocatedAmount) * Number(ExchangeRate);
            if(LCAllocatedAmount=='Infinity'){LCAllocatedAmount='';}
          ...
          addtoLCDebitAmount(evt, key){
            ...
            //Phân bổ lại theo tỷ lệ phân bổ
            let isReguRate = self.model.ActgvoucTransItem[key].isReguRate;
            let allChildren = _.filter(self.model.ActgvoucTransItem, ['ParentID', self.model.ActgvoucTransItem[key].LineID]);
            if(isReguRate) {
              _.forEach(allChildren, function (value, keyChild) {
                let indexChild = _.findIndex(self.model.ActgvoucTransItem, ['LineID', value.LineID]);
                self.model.ActgvoucTransItem[indexChild].FCDebitAmount = (FCDebitAmount * Number(value.ReguRate)) / 100;
              });
            }
            //this.$forceUpdate()
          },
          ...
          changeRevenueNo($event,key){
            let self = this;
            let isRRR = this.model.ActgvoucTransItem[key].isRevenueRegulationRate;
            let RevenueID = this.model.ActgvoucTransItem[key].RevenueID;
            let RevenueNo = this.model.ActgvoucTransItem[key].RevenueNo;
            let PostDate = this.model.PostDate;

            if(isRRR==1){
              //let title = 'Bạn có muốn phân bổ điều tiết thu ngân sách?';
              Swal.fire({
                //title: title,
                text: 'Bạn có muốn phân bổ điều tiết thu ngân sách?',
                type: 'warning',
                ...
                if (result.value) {
                  let requestData = {
                    method: 'post',
                    url: '/state-budget-planning/api/sbpestimateplan/get-list-regu',
                    data: {
                      RevenueID: RevenueID,
                      RevenueNo: RevenueNo,
                      PostDate: PostDate,
                  ...
                  ApiService.setHeader();
                  ApiService.customRequest(requestData).then((response) => {
                    let responseData = response.data; //console.log(responseData.data.RevenueRegu);
                    if (responseData.status === 1) {
                      ...
                      _.forEach(allChildren, function (value, keyChild) {
                        let indexChild = _.findIndex(self.model.ActgvoucTransItem, ['LineID', value.LineID]);
                        if (indexChild > -1) {
                          self.model.ActgvoucTransItem.splice(indexChild, 1);
                        }
                      });
                      _.forEach(responseData.data.RevenueRegu, function (item, key) {
                        self.onAddFieldChildrenOnTable1(i,item.ReguRate);
                      });
                ...
                if (responsesData.status === 1) {
                  if (!self.idParams && responsesData.data) self.idParams = responsesData.data.param;
                    ...
                    _.forEach(self.model.NormTableItem, function (field, key) {
                        ...
                        fieldObj.AutoactName = 'Lập dự toán';
                        fieldObj.AutoactNo = '';
                        fieldObj.CcyID = 33;
                        fieldObj.CcyNo = '033';
                        fieldObj.CcyName = 'VND';
          ...
          onAddLine(data){
            ...
            if(data.length){
              ...
              data.map(function (val, key) {
                let AnuAccountNo = '012';
                if(val.NormType==2){ AnuAccountNo = '022';}
              ...
              // update parent
              _.forEach(self.model.ActgvoucTransItem, function (tranItem, key) {
                if (tranItem.ParentID) {
                  let parent = _.find(self.model.ActgvoucTransItem, ['NormTableItemID', tranItem.ParentID]);
                  if (parent) {
                    self.model.ActgvoucTransItem[key].ParentID = parent.LineID;
                  }
                }
              });
          ...
          changeTemplate() {
            ...
            requestData.url = '/state-budget-planning/api/sbpmakeplan/load-temp/' + this.cloneTransID;
            this.$store.commit('isLoading', true);
            ApiService.setHeader();
            ApiService.customRequest(requestData).then((responses) => {
              let responsesData = responses.data;
              if (responsesData.status === 1) {
                ...
                self.model.NormTableNo = responsesData.data.data.NormTableNo;
                self.model.NormTableName = responsesData.data.data.NormTableName;
                self.model.TransTypeID = 2;

                self.model.ActgvoucTransItem = responsesData.data.SbpmakeplanTrans;
                _.map(self.model.ActgvoucTransItem, function (value, key) {
                  //value.AutoactName = value.actautoact.AutoactName;
                  value.AutoactID = 33;
                  value.AutoactName = 'Lập dự toán';
                  value.FCEstimatedAmount = value.FCDebitAmount;
                  value.LCEstimatedAmount = value.LCDebitAmount;
                  value.FCEstimatedAmount = value.FCDebitAmount;
                  value.FCEstimatedAmount = value.LCDebitAmount;
                  self.$set(self.model.ActgvoucTransItem[key], 'Show', true);
                  self.$set(self.model.ActgvoucTransItem[key], 'ShowPagination', false);
                  if (value.LineID > self.RowItem) {
                    self.RowItem = value.LineIDTmp;
...
<style lang="css">
  ...
  {
    .w-form-control .form-group { margin-bottom: 0 !important;}
  }
  @media only screen
  and (min-device-width : 768px)
  and (max-device-width : 1024px)
  ...
  .tab-content .tab-pane{ padding-bottom: 0 !important;  padding-top: 10px !important;}
