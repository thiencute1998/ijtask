<template>
  <div class="main-entry">
    ...
    <div class="main-body">
      <ijcore-report-viewer-listing report-name="actgvouctrans" :filter="filter" report-data-api="accounting/api/actgvouctrans/get-report-data"></ijcore-report-viewer-listing>
    </div>
  </div>
</template>
...
<script>
  ...
  export default {
    name: 'listing-actgvouctrans-report',
    data () {
      return {
