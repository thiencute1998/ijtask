                ...
                <b-row class="mb-2">
                    <b-col class="col-md-18">
                        <div class="main-header-item main-header-name">
                            <span><i class="icon-eye icon mr-2"></i> Phê duyệt dự toán</span>
                        </div>
                    </b-col>
                          ...
                          <b-dropdown variant="primary" id="dropdown-actions" class="main-header-action mr-2" text="Thao tác">
                                <li class="dropdown b-dropdown dropright">
                                  ...
                                  <ul role="menu" tabindex="-1" class="dropdown-sub-menu dropdown-menu m-0">
                                    <li v-if="model.TransID == 134" role="presentation"><a role="menuitem" target="_self" href="/#/report/DULIEUDEMOVINHTHANH_PHEDUYET" class="dropdown-item" @click="handleExportPrint">Phê duyệt dự toán thu chi ngân sách nhà nước</a></li>
                                    <li v-if="model.TransID == 151" role="presentation"><a role="menuitem" target="_self" href="/#/report/UocThucHien_VPSoNN-PheDuyet" class="dropdown-item" @click="handleExportPrint">Phê duyệt dự toán ngân sách nhà nước</a></li>
                                    <li v-if="model.TransID == 143" role="presentation"><a role="menuitem" target="_self" href="/#/report/SBP_UTH_SOKHDT_05" class="dropdown-item" @click="handleExportPrint">Phê duyệt dự toán ngân sách nhà nước</a></li>
                                    <li v-if="model.TransID == 157" role="presentation"><a role="menuitem" target="_self" href="/#/report/SBP_UTH_Demo_modul_du_toan_03" class="dropdown-item" @click="handleExportPrint">Phê duyệt dự toán ngân sách nhà nước</a></li>
...
<!--                      </td>-->
                      ...
                      <!-- Xem xét dự toán -->
                      <td>
                        <span class="text-right">{{field.FCReviewAmount | convertNumberToText}}</span>
                      </td>
                      <td v-if="model.item_tt">
                        <span class="text-right">{{field.LCReviewAmount | convertNumberToText}}</span>
                      </td>
                      <!--Tài sản/Vật tư -->
...
<script>
    ...
    const ListRouter = 'statebudgetplanning-sbpapprovalplan';
    const EditRouter = 'statebudgetplanning-sbpapprovalplan-edit';
    const CreateRouter = 'statebudgetplanning-sbpapprovalplan-create';
    const ViewApi = 'state-budget-planning/api/sbpapprovalplan/view';
    const ListApi = 'state-budget-planning/api/sbpapprovalplan';
    const DeleteApi = 'state-budget-planning/api/sbpapprovalplan/delete';
    const CompanyType = {
        1: 'Đơn vị tổng hợp',
        2: 'Đơn vị trực thuộc',
        3: 'Đơn vị liên kết',
    ...
    export default {
        ...
        methods: {
          ...
          actbook(TransID) {
            ...
            const requestData = {
              method: 'post',
              url: 'state-budget-planning/api/sbpapprovalplan/actbook',
              data: {
