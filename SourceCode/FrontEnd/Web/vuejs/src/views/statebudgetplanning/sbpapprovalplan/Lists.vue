                  ...
                  <b-row class="mb-2">
                      <b-col md="6" class="col-24">
                          <div class="main-header-item main-header-name">
                              <span class="text-capitalize"><i class="fa fa-list mr-2"></i> Phê duyệt dự toán</span>
                          </div>
                      </b-col>
                  ...
                  <b-row class="mb-2">
                    <b-col class="col-lg-16 col-md-24 col-sm-24 col-24 mb-2 mb-lg-0 d-lg-flex justify-content-start align-items-center">
                      <div class="main-header-item main-header-actions">
                        ...
                        <IjcoreModalTransTemp @changed="changeTemplate" v-model="TransTemp" :options="options" :OptionsTransType="OptionsTransType" :TransTypeID="3" :title="'xem xét dự toán'" :api="'/state-budget-planning/api/sbpapprovalplan/get-list'"></IjcoreModalTransTemp>
<!--                        <b-button class="main-header-action mr-2" variant="primary" @click="$_lists_handleAddNewItem" size="md">-->
    ...
    export default {
      ...
      data() {
          return {
            ...
            options: [
              { item: '0', name: 'Chưa phê duyệt' },
              { item: '1', name: 'Đã phê duyệt' }
            ],
            OptionsTransType: [{value: '3', text: 'Xem xét dự toán'},{value: '4', text: 'Phê duyệt dự toán'},],
          }
      },
      components:{
        IjcoreUsersIcon,
      ...
      created() {
        ...
        this.settings.ListApi = 'state-budget-planning/api/sbpapprovalplan';
        this.settings.DeleteApi = 'state-budget-planning/api/sbpapprovalplan/delete';
        this.settings.CreateRouter = 'statebudgetplanning-sbpapprovalplan-create';
        this.settings.EditRouter = 'statebudgetplanning-sbpapprovalplan-edit';
        this.settings.ViewRouter = 'statebudgetplanning-sbpapprovalplan-view';
