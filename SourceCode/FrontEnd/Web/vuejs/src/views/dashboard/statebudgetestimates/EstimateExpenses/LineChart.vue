  ...
  export default {
    ...
    methods: {
      ...
      changeChart(){
        ...
        self.optionDataLineChar.datasets[2].data = [];
        _.forEach(self.optionDataLineChar.labels, function (val, key){
          ...
          self.optionDataLineChar.datasets[2].data.push(0);
        });
        _.forEach(self.value.knst, function (val, key){
          if(val.DTT){
            self.optionDataLineChar.datasets[0].data[val.STT -1] = val.DTT;
          }
        });
        _.forEach(self.value.knsc , function (val, key){
          if(val.DT){
            self.optionDataLineChar.datasets[1].data[val.STT -1] = val.DT;
          }
          if(val.UTT){
            self.optionDataLineChar.datasets[2].data[val.STT- 1] = val.UTT;
          }
        });
