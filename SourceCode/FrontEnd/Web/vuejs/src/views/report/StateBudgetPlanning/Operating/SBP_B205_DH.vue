          ...
          <b-collapse id="collapse-main-header-filter">
            <div class="main-header-filter pt-2">
              <div class="row mb-2">
                ...
                <div class="col-4 mb-2">
                  <b-form-select v-model="filter.Type" :options="TypeOption">
                  </b-form-select>
                </div>
                <div class="col-4 mb-2">
                  <ijcore-modal-listing
...
export default {
  ...
  data() {
    return {
      ...
      Api:"/report/api/StateBudgetPlanning/Operating/SBP_B205_DH"+ '?XDEBUG_SESSION_START=PHPSTORM',
      momentFormat: {
      ...
      TypeOption: [{vale: null, text: 'Chọn loại'},{value: 1, text: 'Khoản thu'},{value: 2, text: 'Khoản chi'}]
    }
  },
  components:{
    ReportViewer,
