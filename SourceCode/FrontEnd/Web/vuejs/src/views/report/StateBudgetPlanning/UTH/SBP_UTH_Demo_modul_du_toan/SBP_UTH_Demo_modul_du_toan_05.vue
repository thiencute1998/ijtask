                ...
                <b-col>
                  <div class="main-action d-lg-flex justify-content-end">
                    <b-button variant="primary" size="md">
                      <i class="fa fa-search" @click="reloadReport"></i> Tìm
                    </b-button>
                  </div>
                </b-col>
              </div>
        ...
        <b-card class="m-0 border-0" body-class="py-0 px-0">
          <div class="content-body" style="height: 100%">
            <div class="content-body-list" style="height: 100%">
              <report-viewer
                ref="report-viewer"
                report-folder-name="StateBudgetPlanning/UTH/SBP_UTH_Demo_modul_du_toan"
                report-name="SBP_UTH_Demo_modul_du_toan_05"
                :report-filter="filter"
                report-data-api="/report/api/StateBudgetPlanning/UTH/SBPUTHDemomoduldutoan/SBPUTHDemomoduldutoan05">
              </report-viewer>
            </div>
          </div>
        </b-card>
