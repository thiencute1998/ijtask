...
<!--                  &lt;!&ndash;                  <date-picker v-model="filter.Year" :formatter="momentFormat" format="YYYY" type="year" placeholder="Chọn năm báo cáo"></date-picker>&ndash;&gt;-->
...
<!--                </div>-->
                <div class="col-2 mb-2">
                  <b-form-select v-model="filter.PeriodYear" :options="[{value: '2016-2020', text: '2016-2020'}, {value: '2021-2025', text: '2021-2025'}, {value: '2026-2030', text: '2026-2030'}]">
                  </b-form-select>
                </div>
        ...
        <b-card class="m-0 border-0" body-class="py-0 px-0">
          <div class="content-body" style="height: 100%">
            <div class="content-body-list" style="height: 100%">
              <report-viewer
                ref="report-viewer"
                report-folder-name="SBP/312017NDCP"
                report-name="SBP_ND_31_2017_ND_CP_05"
  ...
  data() {
    return {
      filter: {
        ...
        DirectionID: null,
        DirectionNo: '',
        PeriodYear: '2016-2020',
      },
      Api:"/report/api/SBPND312017NDCP/MB05" +'?XDEBUG_SESSION_START=PHPSTORM',
      momentFormat: {
