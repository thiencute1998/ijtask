        ...
        <b-card class="m-0 border-0" body-class="py-0 px-0">
          <div class="content-body" style="height: 100%">
            <div class="content-body-list" style="height: 100%">
              <report-viewer
                ref="report-viewer"
                report-folder-name="StateBudgetPlanning/UTH/SBP_UTH_DMCS-DMDV"
                report-name="SBP_UTH_DMCS-DMDV_02"
                :report-filter="filter"
                report-data-api="/report/api/StateBudgetPlanning/UTH/SBPUTHDMCSDMDV/SBPUTHDMCSDMDV02">
              </report-viewer>
            </div>
          </div>
        </b-card>
