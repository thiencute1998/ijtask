            ...
            <b-col class="col-md-12">
              <div class="main-header-item main-header-icons">
                <b-button-group id="main-header-views" class="main-header-views">
                  <b-button id="tooltip-view-filter" v-b-toggle.collapse-main-header-filter title="Lọc"
                            class="main-header-view"><i class="fa fa-filter"></i></b-button>
                </b-button-group>
...
export default {
  ...
  data() {
    return {
      ...
      Api:"/report/api/StateBudgetPlanning/Operating/SBP_B262_DH?XDEBUG_SESSION_START=PHPSTORM",
      momentFormat: {
