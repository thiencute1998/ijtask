          ...
          <b-collapse id="collapse-main-header-filter">
            <div class="main-header-filter pt-2">
              <div class="row mb-2">
                ...
                <div class="col-md-2">
                  <b-form-select v-model="filter.Month" :options="[
                    { value: null, text: '-- Chọn tháng báo cáo --'},
                    { value: '1',text: '1'},
                    { value: '2', text: '2'},
                    { value: '3', text: '3'},
                    { value: '4', text: '4'},
          ...
          <div class="content-body" style="height: 100%">
            <div class="content-body-list" style="height: 100%">
              <report-viewer
                ...
                report-name="SBP_342_2016_TT_BTC_56"
...
export default {
  ...
  data() {
    return {
      ...
      Api:"/report/api/SBP3422016TTBTC/MB56" +'?XDEBUG_SESSION_START=PHPSTORM',
      momentFormat: {
