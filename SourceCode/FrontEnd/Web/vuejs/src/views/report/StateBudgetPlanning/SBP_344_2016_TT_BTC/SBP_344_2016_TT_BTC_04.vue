          ...
          <b-collapse id="collapse-main-header-filter">
            <div class="main-header-filter pt-2">
              <div class="row mb-2">
                ...
                <div class="col-2 mb-2">
                  <b-form-select v-model="filter.PeriodYear" :options="[{value: null, text: '-- Kỳ 5 năm --'}, {value: '2016-2020', text: '2016-2020'}, {value: '2020-2024', text: '2020-2024'}]">
                  </b-form-select>
                </div>
        ...
        <b-card class="m-0 border-0" body-class="py-0 px-0">
          <div class="content-body" style="height: 100%">
            <div class="content-body-list" style="height: 100%">
              <report-viewer
                ref="report-viewer"
                report-folder-name="SBP/3442016TTBTC"
                report-name="SBP_344_2016_TT_BTC_04"
...
export default {
  ...
  data() {
    return {
      ...
      Api:"/report/api/SBP3442016TTBTC/MB04" + '?XDEBUG_SESSION_START=PHPSTORM',
      momentFormat: {
