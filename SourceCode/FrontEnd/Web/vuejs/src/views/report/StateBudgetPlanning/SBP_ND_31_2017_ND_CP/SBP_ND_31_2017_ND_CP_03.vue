          ...
          <b-collapse id="collapse-main-header-filter">
            <div class="main-header-filter pt-2">
              <div class="row mb-2">
                ...
                <div class="col-2 mb-2">
                  <IjcoreDatePicker v-model="filter.PostDate"></IjcoreDatePicker>
                </div>
                <div class="col-2 mb-2">
                  <label>Ngày chứng từ </label>
                </div>
                <div class="col-2 mb-2">
                  <IjcoreDatePicker v-model="filter.TransDate"></IjcoreDatePicker>
                </div>
          ...
          <div class="content-body" style="height: 100%">
            <div class="content-body-list" style="height: 100%">
              <report-viewer
                ...
                report-name="SBP_ND_31_2017_ND_CP_03"
...
export default {
  ...
  data() {
    return {
      ...
      Api:"/report/api/SBPND312017NDCP/MB03" +'?XDEBUG_SESSION_START=PHPSTORM',
      momentFormat: {
