        ...
        <b-card class="m-0 border-0" body-class="py-0 px-0">
          <div class="content-body" style="height: 100%">
            <div class="content-body-list" style="height: 100%">
              <report-viewer
                ref="report-viewer"
                report-folder-name="SBP_TT-342-2016-TT-BTC"
                report-name="SBP_TT-342-2016-TT-BTC_MB-06"
...
export default {
  ...
  data() {
    return {
      ...
      Api:"/report/api/SBP3422016TTBTC/MB06?XDEBUG_SESSION_START=PHPSTORM",
      momentFormat: {
  ...
  methods: {
    ...
    getLevelCompany(){
      ...
      let requestData = {
        method: 'post',
        url: "report/api/common/get-level-company?XDEBUG_SESSION_START=PHPSTORM",
        data: {
