        ...
        <b-card class="m-0 border-0" body-class="py-0 px-0">
          <div class="content-body" style="height: 100%">
            <div class="content-body-list" style="height: 100%">
              <report-viewer
                ref="report-viewer"
                report-folder-name="StateBudgetPlanning/SBPESTIMATE"
                report-name="SBPESTIMATE_F01b-DH-DT"
                :report-filter="filter"
                report-data-api= "/report/api/StateBudgetPlanning/SBPESTIMATE/SBPESTIMATE_F01b-DH-DT">
              </report-viewer>
            </div>
          </div>
        </b-card>
