        ...
        <b-card class="m-0 border-0" body-class="py-0 px-0">
          <div class="content-body" style="height: 100%">
            <div class="content-body-list" style="height: 100%">
              <report-viewer
                ref="report-viewer"
                report-folder-name="PHEDUYET"
                report-name="Ty_le_phan_tram_cac_khoan_thu_phan_chia_giua_ngan_sach_cac_cap_chinh_quyen_dia_phuong_nam_2021"
                :report-filter="filter"
                report-data-api="/report/api/PHEDUYET/QDUB_BS54">
              </report-viewer>
            </div>
          </div>
        </b-card>
