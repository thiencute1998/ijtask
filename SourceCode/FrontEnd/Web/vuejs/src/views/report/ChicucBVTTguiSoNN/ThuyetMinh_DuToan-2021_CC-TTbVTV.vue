        ...
        <b-card class="m-0 border-0" body-class="py-0 px-0">
          <div class="content-body" style="height: 100%">
            <div class="content-body-list" style="height: 100%">
              <report-viewer
                ref="report-viewer"
                report-folder-name="ChicucBVTTguiSoNN"
                report-name="ThuyetMinh_DuToan-2021_CC-TTbVTV"
                :report-filter="filter"
                report-data-api="/report/api/ChicucBVTTguiSoNN/ThuyetMinhDuToan2021CCTTbVTV">
              </report-viewer>
            </div>
          </div>
        </b-card>
