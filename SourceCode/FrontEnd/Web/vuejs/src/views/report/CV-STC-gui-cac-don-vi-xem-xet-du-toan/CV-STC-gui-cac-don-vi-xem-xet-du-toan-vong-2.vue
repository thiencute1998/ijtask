        ...
        <b-card class="m-0 border-0" body-class="py-0 px-0">
          <div class="content-body" style="height: 100%">
            <div class="content-body-list" style="height: 100%">
              <report-viewer
                ref="report-viewer"
                report-folder-name="CV-STC-gui-cac-don-vi-xem-xet-du-toan"
                report-name="CV-STC-gui-cac-don-vi-xem-xet-du-toan-vong-2"
                :report-filter="filter"
                report-data-api="/report/api/CVSTCguicacdonvixemxetdutoan/CVSTCguicacdonvixemxetdutoanvong2">
              </report-viewer>
            </div>
          </div>
        </b-card>
