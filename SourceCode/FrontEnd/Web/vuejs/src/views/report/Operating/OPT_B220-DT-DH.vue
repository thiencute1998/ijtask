            ...
            <div class="main-header-filter pt-2">
              <div class="row mb-2">
                ...
                <div class="col-5 mb-2">
                  <ijcore-modal-listing
                    v-model="filter" title="Loại khoản thu"  api="/listing/api/common/list"
                    FieldName="RevenueName" FieldNo="RevenueNo" FieldID="RevenueID" table="revenue"
                    :FieldNoConfig="{show: true, tdStyle: {width: '20%'}}"
                    columnID="RevenueID"
                    columnNo="RevenueNo"
                ...
                <div class="col-5 mb-2">
                  <ijcore-modal-listing
                    v-model="filter" title="Loại khoản chi"  api="/listing/api/common/list"
                    FieldName="ExpenseName" FieldNo="ExpenseNo" FieldID="ExpenseID" table="expense"
        ...
        <b-card class="m-0 border-0" body-class="py-0 px-0">
          <div class="content-body" style="height: 100%">
            <div class="content-body-list" style="height: 100%">
              <report-viewer
                ref="report-viewer"
                report-folder-name="Operating"
                report-name="OPT_B220-DT-DH"
...
export default {
  ...
  data() {
    return {
      ...
      Api:"/report/api/Operating/OPT_B220-DT-DH?XDEBUG_SESSION_START=PHPSTORM",
      momentFormat: {
