        ...
        <b-card class="m-0 border-0" body-class="py-0 px-0">
          <div class="content-body" style="height: 100%">
            <div class="content-body-list" style="height: 100%">
              <report-viewer
                ref="report-viewer"
                report-folder-name="SBS_TT-99-2018-TT-BTC"
                report-name="SBS_TT-99-2018-TT-BTC_B04-BCTC-TH"
                :report-filter="filter"
                report-data-api="/report/api/SBSTT992018TTBTC/SBSTT992018TTBTCB04BCTCTH">
              </report-viewer>
            </div>
          </div>
        </b-card>
