        ...
        <b-card class="m-0 border-0" body-class="py-0 px-0">
          <div class="content-body" style="height: 100%">
            <div class="content-body-list" style="height: 100%">
              <report-viewer-1
                ref="report-viewer"
                report-folder-name="Ngay12-5"
                report-name="PFMIS_DUTOAN_TOTRINH_STC_UBNDtinh"
...
import ReportViewer1 from "../ReportViewer1";
  ...
  data() {
    return {
      filter: {
        ...
        DirectionID: null,
        DirectionNo: '',
        queryFilter: (this.$route.query) ? (this.$route.query) : {},
      },
      Api:"/report/api/Ngay125/PFMISDUTOANTOTRINHSTCUBNDtinh" + '?XDEBUG_SESSION_START=PHPSTORM',
      momentFormat: {
