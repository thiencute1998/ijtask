x<template>
  <div class="ijcore ijcore-modal ijcore-modal-search-input component-modal-search-input" @mouseleave="onMouseLeave" @mouseenter="onMouseenter">
    <b-input-group>
      <b-form-input v-if="FieldType === 1" :placeholder="'Nhập ' + this.title" :title="value[FieldNameData]" :readonly="true" v-model="value[FieldNameData]"
                    class="readonly form-control" @click="onToggleModal()"></b-form-input>
      <b-form-input v-else :placeholder="'Nhập ' + this.title" :title="value[FieldNameData]" :readonly="true" v-model="value[FieldNameData]"
                    class="readonly form-control" @click="onToggleModal()"></b-form-input>
...
<script>
  ...
  export default {
    name: 'IjcoreModalMultipleCategory',
    mixins: [mixinLists],
    components: {},
    computed: {
      rows() {
