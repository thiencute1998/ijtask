<template>
    <div class="d-lg-flex" id="myFlowchart" :style="{'height': heightFlowchart}">
      <div id="myPaletteDiv" v-if="isEditableFlowchart" :style="{'width': widthPalette, 'height': '100%'}"></div>
      <div id="myDiagramDiv" :style="{'width': widthDiagram, 'height': '100%'}"></div>
    </div>
    ...
    methods: {
      init() {
          ...
          $(go.Diagram, "myDiagramDiv",  // must name or refer to the DIV HTML element
            {
              ...
              allowTextEdit: this.allowTextEdit,
              allowClipboard: this.allowClipboard,
              isEnabled: this.isEnabled,
              allowHorizontalScroll: this.allowHorizontalScroll,
              allowVerticalScroll: this.allowVerticalScroll,
              allowMove: this.allowMove,
              allowRelink: this.allowRelink,
              allowReshape: this.allowReshape,
        ...
        if (this.isEditableFlowchart) {
          ...
          //       model: new go.GraphLinksModel(this.modelPalette)
          //     });
      ...
      loadPalette(){
        myPalette.model.nodeDataArray = this.modelPalette;
      },
      load() {
        if (this.value) myDiagram.model = go.Model.fromJson(this.value);
      },
      saveDiagram() {
