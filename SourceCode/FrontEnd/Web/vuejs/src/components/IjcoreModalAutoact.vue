<template>
  <div class="ijcore-modal-parent">
    <b-input-group>
      <b-form-input :placeholder="'Nhập ' + this.title" :title="value[FieldNameData]" :readonly="true" v-model="value[FieldNameData]"
  ...
  export default {
    ...
    methods: {
      ...
      updateForParent: function (ParentID, ParentName, ParentNo, Key) {
        ...
        this.$emit('selected', this.listtable[Key]);
