        ...
        <template v-for="(item, index) in navItems">
          ...
          <template v-else>
            <template v-if="item.children">
              ...
              <SidebarNavDropdown :key="index" :name="item.name" :url="item.url" :icon="item.icon" :module-nav-top="item.module">
                <template v-for="(childL1, index1) in item.children">
                  <template v-if="childL1.children">
                    <!-- Second level dropdown -->
                    <SidebarNavDropdown :key="index1" :name="childL1.name" :url="childL1.url" :icon="childL1.icon" :module-nav-top="item.module">
                  ...
                  <template v-else>
                    <SidebarNavItem :key="index1" :classes="item.class" :module-nav-top="item.module">
            ...
            <template v-else>
              <SidebarNavItem :key="index" :classes="item.class" :module-nav-top="item.module">
...
export default {
  ...
  mounted() {
    ...
    this.$nextTick(() => {
      if (!ps) {
        ps = new PerfectScrollbar('.sidebar-nav .scroll-area', {
          wheelSpeed: 2,
