...
class SBPND312017NDCPMB06Controller extends Controller {
    use Common;
    public function SBPND312017NDCP_MB06(Request $request){
        ...
        $this->insertDataMB06($userCompany, $typeUserCompany, $whereDebt, $whereCondition, $provinceNo, $districtNo, $fromDate, $toDate);
        $this->setLevel();
        $this->sortSector();
    ...
    public function insertDataMB06($userCompany, $typeUserCompany, $whereDebt, $whereCondition, $provinceNo, $districtNo, $fromDate, $toDate){
        if($typeUserCompany){
            if($typeUserCompany->CateValue == '1'){
                ...
                if($userCompany->SumCompanyType == '2'){
                    ...
                    if($userCompany->ManagementLevel == '2'){
                        ...
                        $this->insertDistrictR1C7_8($whereDebt, $provinceNo);
                        $this->insertDistrictR1C9_10($whereDebt, $provinceNo);
                        $this->insertDistrictR1C12_13_16_17($whereCondition, $provinceNo);
                        $this->insertDistrictR1C14_18($whereCondition, $provinceNo);
                        $this->insertDistrictR2C7_8($whereDebt, $provinceNo, $fromDate, $toDate);
                        $this->insertDistrictR2C9_10($whereDebt, $provinceNo, $fromDate, $toDate);
                        $this->insertDistrictR2C12_13_16_17($whereCondition, $provinceNo, $fromDate, $toDate);
                        $this->insertDistrictR2C14_18($whereCondition, $provinceNo, $fromDate, $toDate);
                        ...
                        $this->insertCommuneR1C7_8($whereDebt, $districtNo);
                        $this->insertCommuneR1C9_10($whereDebt, $districtNo);
                        $this->insertCommuneR1C12_13_16_17($whereCondition, $districtNo);
                        $this->insertCommuneR1C14_18($whereCondition, $districtNo);
                        $this->insertCommuneR2C7_8($whereDebt, $districtNo, $fromDate, $toDate);
                        $this->insertCommuneR2C9_10($whereDebt, $districtNo, $fromDate, $toDate);
                        $this->insertCommuneR2C12_13_16_17($whereCondition, $districtNo, $fromDate, $toDate);
                        $this->insertCommuneR2C14_18($whereCondition, $districtNo, $fromDate, $toDate);
            ...
            $this->insertR1C7_8($whereDebt);
            $this->insertR1C9_10($whereDebt);
            $this->insertR1C12_13_16_17($whereCondition);
            $this->insertR1C14_18($whereCondition);
            $this->insertR2C7_8($whereDebt, $fromDate, $toDate);
            $this->insertR2C9_10($whereDebt, $fromDate, $toDate);
            $this->insertR2C12_13_16_17($whereCondition, $fromDate, $toDate);
            $this->insertR2C14_18($whereCondition, $fromDate, $toDate);
            $this->getDetailParentCompany($userCompany->Level);
            $this->getParentDataTreeCommonMB06([['sector_cate_value', '200030301'], 'company', 'T1Temporary', 'project']);
            $this->getParentDataTreeCommonMB06([['sector_cate_value', '200030301'], 'company', 'T1Temporary', 'T2Temporary', 'project']);
        }
    }
    ...
    public function insertR1C7_8($whereDebt){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ParentID1, ItemName, SectorCateValue, Company, T1Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Path, ParentCompanyNo, Norder, Detail, I3, I4)
        ...
        SUM(CASE WHEN BudgetLevel IN (2, 3, 4) THEN I ELSE 0 END) as I4 FROM(
    ...
    public function insertR1C9_10($whereDebt){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ParentID1, ItemName, SectorCateValue, Company, T1Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Path, ParentCompanyNo, Norder, Detail, I5, I6)
        SELECT * FROM
        (SELECT CONCAT(ParentID, '#', ProjectNo) as ItemID, ParentID, ParentID1, ItemName, SectorCateValue, CompanyNo, ProjectCateValue as T1Temporary, ProjectNo,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Path, ParentNo, 1 as Norder, 1 as Detail,
        SUM(I) as A1,
        ...
        IF(C.ParentNo IS NOT NULL, CONCAT('A#', SC.CateValue, '#', C.ParentNo, '#', PC.CateValue, '#', A.ProjectNo), '') as ParentID1,
        A.ProjectName as ItemName, SC.CateValue as SectorCateValue, C.CompanyNo, PC.CateValue as ProjectCateValue,
        A.ProjectNo, " . $this->selectCommon() . ", SUM(FCDebitAmount - FCCreditAmount) as I, SUM(LCDebitAmount - LCCreditAmount) as II,
        C.Path, C.ParentNo
        FROM act_gl_books as A
        INNER JOIN sector_cate as SC on A.SectorID = SC.SectorID
        INNER JOIN project_cate as PC on A.ProjectID = PC.ProjectID
        ...
        AND SC.CateNo = '200030301'
        AND PC.CateNo = '009' AND PC.CateValue = '1'
        AND CC.CateNo IN ('20012201', '20012202')
        $whereDebt
        GROUP BY  SC.CateValue, C.CompanyNo, A.ProjectNo
        ) as CH GROUP BY SectorCateValue, CompanyNo, ProjectNo) as DT ON DUPLICATE KEY UPDATE I5 = A1, I6 = A2
        ";

        DB::statement($sql);
    }

    public function insertR1C12_13_16_17($whereCondition){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ParentID1, ItemName, SectorCateValue, Company, T1Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Path, ParentCompanyNo, Norder, Detail, I8, I9, I12, I13)
        SELECT * FROM
        ...
        ) as CH GROUP BY SectorCateValue, CompanyNo, ProjectNo) as DT ON DUPLICATE KEY UPDATE I8 = A1, I9 = A2, I12 = A3, I13 = A4
        ";

        DB::statement($sql);
    }

    public function insertR1C14_18($whereCondition){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ParentID1, ItemName, SectorCateValue, Company, T1Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Path, ParentCompanyNo, Norder, Detail, I10, I14)
        SELECT * FROM
        (SELECT CONCAT(ParentID, '#', ProjectNo) as ItemID, ParentID, ParentID1, ItemName, SectorCateValue, CompanyNo, ProjectCateValue as T1Temporary,
        ProjectNo, BuildAddress, CapableDesign, PerformDate, Investdoc, Path, ParentNo, 1 as Norder, 1 as Detail,
        SUM(CASE WHEN AccountNo IN ('0441', '0442') THEN I ELSE 0 END) as A1,
        SUM(CASE WHEN AccountNo IN ('0441', '0442') THEN I ELSE 0 END) as A2
        FROM(
        SELECT CONCAT('A#', SC.CateValue, '#', C.CompanyNo, '#', PC.CateValue) as ParentID,
        CONCAT('A#', SC.CateValue, '#', C.ParentNo, '#', PC.CateValue, '#', A.ProjectNo) as ParentID1,
        A.ProjectName as ItemName, SC.CateValue as SectorCateValue, C.CompanyNo, PC.CateValue as ProjectCateValue,
        A.ProjectNo, " . $this->selectCommon() . ",
        A.AccountNo, SUM(LCDebitAmount) as I, C.Path, C.ParentNo
        FROM act_gl_books as A
        INNER JOIN sector_cate as SC on A.SectorID = SC.SectorID
        INNER JOIN project_cate as PC on A.ProjectID = PC.ProjectID
        INNER JOIN project as P on A.ProjectID = P.ProjectID
        ...
        AND CC.CateNo IN ('20012201', '20012202')
        $whereCondition
        GROUP BY A.AccountNo, SC.CateValue, C.CompanyNo, A.ProjectNo
        ) as CH GROUP BY SectorCateValue, CompanyNo, ProjectNo) as DT ON DUPLICATE KEY UPDATE I10 = A1, I14 = A2
        ";
    ...
    public function insertR2C7_8($whereDebt, $fromDate, $toDate){
    ...
    public function insertR2C9_10($whereDebt, $fromDate, $toDate){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ParentID1, ItemName, SectorCateValue, Company, T1Temporary, T2Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Path, ParentCompanyNo, Norder, Detail, I5, I6)
        SELECT * FROM
        (SELECT CONCAT(ParentID, '#', ProjectNo) as ItemID, ParentID, ParentID1, ItemName, SectorCateValue, CompanyNo, ProjectCateValue as T1Temporary, T2Temporary,
        ...
        A.ProjectName as ItemName, SC.CateValue as SectorCateValue, C.CompanyNo, PC.CateValue as ProjectCateValue, " . $this->setPerformDateNo($fromDate, $toDate) . " as T2Temporary,
        A.ProjectNo, " . $this->selectCommon() . ",
        SUM(FCDebitAmount - FCCreditAmount) as I, SUM(LCDebitAmount - LCCreditAmount) as II,
        C.Path, C.ParentNo
        FROM act_gl_books as A
        INNER JOIN sector_cate as SC on A.SectorID = SC.SectorID
        INNER JOIN project_cate as PC on A.ProjectID = PC.ProjectID
        ...
        as DT ON DUPLICATE KEY UPDATE I5 = A1, I6 = A2
        ";

        DB::statement($sql);
    }

    public function insertR2C12_13_16_17($whereCondition, $fromDate, $toDate){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ParentID1, ItemName, SectorCateValue, Company, T1Temporary, T2Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Path, ParentCompanyNo, Norder, Detail, I8, I9, I12, I13)
        SELECT * FROM
        (SELECT CONCAT(ParentID, '#', ProjectNo) as ItemID, ParentID, ParentID1, ItemName, SectorCateValue, CompanyNo, ProjectCateValue as T1Temporary, T2Temporary,
    ...
    public function insertR2C14_18($whereCondition, $fromDate, $toDate){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ParentID1, ItemName, SectorCateValue, Company, T1Temporary, T2Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Path, ParentCompanyNo, Norder, Detail, I10, I14)
        SELECT * FROM
        (SELECT CONCAT(ParentID, '#', ProjectNo) as ItemID, ParentID, ParentID1, ItemName, SectorCateValue, CompanyNo, ProjectCateValue as T1Temporary, T2Temporary,
    ...
    public function insertDistrictR1C7_8($whereDebt, $provinceNo){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ItemName, SectorCateValue, District, T1Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Norder, Detail, I3, I4)
    ...
    public function insertDistrictR1C9_10($whereDebt, $provinceNo){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ItemName, SectorCateValue, District, T1Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Norder, Detail, I5, I6)
        SELECT * FROM
        (SELECT CONCAT(ParentID, '#', ProjectNo) as ItemID, ParentID, ItemName, SectorCateValue, DistrictNo, ProjectCateValue as T1Temporary, ProjectNo,
        BuildAddress, CapableDesign, PerformDate, Investdoc, 2 as Norder, 1 as Detail,
        SUM(I) as A1,
        ...
        AND CC.CateNo IN ('20012201', '20012202')
        $whereDebt
        GROUP BY SC.CateValue, C.DistrictNo, A.ProjectNo
        ) as CH GROUP BY SectorCateValue, DistrictNo, ProjectNo)
        as DT ON DUPLICATE KEY UPDATE I5 = A1, I6 = A2
        ";
    ...
    public function insertDistrictR1C12_13_16_17($whereCondition, $provinceNo){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ItemName, SectorCateValue, District, T1Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Norder, Detail, I8, I9, I12, I13)
        SELECT * FROM
        ...
        as DT ON DUPLICATE KEY UPDATE I8 = A1, I9 = A2, I12 = A3, I13 = A4
        ";

        DB::statement($sql);
    }

    public function insertDistrictR1C14_18($whereCondition, $provinceNo){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ItemName, SectorCateValue, District, T1Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Norder, Detail, I10, I14)
        SELECT * FROM
        (SELECT CONCAT(ParentID, '#', ProjectNo) as ItemID, ParentID, ItemName, SectorCateValue, DistrictNo, ProjectCateValue as T1Temporary,
        ProjectNo, BuildAddress, CapableDesign, PerformDate, Investdoc, 2 as Norder, 1 as Detail,
        SUM(CASE WHEN AccountNo IN ('0441', '0442') THEN I ELSE 0 END) as A1,
        ...
        A.ProjectName as ItemName, SC.CateValue as SectorCateValue, C.DistrictNo, C.CompanyNo, PC.CateValue as ProjectCateValue,
        A.ProjectNo, " . $this->selectCommon() . ",
        A.AccountNo, SUM(LCDebitAmount) as I
        FROM act_gl_books as A
        INNER JOIN sector_cate as SC on A.SectorID = SC.SectorID
        INNER JOIN project_cate as PC on A.ProjectID = PC.ProjectID
        INNER JOIN project as P on A.ProjectID = P.ProjectID
        ...
        AND CC.CateNo IN ('20012201', '20012202')
        $whereCondition
        GROUP BY A.AccountNo, SC.CateValue, C.DistrictNo, A.ProjectNo
        ) as CH GROUP BY SectorCateValue, DistrictNo, ProjectNo)
        as DT ON DUPLICATE KEY UPDATE I10 = A1, I14 = A2
        ";
    ...
    public function insertDistrictR2C7_8($whereDebt, $provinceNo, $fromDate, $toDate){
    ...
    public function insertDistrictR2C9_10($whereDebt, $provinceNo, $fromDate, $toDate){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ItemName, SectorCateValue, District, T1Temporary, T2Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Norder, Detail, I5, I6)
        SELECT * FROM
        (SELECT CONCAT(ParentID, '#', ProjectNo) as ItemID, ParentID, ItemName, SectorCateValue, DistrictNo, ProjectCateValue as T1Temporary, T2Temporary,
    ...
    public function insertDistrictR2C12_13_16_17($whereCondition, $provinceNo, $fromDate, $toDate){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ItemName, SectorCateValue, District, T1Temporary, T2Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Norder, Detail, I8, I9, I12, I13)
        SELECT * FROM
        (SELECT CONCAT(ParentID, '#', ProjectNo) as ItemID, ParentID, ItemName, SectorCateValue, DistrictNo, ProjectCateValue as T1Temporary, T2Temporary,
        ...
        $whereCondition
        GROUP BY A.AccountNo, A.BudgetLevel, SC.CateValue, C.DistrictNo, A.ProjectNo
        ) as CH GROUP BY SectorCateValue, DistrictNo, ProjectNo) as DT ON DUPLICATE KEY UPDATE I8 = A1, I9 = A2, I12 = A3, I13 = A4
        ";

        DB::statement($sql);
    }

    public function insertDistrictR2C14_18($whereCondition, $provinceNo, $fromDate, $toDate){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ItemName, SectorCateValue, District, T1Temporary, T2Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Norder, Detail, I10, I14)
        SELECT * FROM
        (SELECT CONCAT(ParentID, '#', ProjectNo) as ItemID, ParentID, ItemName, SectorCateValue, DistrictNo, ProjectCateValue as T1Temporary, T2Temporary,
        ProjectNo, BuildAddress, CapableDesign, PerformDate, Investdoc, 2 as Norder, 1 as Detail,
        SUM(CASE WHEN AccountNo IN ('0441', '0442') THEN I ELSE 0 END) as A1,
        SUM(CASE WHEN AccountNo IN ('0441', '0442') THEN I ELSE 0 END) as A2 FROM(
        SELECT CONCAT('A#', SC.CateValue, '#', C.DistrictNo, '#', PC.CateValue, '#'," . $this->setPerformDateNo($fromDate, $toDate) . ") as ParentID,
        A.ProjectName as ItemName, SC.CateValue as SectorCateValue, C.DistrictNo, PC.CateValue as ProjectCateValue, " . $this->setPerformDateNo($fromDate, $toDate) . " as T2Temporary,
        A.ProjectNo, " . $this->selectCommon() . ",
        A.AccountNo, SUM(LCDebitAmount) as I
        ...
        $whereCondition
        GROUP BY A.AccountNo, SC.CateValue, C.DistrictNo, A.ProjectNo
        ) as CH GROUP BY SectorCateValue, DistrictNo, ProjectNo) as DT ON DUPLICATE KEY UPDATE I10 = A1, I14 = A2
        ";

        DB::statement($sql);
    }

    public function insertCommuneR1C7_8($whereDebt, $districtNo){
    ...
    public function insertCommuneR1C9_10($whereDebt, $districtNo){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ItemName, SectorCateValue, Commune, T1Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Norder, Detail, I5, I6)
        SELECT * FROM
        (SELECT CONCAT(ParentID, '#', ProjectNo) as ItemID, ParentID, ItemName, SectorCateValue, CommuneNo, ProjectCateValue as T1Temporary, ProjectNo,
        ...
        AND CC.CateNo IN ('20012201', '20012202')
        $whereDebt
        GROUP BY SC.CateValue, C.CommuneNo, A.ProjectNo
        ) as CH GROUP BY SectorCateValue, CommuneNo, ProjectNo)
        as DT ON DUPLICATE KEY UPDATE I5 = A1, I6 = A2
        ";
    ...
    public function insertCommuneR1C12_13_16_17($whereCondition, $districtNo){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ItemName, SectorCateValue, Commune, T1Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Norder, Detail, I8, I9, I12, I13)
        SELECT * FROM
        ...
        ) as CH GROUP BY SectorCateValue, CommuneNo, ProjectNo) as DT ON DUPLICATE KEY UPDATE I8 = A1, I9 = A2, I12 = A3, I13 = A4
        ";

        DB::statement($sql);
    }

    public function insertCommuneR1C14_18($whereCondition, $districtNo){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ItemName, SectorCateValue, Commune, T1Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Norder, Detail, I10, I14)
        SELECT * FROM
        (SELECT CONCAT(ParentID, '#', ProjectNo) as ItemID, ParentID, ItemName, SectorCateValue, CommuneNo, ProjectCateValue as T1Temporary,
        ...
        AND CC.CateNo IN ('20012201', '20012202')
        $whereCondition
        GROUP BY A.AccountNo, SC.CateValue, C.CommuneNo, A.ProjectNo
        ) as CH GROUP BY SectorCateValue, CommuneNo, ProjectNo)
        as DT ON DUPLICATE KEY UPDATE I10 = A1, I14 = A2
        ";
    ...
    public function insertCommuneR2C7_8($whereDebt, $districtNo, $fromDate, $toDate){
    ...
    public function insertCommuneR2C9_10($whereDebt, $districtNo, $fromDate, $toDate){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ItemName, SectorCateValue, Commune, T1Temporary, T2Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Norder, Detail, I5, I6)
        SELECT * FROM
        (SELECT CONCAT(ParentID, '#', ProjectNo) as ItemID, ParentID, ItemName, SectorCateValue, CommuneNo, ProjectCateValue as T1Temporary, T2Temporary,
    ...
    public function insertCommuneR2C12_13_16_17($whereCondition, $districtNo, $fromDate, $toDate){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ItemName, SectorCateValue, Commune, T1Temporary, T2Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Norder, Detail, I8, I9, I12, I13)
        SELECT * FROM
        (SELECT CONCAT(ParentID, '#', ProjectNo) as ItemID, ParentID, ItemName, SectorCateValue, CommuneNo, ProjectCateValue as T1Temporary, T2Temporary,
    ...
    public function insertCommuneR2C14_18($whereCondition, $districtNo, $fromDate, $toDate){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ItemName, SectorCateValue, Commune, T1Temporary, T2Temporary, Project,
        BuildAddress, CapableDesign, PerformDate, Investdoc, Norder, Detail, I10, I14)
        SELECT * FROM
        (SELECT CONCAT(ParentID, '#', ProjectNo) as ItemID, ParentID, ItemName, SectorCateValue, CommuneNo, ProjectCateValue as T1Temporary, T2Temporary,
    ...
    public function getParentDataTreeCommonMB06($table, $id = null){
        $uniqueItems = [];
        $arrID = [];
