...
class OperatingB225DHController extends Controller {
    use Common;
    ...
    public function SBPB225DH(Request $request)
    {
...
//        $this->updateIndexReport('B');
        ...
        $this->sumUpSBPB225DH(0,6, $maxLevel);
        ...
        foreach ($data as $key => $value) {
            ...
            if($data[$key]->I2 !=0){
                $data[$key]->I5 = round((((int)($data[$key]->I4) - (int)($data[$key]->I2))/ (int)($data[$key]->I2))*100, 2);
            }
        }
    ...
    // SUM
    public function sumUpSBPB225DH($start, $end, $maxLevel){
        if ($maxLevel) {
