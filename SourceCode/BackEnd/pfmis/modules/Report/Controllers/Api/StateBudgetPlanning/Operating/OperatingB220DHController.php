...
class OperatingB220DHController extends Controller {
    use Common;
    ...
    public function insertRevenue($whereCondition, $year){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ItemName, Revenue, Path,  Detail, I1, I2, I3, I4)
    ...
    public function sumUpSBPB220DH($start, $end, $maxLevel){
        ...
        if ($end) {
            for ($i = $end; $i > $start; $i--) {
                $j = $i - 1;
                $sql = "SELECT ItemID, ParentID, SUM(M.I1) AS I1, SUM(M.I2) AS I2, SUM(M.I3) AS I3, SUM(M.I4) AS I4, SUM(M.I5) AS I5 FROM table_tmp M
