...
class SBP3432016TTBTCMB106Controller extends Controller {
    public function SBP3432016TTBTC_MB106(Request $request){
        ...
        if (isset($data[0])) {
            $data[0]->HeaderName1 = 'Giá trị thực hiện đến 31/12/' . $year;
            $data[0]->HeaderName2 = 'Giá trị đã thanh toán đến 31/12/' . $year;
        ...
        $response = [
            'master' => [
                ...
                "TransNo" => "00001",
                "ReportName" => "DỰ TOÁN CHI ĐẦU TƯ PHÁT TRIỂN(1) NĂM " . $year,
                "DateTime" => $dateTime,
                "CompanyName" => 'UBND XÃ..',
                "Note" => $note
            ],
