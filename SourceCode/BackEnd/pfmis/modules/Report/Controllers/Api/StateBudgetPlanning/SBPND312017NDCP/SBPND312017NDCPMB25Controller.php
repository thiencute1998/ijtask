...
class SBPND312017NDCPMB25Controller extends Controller {
    use Common;
    public function SBPND312017NDCP_MB25(Request $request){
        ...
        $whereCondition = " AND YEAR(A.PeriodFromDate) = $yearNext $whereCommonCondition AND LEFT(EC.CateNo,5)='20152'";
