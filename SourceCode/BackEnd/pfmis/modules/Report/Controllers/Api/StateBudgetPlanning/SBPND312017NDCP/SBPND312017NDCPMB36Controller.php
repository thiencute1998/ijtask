...
class SBPND312017NDCPMB36Controller extends Controller {
    use Common;
    public function SBPND312017NDCP_MB36(Request $request){
        ...
        $whereCondition = " AND YEAR(A.PeriodFromDate) = $yearNext AND A.AccountNo = '0411' AND LEFT(EC.CateNo, 5) = '20152'
