...
class SBP612021TTBTCMB05Controller extends Controller {
    public function SBP612021TTBTC_MB05(Request $request){
        ...
        if (isset($data[0])) {
            $data[0]->HeaderName1 = 'Lũy kế thực hiện hết '.$year;
            $data[0]->HeaderName2 = 'Trong đó: năm '.$year;
            $data[0]->HeaderName3 = 'Kế hoạch '.$yearNext.' và giai đoạn '. $yearNext.'-'.$year24;
            $data[0]->HeaderName4 = 'Kế hoạch ' .$yearNext;
            $data[0]->HeaderName5 = 'Giai đoạn '. $yearNext.'-'.$year24;
        }
        ...
        $response = [
            'master' => [
                ...
                "TransNo" => "00001",
                "ReportName" => "TỔNG HỢP DỰ TOÁN CHI NGÂN SÁCH NHÀ NƯỚC TỪ NGUỒN THU XỬ LÝ NHÀ, ĐẤT NĂM " .$year." VÀ GIAI ĐOẠN ". $yearNext.'-'.$year24,
                "DateTime" => $dateTime,
