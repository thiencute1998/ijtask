...
class OperatingB253DHController extends Controller
{
    use Common;
    ...
    public function SBPB253DH(Request $request)
    {
        $json = [
            'status' => 1,
            'msg' => '',
        ...
        $this->sumUpSBPB253DH(0, $maxLevel);
    ...
    // SUM
    public function sumUpSBPB253DH($start, $maxLevel)
    {
    ...
    public function setIndexReportB253($id = null)
    {
        $insertArr = [];
