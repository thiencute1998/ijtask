...
class SBP3422016TTBTCCCVChungTuGiaoDuToanBM48Controller extends Controller {
    public function sbptt3422016ttbtcchungtugiaodutoanbm48(Request $request){
        ...
        if(isset($filter['queryFilter'])){
            $book = DB::table('act_gl_books')->where('TransID',$filter['queryFilter'])->first();
        }
