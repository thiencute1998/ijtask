...
class SBP612021TTBTCMB03Controller extends Controller {
    public function SBP612021TTBTC_MB03(Request $request){
        ...
        if (isset($data[0])) {
            ...
            $data[0]->HeaderName3 = 'Dự kiến nhu cầu kinh phí thực hiện năm ' .$yearNext;
        }
        ...
        $response = [
            'master' => [
                ...
                "TransNo" => "00001",
                "ReportName" => "TỔNG HỢP KINH PHÍ THỰC HIỆN CÁC CHÍNH SÁCH, CHẾ ĐỘ NĂM ".$yearPre.", ".$year. " VÀ DỰ KIẾN NHU CẦU KINH PHÍ NĂM " . $yearNext,
                "DateTime" => $dateTime,
                "CompanyName" => 'UBND TỈNH, THÀNH PHỐ:……………….',
                "Note" => $note
            ],
            'detail' => $data
        ];
