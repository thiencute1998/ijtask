...
class SBP3432016TTBTCMB107Controller extends Controller {
    public function SBP3432016TTBTC_MB107(Request $request){
        ...
        foreach ($data as $key => $value) {
            ...
            $data[$key]->I3 = round((int)($data[$key]->I1) - (int)($data[$key]->I2), 2);
            $data[$key]->I4 = ($data[$key]->I4) ? $data[$key]->I4 : '';
            $data[$key]->I5 = ($data[$key]->I5) ? $data[$key]->I5 : '';
            $data[$key]->I6 = round((int)($data[$key]->I4) - (int)($data[$key]->I5), 2);
        }
        ...
        $response = [
            'master' => [
                ...
                "TransNo" => "00001",
                "ReportName" => "KẾ HOẠCH THU, CHI CÁC HOẠT ĐỘNG TÀI CHÍNH KHÁC NĂM " . $year,
                "DateTime" => $dateTime,
                "CompanyName" => 'UBND XÃ..',
                "Note" => $note
            ],
