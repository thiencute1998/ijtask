...
class SBP3422016TTBTCMB48Controller extends Controller {
    use Common;

    public function SBP3422016TTBTC_MB48(Request $request){
        $json = [
            'status' => 1,
            'msg' => '',
            'data' => null
        ...
        $this->updateRowII_1_3($whereCondition);
    ...
    public function setCaseRevenue(){
        return "CASE WHEN A.AccountNo = '0341' AND NC.CateNo = '2011111' AND NC.CateValue = '1' THEN '01#01'
                    WHEN A.AccountNo IN ('0341','0342') AND NC.CateNo = '2011112' AND NC.CateValue IN ('1', '2') THEN '01#02'
                    WHEN A.AccountNo = '0441' AND NC.CateNo = '2011111' AND NC.CateValue = '1' THEN '03#01'
                     WHEN A.AccountNo = '0441' AND NC.CateNo = '2011112' AND NC.CateValue = '2' THEN '03#02' END";
    }
    ...
    public function insertR1C1($whereCondition){
        $sql = "INSERT INTO table_tmp (ItemID, ParentID, ItemName, Detail, I1)
            ...
            WHERE A.AccountNo IN ('0341', '0342','0441')
            AND ((NC.CateNo = '2011111' AND NC.CateValue = '1') OR (NC.CateNo = '2011112' AND NC.CateValue IN ('1', '2')))
            $whereCondition
            GROUP BY A.AccountNo, A.RevenueNo, NC.CateNo, NC.CateValue) as CH GROUP BY RevenueNo, CaseRevenue
            ";
...
//            ->where('Inactive','!=' , 1)
        ...
        if($listCategoryCate){
            ...
            foreach($listCategoryCate as $item){
                if($item->CateValue == '1'){
                    ...
                    $insertII[] = ['STT'=> $item->CateValue . '.1', 'ItemID'=> 'A#02#' . sprintf("%02d",($item->CateValue)) . '#01', 'ParentID'=> 'A#02#' . sprintf("%02d",($item->CateValue)), 'ItemName'=> 'Kinh phí thực hiện chế độ tự chủ', 'Level'=> 4, 'FontWeight'=> 1, 'SbiCategoryCateValue'=> $item->CateValue, 'NormCateNo'=> '20151111111', 'NormCateValue'=> 1];
                    $insertII[] = ['STT'=> $item->CateValue . '.2', 'ItemID'=> 'A#02#' . sprintf("%02d",($item->CateValue)) . '#02', 'ParentID'=> 'A#02#' . sprintf("%02d",($item->CateValue)), 'ItemName'=> 'Kinh phí không thực hiện chế độ tự chủ', 'Level'=> 4, 'FontWeight'=> 1, 'SbiCategoryCateValue'=> $item->CateValue, 'NormCateNo'=> '20151111111', 'NormCateValue'=> 2];
                }
                else{
                    ...
                    if($item->CateValue == '2'){
                        //
                        $insertII[] = ['STT'=> $item->CateValue . '.1', 'ItemID'=> 'A#02#' . sprintf("%02d",($item->CateValue)) . '#01', 'ParentID'=> 'A#02#' . sprintf("%02d",($item->CateValue)), 'ItemName'=> 'Kinh phí thực hiện nhiệm vụ khoa học công nghệ', 'Level'=> 4, 'FontWeight'=> 1, 'SbiCategoryCateValue'=> $item->CateValue, 'NormCateNo'=> '20151111112', 'NormCateValue'=> '1'];
                        $insertII[] = ['STT'=> $item->CateValue . '.2', 'ItemID'=> 'A#02#' . sprintf("%02d",($item->CateValue)) . '#02', 'ParentID'=> 'A#02' . sprintf("%02d",($item->CateValue)), 'ItemName'=> 'Kinh phí nhiệm vụ thường xuyên theo chức năng', 'Level'=> 4, 'FontWeight'=> 1, 'SbiCategoryCateValue'=> $item->CateValue, 'NormCateNo'=> '20151111112', 'NormCateValue'=> '2'];
                        $insertII[] = ['STT'=> $item->CateValue . '.3', 'ItemID'=> 'A#02#' . sprintf("%02d",($item->CateValue)) . '#03', 'ParentID'=> 'A#02' . sprintf("%02d",($item->CateValue)), 'ItemName'=> 'Kinh phí nhiệm vụ không thường xuyên', 'Level'=> 4, 'FontWeight'=> 1, 'SbiCategoryCateValue'=> $item->CateValue, 'NormCateNo'=> '20151111112', 'NormCateValue'=> '3'];

                    }
                    else{
                        $insertII[] = ['STT'=> $item->CateValue . '.1', 'ItemID'=> 'A#02#' . sprintf("%02d",($item->CateValue)) . '#01', 'ParentID'=> 'A#02#' . sprintf("%02d",($item->CateValue)), 'ItemName'=> 'Kinh phí nhiệm vụ thường xuyên', 'Level'=> 4, 'FontWeight'=> 1, 'SbiCategoryCateValue'=> $item->CateValue, 'NormCateNo'=> '20151111111', 'NormCateValue'=> '1'];
                        $insertII[] = ['STT'=> $item->CateValue . '.2', 'ItemID'=> 'A#02#' . sprintf("%02d",($item->CateValue)) . '#02', 'ParentID'=> 'A#02#' . sprintf("%02d",($item->CateValue)), 'ItemName'=> 'Kinh phí nhiệm vụ không thường xuyên', 'Level'=> 4, 'FontWeight'=> 1, 'SbiCategoryCateValue'=> $item->CateValue, 'NormCateNo'=> '20151111111', 'NormCateValue'=> '2'];
                    }
                }
                ...
                $insertI[] = ['STT'=> 'a', 'ItemID'=> 'A#01#02#' . sprintf("%02d",($item->CateValue)) . '#01', 'ParentID'=> 'A#01#02' . sprintf("%02d",($item->CateValue)), 'ItemName'=> $itemNameI1, 'Level'=> 4, 'FontWeight'=> 1, 'SbiCategoryCateValue'=> $item->CateValue, 'NormCateNo'=> '201511211'];
                $insertI[] = ['STT'=> 'b', 'ItemID'=> 'A#01#02#' . sprintf("%02d",($item->CateValue)) . '#02', 'ParentID'=> 'A#01#02' . sprintf("%02d",($item->CateValue)), 'ItemName'=> $itemNameI2, 'Level'=> 4, 'FontWeight'=> 1, 'SbiCategoryCateValue'=> $item->CateValue, 'NormCateNo'=> '201511212'];

                $insertII[] = ['STT'=> $item->CateValue, 'ItemID'=> 'A#02#' . sprintf("%02d",($item->CateValue)), 'ParentID'=> 'A#02', 'ItemName'=> $item->Description, 'Level'=> 2, 'FontWeight'=> 1, 'SbiCategoryCateValue'=> $item->CateValue, 'NormCateNo'=> null, 'NormCateValue'=> null];
            }
    ...
    public function updateRowII_1_3($whereCondition){
        $sql = " UPDATE table_tmp as TT, (
        ...
        $whereCondition
        GROUP BY NC.CateValue, SCC.CateValue
        ) as HH SET I1 = I
        WHERE TT.SbiCategoryCateValue = HH.SbiCategoryCateValue
