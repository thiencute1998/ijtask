...
class OperatingB229DHController extends Controller {
    use Common;
    ...
    public function SBPB229DH(Request $request)
    {
        $json = [
            'status' => 1,
            'msg' => '',
        ...
        $this->sumUpSBPB229DH(0,6, $maxLevel);
    ...
    // SUM
    public function sumUpSBPB229DH($start, $end, $maxLevel){
        if ($maxLevel) {
