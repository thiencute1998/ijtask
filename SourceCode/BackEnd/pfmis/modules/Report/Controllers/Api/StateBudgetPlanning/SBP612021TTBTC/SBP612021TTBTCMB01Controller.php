...
class SBP612021TTBTCMB01Controller extends Controller {
    public function SBP612021TTBTC_MB01(Request $request){
        ...
        if (isset($data[0])) {
            $data[0]->HeaderName1 = 'Kế hoạch giải ngân vốn vay năm '. $year;
            $data[0]->HeaderName2 = 'Dự toán năm ' .$year;
            $data[0]->HeaderName3 = '6 tháng đầu năm ' .$year;
            $data[0]->HeaderName4 = 'Ước thực hiện cả năm ' .$year;
            $data[0]->HeaderName5 = 'Kế hoạch giải ngân vốn vay năm ' .$yearNext;
        }
        ...
        $response = [
            'master' => [
                "Year" => "",
                "CreateName" => "TM ỦY BAN NHÂN DÂN TỈNH, THÀNH PHỐ …….",
                "TransNo" => "00001",
                "ReportName" => "KẾ HOẠCH GIẢI NGÂN VỐN VAY NĂM ".$yearNext." CỦA CÁC DỰ ÁN ODA VÀ VAY ƯU ĐÃI TỪ NGUỒN CHÍNH PHỦ VAY VỀ CHO VAY LẠI ",
                "DateTime" => $dateTime,
                "CompanyName" => 'TUBND TỈNH, THÀNH PHỐ:……………………. ',
                "Note" => $note
            ],
            'detail' => $data
        ];
