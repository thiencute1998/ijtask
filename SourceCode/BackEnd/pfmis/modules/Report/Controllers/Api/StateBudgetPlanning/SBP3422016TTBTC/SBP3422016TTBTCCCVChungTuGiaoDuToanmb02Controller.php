...
class SBP3422016TTBTCCCVChungTuGiaoDuToanmb02Controller extends Controller {
    public function sbptt3422016ttbtcchungtugiaodutoanmb02(Request $request){
        ...
        if(isset($book)){
            ...
            if($parentReviewCompany->ParentID){
