...
class SBP3432016TTBTCMB103Controller extends Controller {
    public function SBP3432016TTBTC_MB103(Request $request){
        ...
        $templateTable = DB::table('report_sbp_3432016ttbtc_bs103')->get();
        ...
        $response = [
            'master' => [
                ...
                "TransNo" => "00001",
                "ReportName" => "CÂN ĐỐI NGÂN SÁCH XÃ NĂM " . $year,
                "DateTime" => $dateTime,
                "CompanyName" => 'UBND XÃ..',
                "Note" => $note
            ],
