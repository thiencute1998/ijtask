...
class SbpgiveplanController extends Controller{
    ...
    public function update(Request $request, $id){
        ...
        $master = (object)$request->master;
        $detail = $request->detail;
        $Sbpmakeplan = Sbpgiveplan::find($id);
        if(!$Sbpmakeplan){
            $json['status'] = 2;
