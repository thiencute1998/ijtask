...
use Module\Accounting\Models\AccountingCFAccount;
...
class AccountingCFAccountController extends Controller{

    public function list(Request $request){
        $data = AccountingCFAccount::search($request);
        $json['status'] = 1;
        $json['msg'] = 'Thành công!';
        $json['data'] = $data;
        $json['CFAccountTypeOption'] = config('dataoptions.AccountingCFAccount.CFAccountTypeOption');
        return json_encode($json);
    }

    public function export(Request $request){
        return Excel::download(new ModelExport('act_cfaccount', ['select' => ['InTransTypeName', 'TransDate'], 'conditions' => []]), 'AccountingCFAccount.xlsx');
    }
...
//            return $json;
//        }
        $data = AccountingCFAccount::create($request->all());
        $json['status'] = 1;
        $json['msg'] = 'Thành công!';
    ...
    public function view($id){
        $data = AccountingCFAccount::find($id);
        $json['status'] = 1;
        $json['msg'] = 'Thành công!';
        $json['data']['data'] = $data;
        $json['CFAccountTypeOption'] = config('dataoptions.AccountingCFAccount.CFAccountTypeOption');
...
//        }
    ...
    public function deleteArray(Request $request){
        ...
        AccountingCFAccount::destroy($IDs);
        $json['status'] = 1;
        $json['msg'] = 'Thành công!';
        $json['data'] = [];
        return json_encode($json);
    ...
    public function getDetailReportData(Request $request){
        ...
        $id = $request->id;
        $master = AccountingCFAccount::find($id);
